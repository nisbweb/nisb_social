 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(function(){if("undefined"!=typeof self)return self;if("undefined"!=typeof window)return window;if(void 0!==h)return h;throw Error("Unable to locate global object.")})().__FIREBASE_DEFAULTS__,k=()=>{if(void 0===u||void 0===u.env)return;let t=void 0;if(t)return JSON.parse(t)},R=()=>{let t;if("undefined"==typeof document)return;try{t=document.cookie.match(/__FIREBASE_DEFAULTS__=([^;]+)/)}catch(t){return}let e=t&&D(t[1]);return e&&JSON.parse(e)},O=()=>{try{return N()||k()||R()}catch(t){console.info(`Unable to get __FIREBASE_DEFAULTS__ due to: ${t}`);return}},L=t=>{var e,n;return null===(n=null===(e=O())||void 0===e?void 0:e.emulatorHosts)||void 0===n?void 0:n[t]},x=t=>{let e=L(t);if(!e)return;let n=e.lastIndexOf(":");if(n<=0||n+1===e.length)throw Error(`Invalid host ${e} with no separate hostname and port!`);let i=parseInt(e.substring(n+1),10);return"["===e[0]?[e.substring(1,n-1),i]:[e.substring(0,n),i]},M=()=>{var t;return null===(t=O())||void 0===t?void 0:t.config};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tT{constructor(t,e,n){this._isDeleted=!1,this._options=Object.assign({},t),this._config=Object.assign({},e),this._name=e.name,this._automaticDataCollectionEnabled=e.automaticDataCollectionEnabled,this._container=n,this.container.addComponent(new H("app",()=>this,"PUBLIC"))}get automaticDataCollectionEnabled(){return this.checkDestroyed(),this._automaticDataCollectionEnabled}set automaticDataCollectionEnabled(t){this.checkDestroyed(),this._automaticDataCollectionEnabled=t}get name(){return this.checkDestroyed(),this._name}get options(){return this.checkDestroyed(),this._options}get config(){return this.checkDestroyed(),this._config}get container(){return this._container}get isDeleted(){return this._isDeleted}set isDeleted(t){this._isDeleted=t}checkDestroyed(){if(this.isDeleted)throw tb.create("app-deleted",{appName:this._name})}}function tI(t,e={}){let n=t;"object"!=typeof e&&(e={name:e});let i=Object.assign({name:tm,automaticDataCollectionEnabled:!1},e),r=i.name;if("string"!=typeof r||!r)throw tb.create("bad-app-name",{appName:String(r)});if(n||(n=M()),!n)throw tb.create("no-options");let s=tv.get(r);if(s){if(B(n,s.options)&&B(i,s.config))return s;throw tb.create("duplicate-app",{appName:r})}let a=new G(r);for(let t of tw.values())a.addComponent(t);let o=new tT(n,i,a);return tv.set(r,o),o}function tS(t,e,n){var i;let r=null!==(i=ty[t])&&void 0!==i?i:t;n&&(r+=`-${n}`);let s=r.match(/\s|\//),a=e.match(/\s|\//);if(s||a){let t=[`Unable to register library "${r}" with version "${e}":`];s&&t.push(`library name "${r}" contains illegal characters (whitespace or "/")`),s&&a&&t.push("and"),a&&t.push(`version name "${e}" contains illegal characters (whitespace or "/")`),tg.warn(t.join(" "));return}tE(new H(`${r}-version`,()=>({library:r,version:e}),"VERSION"))}const tA="firebase-heartbeat-store";let tC=null;function t_(){return tC||(tC=(function(t,e,{blocked:n,upgrade:i,blocking:r,terminated:s}={}){let a=indexedDB.open(t,1),o=ta(a);return i&&a.addEventListener("upgradeneeded",t=>{i(ta(a.result),t.oldVersion,t.newVersion,ta(a.transaction),t)}),n&&a.addEventListener("blocked",t=>n(t.oldVersion,t.newVersion,t)),o.then(t=>{s&&t.addEventListener("close",()=>s()),r&&t.addEventListener("versionchange",t=>r(t.oldVersion,t.newVersion,t))}).catch(()=>{}),o})("firebase-heartbeat-database",0,{upgrade:(t,e)=>{0===e&&t.createObjectStore(tA)}}).catch(t=>{throw tb.create("idb-open",{originalErrorMessage:t.message})})),tC}async function tD(t){try{let e=await t_();return await e.transaction(tA).objectStore(tA).get(tk(t))}catch(t){if(t instanceof F)tg.warn(t.message);else{let e=tb.create("idb-get",{originalErrorMessage:null==t?void 0:t.message});tg.warn(e.message)}}}async function tN(t,e){try{let n=(await t_()).transaction(tA,"readwrite"),i=n.objectStore(tA);await i.put(e,tk(t)),await n.done}catch(t){if(t instanceof F)tg.warn(t.message);else{let e=tb.create("idb-set",{originalErrorMessage:null==t?void 0:t.message});tg.warn(e.message)}}}function tk(t){return`${t.name}!${t.options.appId}`}class tR{constructor(t){this.container=t,this._heartbeatsCache=null;let e=this.container.getProvider("app").getImmediate();this._storage=new tL(e),this._heartbeatsCachePromise=this._storage.read().then(t=>(this._heartbeatsCache=t,t))}async triggerHeartbeat(){let t=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),e=tO();return(null===this._heartbeatsCache&&(this._heartbeatsCache=await this._heartbeatsCachePromise),this._heartbeatsCache.lastSentHeartbeatDate===e||this._heartbeatsCache.heartbeats.some(t=>t.date===e))?void 0:(this._heartbeatsCache.heartbeats.push({date:e,agent:t}),this._heartbeatsCache.heartbeats=this._heartbeatsCache.heartbeats.filter(t=>{let e=new Date(t.date).valueOf();return Date.now()-e<=2592e6}),this._storage.overwrite(this._heartbeatsCache))}async getHeartbeatsHeader(){if(null===this._heartbeatsCache&&await this._heartbeatsCachePromise,null===this._heartbeatsCache||0===this._heartbeatsCache.heartbeats.length)return"";let t=tO(),{heartbeatsToSend:e,unsentEntries:n}=function(t,e=1024){let n=[],i=t.slice();for(let r of t){let t=n.find(t=>t.agent===r.agent);if(t){if(t.dates.push(r.date),tx(n)>e){t.dates.pop();break}}else if(n.push({agent:r.agent,dates:[r.date]}),tx(n)>e){n.pop();break}i=i.slice(1)}return{heartbeatsToSend:n,unsentEntries:i}}(this._heartbeatsCache.heartbeats),i=_(JSON.stringify({version:2,heartbeats:e}));return this._heartbeatsCache.lastSentHeartbeatDate=t,n.length>0?(this._heartbeatsCache.heartbeats=n,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),i}}function tO(){return new Date().toISOString().substring(0,10)}class tL{constructor(t){this.app=t,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return!!function(){try{return"object"==typeof indexedDB}catch(t){return!1}}()&&new Promise((t,e)=>{try{let n=!0,i="validate-browser-context-for-indexeddb-analytics-module",r=self.indexedDB.open(i);r.onsuccess=()=>{r.result.close(),n||self.indexedDB.deleteDatabase(i),t(!0)},r.onupgradeneeded=()=>{n=!1},r.onerror=()=>{var t;e((null===(t=r.error)||void 0===t?void 0:t.message)||"")}}catch(t){e(t)}}).then(()=>!0).catch(()=>!1)}async read(){return await this._canUseIndexedDBPromise&&await tD(this.app)||{heartbeats:[]}}async overwrite(t){var e;if(await this._canUseIndexedDBPromise){let n=await this.read();return tN(this.app,{lastSentHeartbeatDate:null!==(e=t.lastSentHeartbeatDate)&&void 0!==e?e:n.lastSentHeartbeatDate,heartbeats:t.heartbeats})}}async add(t){var e;if(await this._canUseIndexedDBPromise){let n=await this.read();return tN(this.app,{lastSentHeartbeatDate:null!==(e=t.lastSentHeartbeatDate)&&void 0!==e?e:n.lastSentHeartbeatDate,heartbeats:[...n.heartbeats,...t.heartbeats]})}}}function tx(t){return _(JSON.stringify({version:2,heartbeats:t})).length}tE(new H("platform-logger",t=>new tf(t),"PRIVATE")),tE(new H("heartbeat",t=>new tR(t),"PRIVATE")),tS(td,tp,""),tS(td,tp,"esm2017"),tS("fire-js",""),tS("firebase","9.23.0","app");var tM,tP,tF,tV,tU,tB,tj={},t$=t$||{},tH=("undefined"!=typeof globalThis?globalThis:"undefined"!=typeof window?window:void 0!==h?h:"undefined"!=typeof self?self:{})||self;function tz(t){var e=typeof t;return"array"==(e="object"!=e?e:t?Array.isArray(t)?"array":e:"null")||"object"==e&&"number"==typeof t.length}function tq(t){var e=typeof t;return"object"==e&&null!=t||"function"==e}function tG(t,e,n){return t.call.apply(t.bind,arguments)}function tK(t,e,n){if(!t)throw Error();if(2<arguments.length){var i=Array.prototype.slice.call(arguments,2);return function(){var n=Array.prototype.slice.call(arguments);return Array.prototype.unshift.apply(n,i),t.apply(e,n)}}return function(){return t.apply(e,arguments)}}function tQ(t,e,n){return(tQ=Function.prototype.bind&&-1!=Function.prototype.bind.toString().indexOf("native code")?tG:tK).apply(null,arguments)}function tW(t,e){var n=Array.prototype.slice.call(arguments,1);return function(){var e=n.slice();return e.push.apply(e,arguments),t.apply(this,e)}}function tX(t,e){function n(){}n.prototype=e.prototype,t.$=e.prototype,t.prototype=new n,t.prototype.constructor=t,t.ac=function(t,n,i){for(var r=Array(arguments.length-2),s=2;s<arguments.length;s++)r[s-2]=arguments[s];return e.prototype[n].apply(t,r)}}function tY(){this.s=this.s,this.o=this.o}tY.prototype.s=!1,tY.prototype.sa=function(){this.s||(this.s=!0,this.N())},tY.prototype.N=function(){if(this.o)for(;this.o.length;)this.o.shift()()};const tJ=Array.prototype.indexOf?function(t,e){return Array.prototype.indexOf.call(t,e,void 0)}:function(t,e){if("string"==typeof t)return"string"!=typeof e||1!=e.length?-1:t.indexOf(e,0);for(let n=0;n<t.length;n++)if(n in t&&t[n]===e)return n;return -1};function tZ(t){let e=t.length;if(0<e){let n=Array(e);for(let i=0;i<e;i++)n[i]=t[i];return n}return[]}function t0(t,e){for(let e=1;e<arguments.length;e++){let n=arguments[e];if(tz(n)){let e=t.length||0,i=n.length||0;t.length=e+i;for(let r=0;r<i;r++)t[e+r]=n[r]}else t.push(n)}}function t1(t,e){this.type=t,this.g=this.target=e,this.defaultPrevented=!1}t1.prototype.h=function(){this.defaultPrevented=!0};var t2=function(){if(!tH.addEventListener||!Object.defineProperty)return!1;var t=!1,e=Object.defineProperty({},"passive",{get:function(){t=!0}});try{tH.addEventListener("test",()=>{},e),tH.removeEventListener("test",()=>{},e)}catch(t){}return t}();function t9(t){return/^[\s\xa0]*$/.test(t)}function t4(){var t=tH.navigator;return t&&(t=t.userAgent)?t:""}function t6(t){return -1!=t4().indexOf(t)}function t5(t){return t5[" "](t),t}t5[" "]=function(){};var t3=t6("Opera"),t7=t6("Trident")||t6("MSIE"),t8=t6("Edge"),et=t8||t7,ee=t6("Gecko")&&!(-1!=t4().toLowerCase().indexOf("webkit")&&!t6("Edge"))&&!(t6("Trident")||t6("MSIE"))&&!t6("Edge"),en=-1!=t4().toLowerCase().indexOf("webkit")&&!t6("Edge");function ei(){var t=tH.document;return t?t.documentMode:void 0}t:{var er,es="",ea=(er=t4(),ee?/rv:([^\);]+)(\)|;)/.exec(er):t8?/Edge\/([\d\.]+)/.exec(er):t7?/\b(?:MSIE|rv)[: ]([^\);]+)(\)|;)/.exec(er):en?/WebKit\/(\S+)/.exec(er):t3?/(?:Version)[ \/]?(\S+)/.exec(er):void 0);if(ea&&(es=ea?ea[1]:""),t7){var eo=ei();if(null!=eo&&eo>parseFloat(es)){r=String(eo);break t}}r=es}var el=tH.document&&t7&&(ei()||parseInt(r,10))||void 0;function eh(t,e){if(t1.call(this,t?t.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,t){var n=this.type=t.type,i=t.changedTouches&&t.changedTouches.length?t.changedTouches[0]:null;if(this.target=t.target||t.srcElement,this.g=e,e=t.relatedTarget){if(ee){t:{try{t5(e.nodeName);var r=!0;break t}catch(t){}r=!1}r||(e=null)}}else"mouseover"==n?e=t.fromElement:"mouseout"==n&&(e=t.toElement);this.relatedTarget=e,i?(this.clientX=void 0!==i.clientX?i.clientX:i.pageX,this.clientY=void 0!==i.clientY?i.clientY:i.pageY,this.screenX=i.screenX||0,this.screenY=i.screenY||0):(this.clientX=void 0!==t.clientX?t.clientX:t.pageX,this.clientY=void 0!==t.clientY?t.clientY:t.pageY,this.screenX=t.screenX||0,this.screenY=t.screenY||0),this.button=t.button,this.key=t.key||"",this.ctrlKey=t.ctrlKey,this.altKey=t.altKey,this.shiftKey=t.shiftKey,this.metaKey=t.metaKey,this.pointerId=t.pointerId||0,this.pointerType="string"==typeof t.pointerType?t.pointerType:eu[t.pointerType]||"",this.state=t.state,this.i=t,t.defaultPrevented&&eh.$.h.call(this)}}tX(eh,t1);var eu={2:"touch",3:"pen",4:"mouse"};eh.prototype.h=function(){eh.$.h.call(this);var t=this.i;t.preventDefault?t.preventDefault():t.returnValue=!1};var ec="closure_listenable_"+(1e6*Math.random()|0),ef=0;function ed(t,e,n,i,r){this.listener=t,this.proxy=null,this.src=e,this.type=n,this.capture=!!i,this.la=r,this.key=++ef,this.fa=this.ia=!1}function ep(t){t.fa=!0,t.listener=null,t.proxy=null,t.src=null,t.la=null}function eg(t,e,n){for(let i in t)e.call(n,t[i],i,t)}function em(t){let e={};for(let n in t)e[n]=t[n];return e}const ey="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function ev(t,e){let n,i;for(let e=1;e<arguments.length;e++){for(n in i=arguments[e])t[n]=i[n];for(let e=0;e<ey.length;e++)n=ey[e],Object.prototype.hasOwnProperty.call(i,n)&&(t[n]=i[n])}}function ew(t){this.src=t,this.g={},this.h=0}function eE(t,e){var n=e.type;if(n in t.g){var i,r=t.g[n],s=tJ(r,e);(i=0<=s)&&Array.prototype.splice.call(r,s,1),i&&(ep(e),0==t.g[n].length&&(delete t.g[n],t.h--))}}function eb(t,e,n,i){for(var r=0;r<t.length;++r){var s=t[r];if(!s.fa&&s.listener==e&&!!n==s.capture&&s.la==i)return r}return -1}ew.prototype.add=function(t,e,n,i,r){var s=t.toString();(t=this.g[s])||(t=this.g[s]=[],this.h++);var a=eb(t,e,i,r);return -1<a?(e=t[a],n||(e.ia=!1)):((e=new ed(e,this.src,s,!!i,r)).ia=n,t.push(e)),e};var eT="closure_lm_"+(1e6*Math.random()|0),eI={};function eS(t,e,n,i,r,s){if(!e)throw Error("Invalid event type");var a=tq(r)?!!r.capture:!!r,o=eD(t);if(o||(t[eT]=o=new ew(t)),(n=o.add(e,n,i,a,s)).proxy)return n;if(i=function t(e){return e_.call(t.src,t.listener,e)},n.proxy=i,i.src=t,i.listener=n,t.addEventListener)t2||(r=a),void 0===r&&(r=!1),t.addEventListener(e.toString(),i,r);else if(t.attachEvent)t.attachEvent(eC(e.toString()),i);else if(t.addListener&&t.removeListener)t.addListener(i);else throw Error("addEventListener and attachEvent are unavailable.");return n}function eA(t){if("number"!=typeof t&&t&&!t.fa){var e=t.src;if(e&&e[ec])eE(e.i,t);else{var n=t.type,i=t.proxy;e.removeEventListener?e.removeEventListener(n,i,t.capture):e.detachEvent?e.detachEvent(eC(n),i):e.addListener&&e.removeListener&&e.removeListener(i),(n=eD(e))?(eE(n,t),0==n.h&&(n.src=null,e[eT]=null)):ep(t)}}}function eC(t){return t in eI?eI[t]:eI[t]="on"+t}function e_(t,e){if(t.fa)t=!0;else{e=new eh(e,this);var n=t.listener,i=t.la||t.src;t.ia&&eA(t),t=n.call(i,e)}return t}function eD(t){return(t=t[eT])instanceof ew?t:null}var eN="__closure_events_fn_"+(1e9*Math.random()>>>0);function ek(t){return"function"==typeof t?t:(t[eN]||(t[eN]=function(e){return t.handleEvent(e)}),t[eN])}function eR(){tY.call(this),this.i=new ew(this),this.S=this,this.J=null}function eO(t,e){var n,i=t.J;if(i)for(n=[];i;i=i.J)n.push(i);if(t=t.S,i=e.type||e,"string"==typeof e)e=new t1(e,t);else if(e instanceof t1)e.target=e.target||t;else{var r=e;ev(e=new t1(i,t),r)}if(r=!0,n)for(var s=n.length-1;0<=s;s--){var a=e.g=n[s];r=eL(a,i,!0,e)&&r}if(r=eL(a=e.g=t,i,!0,e)&&r,r=eL(a,i,!1,e)&&r,n)for(s=0;s<n.length;s++)r=eL(a=e.g=n[s],i,!1,e)&&r}function eL(t,e,n,i){if(!(e=t.i.g[String(e)]))return!0;e=e.concat();for(var r=!0,s=0;s<e.length;++s){var a=e[s];if(a&&!a.fa&&a.capture==n){var o=a.listener,l=a.la||a.src;a.ia&&eE(t.i,a),r=!1!==o.call(l,i)&&r}}return r&&!i.defaultPrevented}tX(eR,tY),eR.prototype[ec]=!0,eR.prototype.removeEventListener=function(t,e,n,i){!function t(e,n,i,r,s){if(Array.isArray(n))for(var a=0;a<n.length;a++)t(e,n[a],i,r,s);else(r=tq(r)?!!r.capture:!!r,i=ek(i),e&&e[ec])?(e=e.i,(n=String(n).toString())in e.g&&-1<(i=eb(a=e.g[n],i,r,s))&&(ep(a[i]),Array.prototype.splice.call(a,i,1),0==a.length&&(delete e.g[n],e.h--))):e&&(e=eD(e))&&(n=e.g[n.toString()],e=-1,n&&(e=eb(n,i,r,s)),(i=-1<e?n[e]:null)&&eA(i))}(this,t,e,n,i)},eR.prototype.N=function(){if(eR.$.N.call(this),this.i){var t,e=this.i;for(t in e.g){for(var n=e.g[t],i=0;i<n.length;i++)ep(n[i]);delete e.g[t],e.h--}}this.J=null},eR.prototype.O=function(t,e,n,i){return this.i.add(String(t),e,!1,n,i)},eR.prototype.P=function(t,e,n,i){return this.i.add(String(t),e,!0,n,i)};var ex=tH.JSON.stringify,eM=new class{constructor(t,e){this.i=t,this.j=e,this.h=0,this.g=null}get(){let t;return 0<this.h?(this.h--,t=this.g,this.g=t.next,t.next=null):t=this.i(),t}}(()=>new eP,t=>t.reset());class eP{constructor(){this.next=this.g=this.h=null}set(t,e){this.h=t,this.g=e,this.next=null}reset(){this.next=this.g=this.h=null}}let eF,eV=!1,eU=new class{constructor(){this.h=this.g=null}add(t,e){let n=eM.get();n.set(t,e),this.h?this.h.next=n:this.g=n,this.h=n}},eB=()=>{let t=tH.Promise.resolve(void 0);eF=()=>{t.then(ej)}};var ej=()=>{let t;for(var e;t=null,eU.g&&(t=eU.g,eU.g=eU.g.next,eU.g||(eU.h=null),t.next=null),e=t;){try{e.h.call(e.g)}catch(t){!function(t){tH.setTimeout(()=>{throw t},0)}(t)}eM.j(e),100>eM.h&&(eM.h++,e.next=eM.g,eM.g=e)}eV=!1};function e$(t,e){eR.call(this),this.h=t||1,this.g=e||tH,this.j=tQ(this.qb,this),this.l=Date.now()}function eH(t){t.ga=!1,t.T&&(t.g.clearTimeout(t.T),t.T=null)}function ez(t,e,n){if("function"==typeof t)n&&(t=tQ(t,n));else if(t&&"function"==typeof t.handleEvent)t=tQ(t.handleEvent,t);else throw Error("Invalid listener argument");return 2147483647<Number(e)?-1:tH.setTimeout(t,e||0)}tX(e$,eR),(tB=e$.prototype).ga=!1,tB.T=null,tB.qb=function(){if(this.ga){var t=Date.now()-this.l;0<t&&t<.8*this.h?this.T=this.g.setTimeout(this.j,this.h-t):(this.T&&(this.g.clearTimeout(this.T),this.T=null),eO(this,"tick"),this.ga&&(eH(this),this.start()))}},tB.start=function(){this.ga=!0,this.T||(this.T=this.g.setTimeout(this.j,this.h),this.l=Date.now())},tB.N=function(){e$.$.N.call(this),eH(this),delete this.g};class eq extends tY{constructor(t,e){super(),this.m=t,this.j=e,this.h=null,this.i=!1,this.g=null}l(t){this.h=arguments,this.g?this.i=!0:function t(e){e.g=ez(()=>{e.g=null,e.i&&(e.i=!1,t(e))},e.j);let n=e.h;e.h=null,e.m.apply(null,n)}(this)}N(){super.N(),this.g&&(tH.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function eG(t){tY.call(this),this.h=t,this.g={}}tX(eG,tY);var eK=[];function eQ(t,e,n,i){Array.isArray(n)||(n&&(eK[0]=n.toString()),n=eK);for(var r=0;r<n.length;r++){var s=function t(e,n,i,r,s){if(r&&r.once)return function t(e,n,i,r,s){if(Array.isArray(n)){for(var a=0;a<n.length;a++)t(e,n[a],i,r,s);return null}return i=ek(i),e&&e[ec]?e.P(n,i,tq(r)?!!r.capture:!!r,s):eS(e,n,i,!0,r,s)}(e,n,i,r,s);if(Array.isArray(n)){for(var a=0;a<n.length;a++)t(e,n[a],i,r,s);return null}return i=ek(i),e&&e[ec]?e.O(n,i,tq(r)?!!r.capture:!!r,s):eS(e,n,i,!1,r,s)}(e,n[r],i||t.handleEvent,!1,t.h||t);if(!s)break;t.g[s.key]=s}}function eW(t){eg(t.g,function(t,e){this.g.hasOwnProperty(e)&&eA(t)},t),t.g={}}function eX(){this.g=!0}function eY(t,e,n,i){t.info(function(){return"XMLHTTP TEXT ("+e+"): "+function(t,e){if(!t.g)return e;if(!e)return null;try{var n=JSON.parse(e);if(n){for(t=0;t<n.length;t++)if(Array.isArray(n[t])){var i=n[t];if(!(2>i.length)){var r=i[1];if(Array.isArray(r)&&!(1>r.length)){var s=r[0];if("noop"!=s&&"stop"!=s&&"close"!=s)for(var a=1;a<r.length;a++)r[a]=""}}}}return ex(n)}catch(t){return e}}(t,n)+(i?" "+i:"")})}eG.prototype.N=function(){eG.$.N.call(this),eW(this)},eG.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")},eX.prototype.Ea=function(){this.g=!1},eX.prototype.info=function(){};var eJ={},eZ=null;function e0(){return eZ=eZ||new eR}function e1(t){t1.call(this,eJ.Ta,t)}function e2(t){let e=e0();eO(e,new e1(e))}function e9(t,e){t1.call(this,eJ.STAT_EVENT,t),this.stat=e}function e4(t){let e=e0();eO(e,new e9(e,t))}function e6(t,e){t1.call(this,eJ.Ua,t),this.size=e}function e5(t,e){if("function"!=typeof t)throw Error("Fn must not be null and must be a function");return tH.setTimeout(function(){t()},e)}eJ.Ta="serverreachability",tX(e1,t1),eJ.STAT_EVENT="statevent",tX(e9,t1),eJ.Ua="timingevent",tX(e6,t1);var e3={NO_ERROR:0,rb:1,Eb:2,Db:3,yb:4,Cb:5,Fb:6,Qa:7,TIMEOUT:8,Ib:9},e7={wb:"complete",Sb:"success",Ra:"error",Qa:"abort",Kb:"ready",Lb:"readystatechange",TIMEOUT:"timeout",Gb:"incrementaldata",Jb:"progress",zb:"downloadprogress",$b:"uploadprogress"};function e8(){}function nt(t){return t.h||(t.h=t.i())}function ne(){}e8.prototype.h=null;var nn={OPEN:"a",vb:"b",Ra:"c",Hb:"d"};function ni(){t1.call(this,"d")}function nr(){t1.call(this,"c")}function ns(){}function na(t,e,n,i){this.l=t,this.j=e,this.m=n,this.W=i||1,this.U=new eG(this),this.P=nl,t=et?125:void 0,this.V=new e$(t),this.I=null,this.i=!1,this.s=this.A=this.v=this.L=this.G=this.Y=this.B=null,this.F=[],this.g=null,this.C=0,this.o=this.u=null,this.ca=-1,this.J=!1,this.O=0,this.M=null,this.ba=this.K=this.aa=this.S=!1,this.h=new no}function no(){this.i=null,this.g="",this.h=!1}tX(ni,t1),tX(nr,t1),tX(ns,e8),ns.prototype.g=function(){return new XMLHttpRequest},ns.prototype.i=function(){return{}},a=new ns;var nl=45e3,nh={},nu={};function nc(t,e,n){t.L=1,t.v=nN(nS(e)),t.s=n,t.S=!0,nf(t,null)}function nf(t,e){t.G=Date.now(),ng(t),t.A=nS(t.v);var n=t.A,i=t.W;Array.isArray(i)||(i=[String(i)]),n$(n.i,"t",i),t.C=0,n=t.l.J,t.h=new no,t.g=iL(t.l,n?e:null,!t.s),0<t.O&&(t.M=new eq(tQ(t.Pa,t,t.g),t.O)),eQ(t.U,t.g,"readystatechange",t.nb),e=t.I?em(t.I):{},t.s?(t.u||(t.u="POST"),e["Content-Type"]="application/x-www-form-urlencoded",t.g.ha(t.A,t.u,t.s,e)):(t.u="GET",t.g.ha(t.A,t.u,null,e)),e2(),function(t,e,n,i,r,s){t.info(function(){if(t.g){if(s)for(var a="",o=s.split("&"),l=0;l<o.length;l++){var h=o[l].split("=");if(1<h.length){var u=h[0];h=h[1];var c=u.split("_");a=2<=c.length&&"type"==c[1]?a+(u+"=")+h+"&":a+(u+"=redacted&")}}else a=null}else a=s;return"XMLHTTP REQ ("+i+") [attempt "+r+"]: "+e+"\n"+n+"\n"+a})}(t.j,t.u,t.A,t.m,t.W,t.s)}function nd(t){return!!t.g&&"GET"==t.u&&2!=t.L&&t.l.Ha}function np(t,e,n){let i=!0,r;for(;!t.J&&t.C<n.length;)if((r=function(t,e){var n=t.C,i=e.indexOf("\n",n);return -1==i?nu:isNaN(n=Number(e.substring(n,i)))?nh:(i+=1)+n>e.length?nu:(e=e.slice(i,i+n),t.C=i+n,e)}(t,n))==nu){4==e&&(t.o=4,e4(14),i=!1),eY(t.j,t.m,null,"[Incomplete Response]");break}else if(r==nh){t.o=4,e4(15),eY(t.j,t.m,n,"[Invalid Chunk]"),i=!1;break}else eY(t.j,t.m,r,null),nE(t,r);nd(t)&&r!=nu&&r!=nh&&(t.h.g="",t.C=0),4!=e||0!=n.length||t.h.h||(t.o=1,e4(16),i=!1),t.i=t.i&&i,i?0<n.length&&!t.ba&&(t.ba=!0,(e=t.l).g==t&&e.ca&&!e.M&&(e.l.info("Great, no buffering proxy detected. Bytes received: "+n.length),iA(e),e.M=!0,e4(11))):(eY(t.j,t.m,n,"[Invalid Chunked Response]"),nw(t),nv(t))}function ng(t){t.Y=Date.now()+t.P,nm(t,t.P)}function nm(t,e){if(null!=t.B)throw Error("WatchDog timer not null");t.B=e5(tQ(t.lb,t),e)}function ny(t){t.B&&(tH.clearTimeout(t.B),t.B=null)}function nv(t){0==t.l.H||t.J||iD(t.l,t)}function nw(t){ny(t);var e=t.M;e&&"function"==typeof e.sa&&e.sa(),t.M=null,eH(t.V),eW(t.U),t.g&&(e=t.g,t.g=null,e.abort(),e.sa())}function nE(t,e){try{var n=t.l;if(0!=n.H&&(n.g==t||nW(n.i,t))){if(!t.K&&nW(n.i,t)&&3==n.H){try{var i=n.Ja.g.parse(e)}catch(t){i=null}if(Array.isArray(i)&&3==i.length){var r=i;if(0==r[0]){t:if(!n.u){if(n.g){if(n.g.G+3e3<t.G)i_(n),iy(n);else break t}iS(n),e4(18)}}else n.Fa=r[1],0<n.Fa-n.V&&37500>r[2]&&n.G&&0==n.A&&!n.v&&(n.v=e5(tQ(n.ib,n),6e3));if(1>=nQ(n.i)&&n.oa){try{n.oa()}catch(t){}n.oa=void 0}}else ik(n,11)}else if((t.K||n.g==t)&&i_(n),!t9(e))for(r=n.Ja.g.parse(e),e=0;e<r.length;e++){let o=r[e];if(n.V=o[0],o=o[1],2==n.H){if("c"==o[0]){n.K=o[1],n.pa=o[2];let e=o[3];null!=e&&(n.ra=e,n.l.info("VER="+n.ra));let r=o[4];null!=r&&(n.Ga=r,n.l.info("SVER="+n.Ga));let l=o[5];null!=l&&"number"==typeof l&&0<l&&(i=1.5*l,n.L=i,n.l.info("backChannelRequestTimeoutMs_="+i)),i=n;let h=t.g;if(h){let t=h.g?h.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(t){var s=i.i;s.g||-1==t.indexOf("spdy")&&-1==t.indexOf("quic")&&-1==t.indexOf("h2")||(s.j=s.l,s.g=new Set,s.h&&(nX(s,s.h),s.h=null))}if(i.F){let t=h.g?h.g.getResponseHeader("X-HTTP-Session-Id"):null;t&&(i.Da=t,nD(i.I,i.F,t))}}if(n.H=3,n.h&&n.h.Ba(),n.ca&&(n.S=Date.now()-t.G,n.l.info("Handshake RTT: "+n.S+"ms")),(i=n).wa=iO(i,i.J?i.pa:null,i.Y),t.K){nY(i.i,t);var a=i.L;a&&t.setTimeout(a),t.B&&(ny(t),ng(t)),i.g=t}else iI(i);0<n.j.length&&iw(n)}else"stop"!=o[0]&&"close"!=o[0]||ik(n,7)}else 3==n.H&&("stop"==o[0]||"close"==o[0]?"stop"==o[0]?ik(n,7):im(n):"noop"!=o[0]&&n.h&&n.h.Aa(o),n.A=0)}}e2(4)}catch(t){}}function nb(t,e){if(t.forEach&&"function"==typeof t.forEach)t.forEach(e,void 0);else if(tz(t)||"string"==typeof t)Array.prototype.forEach.call(t,e,void 0);else for(var n=function(t){if(t.ta&&"function"==typeof t.ta)return t.ta();if(!t.Z||"function"!=typeof t.Z){if("undefined"!=typeof Map&&t instanceof Map)return Array.from(t.keys());if(!("undefined"!=typeof Set&&t instanceof Set)){if(tz(t)||"string"==typeof t){var e=[];t=t.length;for(var n=0;n<t;n++)e.push(n);return e}for(let i in e=[],n=0,t)e[n++]=i;return e}}}(t),i=function(t){if(t.Z&&"function"==typeof t.Z)return t.Z();if("undefined"!=typeof Map&&t instanceof Map||"undefined"!=typeof Set&&t instanceof Set)return Array.from(t.values());if("string"==typeof t)return t.split("");if(tz(t)){for(var e=[],n=t.length,i=0;i<n;i++)e.push(t[i]);return e}for(i in e=[],n=0,t)e[n++]=t[i];return e}(t),r=i.length,s=0;s<r;s++)e.call(void 0,i[s],n&&n[s],t)}(tB=na.prototype).setTimeout=function(t){this.P=t},tB.nb=function(t){t=t.target;let e=this.M;e&&3==ih(t)?e.l():this.Pa(t)},tB.Pa=function(t){try{if(t==this.g)t:{let u=ih(this.g);var e=this.g.Ia();let c=this.g.da();if(!(3>u)&&(3!=u||et||this.g&&(this.h.h||this.g.ja()||iu(this.g)))){this.J||4!=u||7==e||(8==e||0>=c?e2(3):e2(2)),ny(this);var n=this.g.da();this.ca=n;e:if(nd(this)){var i=iu(this.g);t="";var r=i.length,s=4==ih(this.g);if(!this.h.i){if("undefined"==typeof TextDecoder){nw(this),nv(this);var a="";break e}this.h.i=new tH.TextDecoder}for(e=0;e<r;e++)this.h.h=!0,t+=this.h.i.decode(i[e],{stream:s&&e==r-1});i.splice(0,r),this.h.g+=t,this.C=0,a=this.h.g}else a=this.g.ja();if(this.i=200==n,function(t,e,n,i,r,s,a){t.info(function(){return"XMLHTTP RESP ("+i+") [ attempt "+r+"]: "+e+"\n"+n+"\n"+s+" "+a})}(this.j,this.u,this.A,this.m,this.W,u,n),this.i){if(this.aa&&!this.K){e:{if(this.g){var o,l=this.g;if((o=l.g?l.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!t9(o)){var h=o;break e}}h=null}if(n=h)eY(this.j,this.m,n,"Initial handshake response via X-HTTP-Initial-Response"),this.K=!0,nE(this,n);else{this.i=!1,this.o=3,e4(12),nw(this),nv(this);break t}}this.S?(np(this,u,a),et&&this.i&&3==u&&(eQ(this.U,this.V,"tick",this.mb),this.V.start())):(eY(this.j,this.m,a,null),nE(this,a)),4==u&&nw(this),this.i&&!this.J&&(4==u?iD(this.l,this):(this.i=!1,ng(this)))}else(function(t){let e={};t=(t.g&&2<=ih(t)&&t.g.getAllResponseHeaders()||"").split("\r\n");for(let i=0;i<t.length;i++){if(t9(t[i]))continue;var n=function(t){var e=1;t=t.split(":");let n=[];for(;0<e&&t.length;)n.push(t.shift()),e--;return t.length&&n.push(t.join(":")),n}(t[i]);let r=n[0];if("string"!=typeof(n=n[1]))continue;n=n.trim();let s=e[r]||[];e[r]=s,s.push(n)}!function(t,e){for(let n in t)e.call(void 0,t[n],n,t)}(e,function(t){return t.join(", ")})})(this.g),400==n&&0<a.indexOf("Unknown SID")?(this.o=3,e4(12)):(this.o=0,e4(13)),nw(this),nv(this)}}}catch(t){}finally{}},tB.mb=function(){if(this.g){var t=ih(this.g),e=this.g.ja();this.C<e.length&&(ny(this),np(this,t,e),this.i&&4!=t&&ng(this))}},tB.cancel=function(){this.J=!0,nw(this)},tB.lb=function(){this.B=null;let t=Date.now();0<=t-this.Y?(function(t,e){t.info(function(){return"TIMEOUT: "+e})}(this.j,this.A),2!=this.L&&(e2(),e4(17)),nw(this),this.o=2,nv(this)):nm(this,this.Y-t)};var nT=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function nI(t){if(this.g=this.s=this.j="",this.m=null,this.o=this.l="",this.h=!1,t instanceof nI){this.h=t.h,nA(this,t.j),this.s=t.s,this.g=t.g,nC(this,t.m),this.l=t.l;var e=t.i,n=new nV;n.i=e.i,e.g&&(n.g=new Map(e.g),n.h=e.h),n_(this,n),this.o=t.o}else t&&(e=String(t).match(nT))?(this.h=!1,nA(this,e[1]||"",!0),this.s=nk(e[2]||""),this.g=nk(e[3]||"",!0),nC(this,e[4]),this.l=nk(e[5]||"",!0),n_(this,e[6]||"",!0),this.o=nk(e[7]||"")):(this.h=!1,this.i=new nV(null,this.h))}function nS(t){return new nI(t)}function nA(t,e,n){t.j=n?nk(e,!0):e,t.j&&(t.j=t.j.replace(/:$/,""))}function nC(t,e){if(e){if(isNaN(e=Number(e))||0>e)throw Error("Bad port number "+e);t.m=e}else t.m=null}function n_(t,e,n){var i,r;e instanceof nV?(t.i=e,i=t.i,(r=t.h)&&!i.j&&(nU(i),i.i=null,i.g.forEach(function(t,e){var n=e.toLowerCase();e!=n&&(nB(this,e),n$(this,n,t))},i)),i.j=r):(n||(e=nR(e,nP)),t.i=new nV(e,t.h))}function nD(t,e,n){t.i.set(e,n)}function nN(t){return nD(t,"zx",Math.floor(2147483648*Math.random()).toString(36)+Math.abs(Math.floor(2147483648*Math.random())^Date.now()).toString(36)),t}function nk(t,e){return t?e?decodeURI(t.replace(/%25/g,"%2525")):decodeURIComponent(t):""}function nR(t,e,n){return"string"==typeof t?(t=encodeURI(t).replace(e,nO),n&&(t=t.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),t):null}function nO(t){return"%"+((t=t.charCodeAt(0))>>4&15).toString(16)+(15&t).toString(16)}nI.prototype.toString=function(){var t=[],e=this.j;e&&t.push(nR(e,nL,!0),":");var n=this.g;return(n||"file"==e)&&(t.push("//"),(e=this.s)&&t.push(nR(e,nL,!0),"@"),t.push(encodeURIComponent(String(n)).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),null!=(n=this.m)&&t.push(":",String(n))),(n=this.l)&&(this.g&&"/"!=n.charAt(0)&&t.push("/"),t.push(nR(n,"/"==n.charAt(0)?nM:nx,!0))),(n=this.i.toString())&&t.push("?",n),(n=this.o)&&t.push("#",nR(n,nF)),t.join("")};var nL=/[#\/\?@]/g,nx=/[#\?:]/g,nM=/[#\?]/g,nP=/[#\?@]/g,nF=/#/g;function nV(t,e){this.h=this.g=null,this.i=t||null,this.j=!!e}function nU(t){t.g||(t.g=new Map,t.h=0,t.i&&function(t,e){if(t){t=t.split("&");for(var n=0;n<t.length;n++){var i=t[n].indexOf("="),r=null;if(0<=i){var s=t[n].substring(0,i);r=t[n].substring(i+1)}else s=t[n];e(s,r?decodeURIComponent(r.replace(/\+/g," ")):"")}}}(t.i,function(e,n){t.add(decodeURIComponent(e.replace(/\+/g," ")),n)}))}function nB(t,e){nU(t),e=nH(t,e),t.g.has(e)&&(t.i=null,t.h-=t.g.get(e).length,t.g.delete(e))}function nj(t,e){return nU(t),e=nH(t,e),t.g.has(e)}function n$(t,e,n){nB(t,e),0<n.length&&(t.i=null,t.g.set(nH(t,e),tZ(n)),t.h+=n.length)}function nH(t,e){return e=String(e),t.j&&(e=e.toLowerCase()),e}(tB=nV.prototype).add=function(t,e){nU(this),this.i=null,t=nH(this,t);var n=this.g.get(t);return n||this.g.set(t,n=[]),n.push(e),this.h+=1,this},tB.forEach=function(t,e){nU(this),this.g.forEach(function(n,i){n.forEach(function(n){t.call(e,n,i,this)},this)},this)},tB.ta=function(){nU(this);let t=Array.from(this.g.values()),e=Array.from(this.g.keys()),n=[];for(let i=0;i<e.length;i++){let r=t[i];for(let t=0;t<r.length;t++)n.push(e[i])}return n},tB.Z=function(t){nU(this);let e=[];if("string"==typeof t)nj(this,t)&&(e=e.concat(this.g.get(nH(this,t))));else{t=Array.from(this.g.values());for(let n=0;n<t.length;n++)e=e.concat(t[n])}return e},tB.set=function(t,e){return nU(this),this.i=null,nj(this,t=nH(this,t))&&(this.h-=this.g.get(t).length),this.g.set(t,[e]),this.h+=1,this},tB.get=function(t,e){return t&&0<(t=this.Z(t)).length?String(t[0]):e},tB.toString=function(){if(this.i)return this.i;if(!this.g)return"";let t=[],e=Array.from(this.g.keys());for(var n=0;n<e.length;n++){var i=e[n];let s=encodeURIComponent(String(i)),a=this.Z(i);for(i=0;i<a.length;i++){var r=s;""!==a[i]&&(r+="="+encodeURIComponent(String(a[i]))),t.push(r)}}return this.i=t.join("&")};var nz=class{constructor(t,e){this.g=t,this.map=e}};function nq(t){this.l=t||nG,t=tH.PerformanceNavigationTiming?0<(t=tH.performance.getEntriesByType("navigation")).length&&("hq"==t[0].nextHopProtocol||"h2"==t[0].nextHopProtocol):!!(tH.g&&tH.g.Ka&&tH.g.Ka()&&tH.g.Ka().ec),this.j=t?this.l:1,this.g=null,1<this.j&&(this.g=new Set),this.h=null,this.i=[]}var nG=10;function nK(t){return!!t.h||!!t.g&&t.g.size>=t.j}function nQ(t){return t.h?1:t.g?t.g.size:0}function nW(t,e){return t.h?t.h==e:!!t.g&&t.g.has(e)}function nX(t,e){t.g?t.g.add(e):t.h=e}function nY(t,e){t.h&&t.h==e?t.h=null:t.g&&t.g.has(e)&&t.g.delete(e)}function nJ(t){if(null!=t.h)return t.i.concat(t.h.F);if(null!=t.g&&0!==t.g.size){let e=t.i;for(let n of t.g.values())e=e.concat(n.F);return e}return tZ(t.i)}nq.prototype.cancel=function(){if(this.i=nJ(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&0!==this.g.size){for(let t of this.g.values())t.cancel();this.g.clear()}};var nZ=class{stringify(t){return tH.JSON.stringify(t,void 0)}parse(t){return tH.JSON.parse(t,void 0)}};function n0(){this.g=new nZ}function n1(t,e,n,i,r){try{e.onload=null,e.onerror=null,e.onabort=null,e.ontimeout=null,r(i)}catch(t){}}function n2(t){this.l=t.fc||null,this.j=t.ob||!1}function n9(t,e){eR.call(this),this.F=t,this.u=e,this.m=void 0,this.readyState=n4,this.status=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.v=new Headers,this.h=null,this.C="GET",this.B="",this.g=!1,this.A=this.j=this.l=null}tX(n2,e8),n2.prototype.g=function(){return new n9(this.l,this.j)},n2.prototype.i=(i={},function(){return i}),tX(n9,eR);var n4=0;function n6(t){t.j.read().then(t.Xa.bind(t)).catch(t.ka.bind(t))}function n5(t){t.readyState=4,t.l=null,t.j=null,t.A=null,n3(t)}function n3(t){t.onreadystatechange&&t.onreadystatechange.call(t)}(tB=n9.prototype).open=function(t,e){if(this.readyState!=n4)throw this.abort(),Error("Error reopening a connection");this.C=t,this.B=e,this.readyState=1,n3(this)},tB.send=function(t){if(1!=this.readyState)throw this.abort(),Error("need to call open() first. ");this.g=!0;let e={headers:this.v,method:this.C,credentials:this.m,cache:void 0};t&&(e.body=t),(this.F||tH).fetch(new Request(this.B,e)).then(this.$a.bind(this),this.ka.bind(this))},tB.abort=function(){this.response=this.responseText="",this.v=new Headers,this.status=0,this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),1<=this.readyState&&this.g&&4!=this.readyState&&(this.g=!1,n5(this)),this.readyState=n4},tB.$a=function(t){if(this.g&&(this.l=t,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=t.headers,this.readyState=2,n3(this)),this.g&&(this.readyState=3,n3(this),this.g))){if("arraybuffer"===this.responseType)t.arrayBuffer().then(this.Ya.bind(this),this.ka.bind(this));else if(void 0!==tH.ReadableStream&&"body"in t){if(this.j=t.body.getReader(),this.u){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.A=new TextDecoder;n6(this)}else t.text().then(this.Za.bind(this),this.ka.bind(this))}},tB.Xa=function(t){if(this.g){if(this.u&&t.value)this.response.push(t.value);else if(!this.u){var e=t.value?t.value:new Uint8Array(0);(e=this.A.decode(e,{stream:!t.done}))&&(this.response=this.responseText+=e)}t.done?n5(this):n3(this),3==this.readyState&&n6(this)}},tB.Za=function(t){this.g&&(this.response=this.responseText=t,n5(this))},tB.Ya=function(t){this.g&&(this.response=t,n5(this))},tB.ka=function(){this.g&&n5(this)},tB.setRequestHeader=function(t,e){this.v.append(t,e)},tB.getResponseHeader=function(t){return this.h&&this.h.get(t.toLowerCase())||""},tB.getAllResponseHeaders=function(){if(!this.h)return"";let t=[],e=this.h.entries();for(var n=e.next();!n.done;)t.push((n=n.value)[0]+": "+n[1]),n=e.next();return t.join("\r\n")},Object.defineProperty(n9.prototype,"withCredentials",{get:function(){return"include"===this.m},set:function(t){this.m=t?"include":"same-origin"}});var n7=tH.JSON.parse;function n8(t){eR.call(this),this.headers=new Map,this.u=t||null,this.h=!1,this.C=this.g=null,this.I="",this.m=0,this.j="",this.l=this.G=this.v=this.F=!1,this.B=0,this.A=null,this.K=it,this.L=this.M=!1}tX(n8,eR);var it="",ie=/^https?$/i,ii=["POST","PUT"];function ir(t,e){t.h=!1,t.g&&(t.l=!0,t.g.abort(),t.l=!1),t.j=e,t.m=5,is(t),io(t)}function is(t){t.F||(t.F=!0,eO(t,"complete"),eO(t,"error"))}function ia(t){if(t.h&&void 0!==t$&&(!t.C[1]||4!=ih(t)||2!=t.da())){if(t.v&&4==ih(t))ez(t.La,0,t);else if(eO(t,"readystatechange"),4==ih(t)){t.h=!1;try{let a=t.da();switch(a){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var e,n,i=!0;break;default:i=!1}if(!(e=i)){if(n=0===a){var r=String(t.I).match(nT)[1]||null;!r&&tH.self&&tH.self.location&&(r=tH.self.location.protocol.slice(0,-1)),n=!ie.test(r?r.toLowerCase():"")}e=n}if(e)eO(t,"complete"),eO(t,"success");else{t.m=6;try{var s=2<ih(t)?t.g.statusText:""}catch(t){s=""}t.j=s+" ["+t.da()+"]",is(t)}}finally{io(t)}}}}function io(t,e){if(t.g){il(t);let n=t.g,i=t.C[0]?()=>{}:null;t.g=null,t.C=null,e||eO(t,"ready");try{n.onreadystatechange=i}catch(t){}}}function il(t){t.g&&t.L&&(t.g.ontimeout=null),t.A&&(tH.clearTimeout(t.A),t.A=null)}function ih(t){return t.g?t.g.readyState:0}function iu(t){try{if(!t.g)return null;if("response"in t.g)return t.g.response;switch(t.K){case it:case"text":return t.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in t.g)return t.g.mozResponseArrayBuffer}return null}catch(t){return null}}function ic(t){let e="";return eg(t,function(t,n){e+=n+":"+t+"\r\n"}),e}function id(t,e,n){t:{for(i in n){var i=!1;break t}i=!0}i||(n=ic(n),"string"==typeof t?null!=n&&encodeURIComponent(String(n)):nD(t,e,n))}function ip(t,e,n){return n&&n.internalChannelParams&&n.internalChannelParams[t]||e}function ig(t){this.Ga=0,this.j=[],this.l=new eX,this.pa=this.wa=this.I=this.Y=this.g=this.Da=this.F=this.na=this.o=this.U=this.s=null,this.fb=this.W=0,this.cb=ip("failFast",!1,t),this.G=this.v=this.u=this.m=this.h=null,this.aa=!0,this.Fa=this.V=-1,this.ba=this.A=this.C=0,this.ab=ip("baseRetryDelayMs",5e3,t),this.hb=ip("retryDelaySeedMs",1e4,t),this.eb=ip("forwardChannelMaxRetries",2,t),this.xa=ip("forwardChannelRequestTimeoutMs",2e4,t),this.va=t&&t.xmlHttpFactory||void 0,this.Ha=t&&t.dc||!1,this.L=void 0,this.J=t&&t.supportsCrossDomainXhr||!1,this.K="",this.i=new nq(t&&t.concurrentRequestLimit),this.Ja=new n0,this.P=t&&t.fastHandshake||!1,this.O=t&&t.encodeInitMessageHeaders||!1,this.P&&this.O&&(this.O=!1),this.bb=t&&t.bc||!1,t&&t.Ea&&this.l.Ea(),t&&t.forceLongPolling&&(this.aa=!1),this.ca=!this.P&&this.aa&&t&&t.detectBufferingProxy||!1,this.qa=void 0,t&&t.longPollingTimeout&&0<t.longPollingTimeout&&(this.qa=t.longPollingTimeout),this.oa=void 0,this.S=0,this.M=!1,this.ma=this.B=null}function im(t){if(iv(t),3==t.H){var e=t.W++,n=nS(t.I);if(nD(n,"SID",t.K),nD(n,"RID",e),nD(n,"TYPE","terminate"),ib(t,n),(e=new na(t,t.l,e)).L=2,e.v=nN(nS(n)),n=!1,tH.navigator&&tH.navigator.sendBeacon)try{n=tH.navigator.sendBeacon(e.v.toString(),"")}catch(t){}!n&&tH.Image&&((new Image).src=e.v,n=!0),n||(e.g=iL(e.l,null),e.g.ha(e.v)),e.G=Date.now(),ng(e)}iR(t)}function iy(t){t.g&&(iA(t),t.g.cancel(),t.g=null)}function iv(t){iy(t),t.u&&(tH.clearTimeout(t.u),t.u=null),i_(t),t.i.cancel(),t.m&&("number"==typeof t.m&&tH.clearTimeout(t.m),t.m=null)}function iw(t){if(!nK(t.i)&&!t.m){t.m=!0;var e=t.Na;eF||eB(),eV||(eF(),eV=!0),eU.add(e,t),t.C=0}}function iE(t,e){var n;n=e?e.m:t.W++;let i=nS(t.I);nD(i,"SID",t.K),nD(i,"RID",n),nD(i,"AID",t.V),ib(t,i),t.o&&t.s&&id(i,t.o,t.s),n=new na(t,t.l,n,t.C+1),null===t.o&&(n.I=t.s),e&&(t.j=e.F.concat(t.j)),e=iT(t,n,1e3),n.setTimeout(Math.round(.5*t.xa)+Math.round(.5*t.xa*Math.random())),nX(t.i,n),nc(n,i,e)}function ib(t,e){t.na&&eg(t.na,function(t,n){nD(e,n,t)}),t.h&&nb({},function(t,n){nD(e,n,t)})}function iT(t,e,n){n=Math.min(t.j.length,n);var i=t.h?tQ(t.h.Va,t.h,t):null;t:{var r=t.j;let e=-1;for(;;){let t=["count="+n];-1==e?0<n?(e=r[0].g,t.push("ofs="+e)):e=0:t.push("ofs="+e);let s=!0;for(let a=0;a<n;a++){let n=r[a].g,o=r[a].map;if(0>(n-=e))e=Math.max(0,r[a].g-100),s=!1;else try{!function(t,e,n){let i=n||"";try{nb(t,function(t,n){let r=t;tq(t)&&(r=ex(t)),e.push(i+n+"="+encodeURIComponent(r))})}catch(t){throw e.push(i+"type="+encodeURIComponent("_badmap")),t}}(o,t,"req"+n+"_")}catch(t){i&&i(o)}}if(s){i=t.join("&");break t}}}return t=t.j.splice(0,n),e.F=t,i}function iI(t){if(!t.g&&!t.u){t.ba=1;var e=t.Ma;eF||eB(),eV||(eF(),eV=!0),eU.add(e,t),t.A=0}}function iS(t){return!t.g&&!t.u&&!(3<=t.A)&&(t.ba++,t.u=e5(tQ(t.Ma,t),iN(t,t.A)),t.A++,!0)}function iA(t){null!=t.B&&(tH.clearTimeout(t.B),t.B=null)}function iC(t){t.g=new na(t,t.l,"rpc",t.ba),null===t.o&&(t.g.I=t.s),t.g.O=0;var e=nS(t.wa);nD(e,"RID","rpc"),nD(e,"SID",t.K),nD(e,"AID",t.V),nD(e,"CI",t.G?"0":"1"),!t.G&&t.qa&&nD(e,"TO",t.qa),nD(e,"TYPE","xmlhttp"),ib(t,e),t.o&&t.s&&id(e,t.o,t.s),t.L&&t.g.setTimeout(t.L);var n=t.g;t=t.pa,n.L=1,n.v=nN(nS(e)),n.s=null,n.S=!0,nf(n,t)}function i_(t){null!=t.v&&(tH.clearTimeout(t.v),t.v=null)}function iD(t,e){var n=null;if(t.g==e){i_(t),iA(t),t.g=null;var i=2}else{if(!nW(t.i,e))return;n=e.F,nY(t.i,e),i=1}if(0!=t.H){if(e.i){if(1==i){n=e.s?e.s.length:0,e=Date.now()-e.G;var r,s=t.C;eO(i=e0(),new e6(i,n)),iw(t)}else iI(t)}else if(3==(s=e.o)||0==s&&0<e.ca||!(1==i&&(r=e,!(nQ(t.i)>=t.i.j-(t.m?1:0))&&(t.m?(t.j=r.F.concat(t.j),!0):1!=t.H&&2!=t.H&&!(t.C>=(t.cb?0:t.eb))&&(t.m=e5(tQ(t.Na,t,r),iN(t,t.C)),t.C++,!0)))||2==i&&iS(t)))switch(n&&0<n.length&&((e=t.i).i=e.i.concat(n)),s){case 1:ik(t,5);break;case 4:ik(t,10);break;case 3:ik(t,6);break;default:ik(t,2)}}}function iN(t,e){let n=t.ab+Math.floor(Math.random()*t.hb);return t.isActive()||(n*=2),n*e}function ik(t,e){if(t.l.info("Error code "+e),2==e){var n=null;t.h&&(n=null);var i=tQ(t.pb,t);n||(n=new nI("//www.google.com/images/cleardot.gif"),tH.location&&"http"==tH.location.protocol||nA(n,"https"),nN(n)),function(t,e){let n=new eX;if(tH.Image){let i=new Image;i.onload=tW(n1,n,i,"TestLoadImage: loaded",!0,e),i.onerror=tW(n1,n,i,"TestLoadImage: error",!1,e),i.onabort=tW(n1,n,i,"TestLoadImage: abort",!1,e),i.ontimeout=tW(n1,n,i,"TestLoadImage: timeout",!1,e),tH.setTimeout(function(){i.ontimeout&&i.ontimeout()},1e4),i.src=t}else e(!1)}(n.toString(),i)}else e4(2);t.H=0,t.h&&t.h.za(e),iR(t),iv(t)}function iR(t){if(t.H=0,t.ma=[],t.h){let e=nJ(t.i);(0!=e.length||0!=t.j.length)&&(t0(t.ma,e),t0(t.ma,t.j),t.i.i.length=0,tZ(t.j),t.j.length=0),t.h.ya()}}function iO(t,e,n){var i=n instanceof nI?nS(n):new nI(n);if(""!=i.g)e&&(i.g=e+"."+i.g),nC(i,i.m);else{var r=tH.location;i=r.protocol,e=e?e+"."+r.hostname:r.hostname,r=+r.port;var s=new nI(null);i&&nA(s,i),e&&(s.g=e),r&&nC(s,r),n&&(s.l=n),i=s}return n=t.F,e=t.Da,n&&e&&nD(i,n,e),nD(i,"VER",t.ra),ib(t,i),i}function iL(t,e,n){if(e&&!t.J)throw Error("Can't create secondary domain capable XhrIo object.");return(e=new n8(n&&t.Ha&&!t.va?new n2({ob:!0}):t.va)).Oa(t.J),e}function ix(){}function iM(){if(t7&&!(10<=Number(el)))throw Error("Environmental error: no available transport.")}function iP(t,e){eR.call(this),this.g=new ig(e),this.l=t,this.h=e&&e.messageUrlParams||null,t=e&&e.messageHeaders||null,e&&e.clientProtocolHeaderRequired&&(t?t["X-Client-Protocol"]="webchannel":t={"X-Client-Protocol":"webchannel"}),this.g.s=t,t=e&&e.initMessageHeaders||null,e&&e.messageContentType&&(t?t["X-WebChannel-Content-Type"]=e.messageContentType:t={"X-WebChannel-Content-Type":e.messageContentType}),e&&e.Ca&&(t?t["X-WebChannel-Client-Profile"]=e.Ca:t={"X-WebChannel-Client-Profile":e.Ca}),this.g.U=t,(t=e&&e.cc)&&!t9(t)&&(this.g.o=t),this.A=e&&e.supportsCrossDomainXhr||!1,this.v=e&&e.sendRawJson||!1,(e=e&&e.httpSessionIdParam)&&!t9(e)&&(this.g.F=e,null!==(t=this.h)&&e in t&&e in(t=this.h)&&delete t[e]),this.j=new iU(this)}function iF(t){ni.call(this),t.__headers__&&(this.headers=t.__headers__,this.statusCode=t.__status__,delete t.__headers__,delete t.__status__);var e=t.__sm__;if(e){t:{for(let n in e){t=n;break t}t=void 0}(this.i=t)&&(t=this.i,e=null!==e&&t in e?e[t]:void 0),this.data=e}else this.data=t}function iV(){nr.call(this),this.status=1}function iU(t){this.g=t}function iB(){this.blockSize=-1,this.blockSize=64,this.g=[,,,,],this.m=Array(this.blockSize),this.i=this.h=0,this.reset()}function ij(t,e,n){n||(n=0);var i=Array(16);if("string"==typeof e)for(var r=0;16>r;++r)i[r]=e.charCodeAt(n++)|e.charCodeAt(n++)<<8|e.charCodeAt(n++)<<16|e.charCodeAt(n++)<<24;else for(r=0;16>r;++r)i[r]=e[n++]|e[n++]<<8|e[n++]<<16|e[n++]<<24;e=t.g[0],n=t.g[1],r=t.g[2];var s=t.g[3],a=e+(s^n&(r^s))+i[0]+3614090360&4294967295;a=s+(r^(e=n+(a<<7&4294967295|a>>>25))&(n^r))+i[1]+3905402710&4294967295,a=r+(n^(s=e+(a<<12&4294967295|a>>>20))&(e^n))+i[2]+606105819&4294967295,a=n+(e^(r=s+(a<<17&4294967295|a>>>15))&(s^e))+i[3]+3250441966&4294967295,a=e+(s^(n=r+(a<<22&4294967295|a>>>10))&(r^s))+i[4]+4118548399&4294967295,a=s+(r^(e=n+(a<<7&4294967295|a>>>25))&(n^r))+i[5]+1200080426&4294967295,a=r+(n^(s=e+(a<<12&4294967295|a>>>20))&(e^n))+i[6]+2821735955&4294967295,a=n+(e^(r=s+(a<<17&4294967295|a>>>15))&(s^e))+i[7]+4249261313&4294967295,a=e+(s^(n=r+(a<<22&4294967295|a>>>10))&(r^s))+i[8]+1770035416&4294967295,a=s+(r^(e=n+(a<<7&4294967295|a>>>25))&(n^r))+i[9]+2336552879&4294967295,a=r+(n^(s=e+(a<<12&4294967295|a>>>20))&(e^n))+i[10]+4294925233&4294967295,a=n+(e^(r=s+(a<<17&4294967295|a>>>15))&(s^e))+i[11]+2304563134&4294967295,a=e+(s^(n=r+(a<<22&4294967295|a>>>10))&(r^s))+i[12]+1804603682&4294967295,a=s+(r^(e=n+(a<<7&4294967295|a>>>25))&(n^r))+i[13]+4254626195&4294967295,a=r+(n^(s=e+(a<<12&4294967295|a>>>20))&(e^n))+i[14]+2792965006&4294967295,a=n+(e^(r=s+(a<<17&4294967295|a>>>15))&(s^e))+i[15]+1236535329&4294967295,n=r+(a<<22&4294967295|a>>>10),a=e+(r^s&(n^r))+i[1]+4129170786&4294967295,e=n+(a<<5&4294967295|a>>>27),a=s+(n^r&(e^n))+i[6]+3225465664&4294967295,s=e+(a<<9&4294967295|a>>>23),a=r+(e^n&(s^e))+i[11]+643717713&4294967295,r=s+(a<<14&4294967295|a>>>18),a=n+(s^e&(r^s))+i[0]+3921069994&4294967295,n=r+(a<<20&4294967295|a>>>12),a=e+(r^s&(n^r))+i[5]+3593408605&4294967295,e=n+(a<<5&4294967295|a>>>27),a=s+(n^r&(e^n))+i[10]+38016083&4294967295,s=e+(a<<9&4294967295|a>>>23),a=r+(e^n&(s^e))+i[15]+3634488961&4294967295,r=s+(a<<14&4294967295|a>>>18),a=n+(s^e&(r^s))+i[4]+3889429448&4294967295,n=r+(a<<20&4294967295|a>>>12),a=e+(r^s&(n^r))+i[9]+568446438&4294967295,e=n+(a<<5&4294967295|a>>>27),a=s+(n^r&(e^n))+i[14]+3275163606&4294967295,s=e+(a<<9&4294967295|a>>>23),a=r+(e^n&(s^e))+i[3]+4107603335&4294967295,r=s+(a<<14&4294967295|a>>>18),a=n+(s^e&(r^s))+i[8]+1163531501&4294967295,n=r+(a<<20&4294967295|a>>>12),a=e+(r^s&(n^r))+i[13]+2850285829&4294967295,e=n+(a<<5&4294967295|a>>>27),a=s+(n^r&(e^n))+i[2]+4243563512&4294967295,s=e+(a<<9&4294967295|a>>>23),a=r+(e^n&(s^e))+i[7]+1735328473&4294967295,r=s+(a<<14&4294967295|a>>>18),a=n+(s^e&(r^s))+i[12]+2368359562&4294967295,a=e+((n=r+(a<<20&4294967295|a>>>12))^r^s)+i[5]+4294588738&4294967295,a=s+((e=n+(a<<4&4294967295|a>>>28))^n^r)+i[8]+2272392833&4294967295,a=r+((s=e+(a<<11&4294967295|a>>>21))^e^n)+i[11]+1839030562&4294967295,a=n+((r=s+(a<<16&4294967295|a>>>16))^s^e)+i[14]+4259657740&4294967295,a=e+((n=r+(a<<23&4294967295|a>>>9))^r^s)+i[1]+2763975236&4294967295,a=s+((e=n+(a<<4&4294967295|a>>>28))^n^r)+i[4]+1272893353&4294967295,a=r+((s=e+(a<<11&4294967295|a>>>21))^e^n)+i[7]+4139469664&4294967295,a=n+((r=s+(a<<16&4294967295|a>>>16))^s^e)+i[10]+3200236656&4294967295,a=e+((n=r+(a<<23&4294967295|a>>>9))^r^s)+i[13]+681279174&4294967295,a=s+((e=n+(a<<4&4294967295|a>>>28))^n^r)+i[0]+3936430074&4294967295,a=r+((s=e+(a<<11&4294967295|a>>>21))^e^n)+i[3]+3572445317&4294967295,a=n+((r=s+(a<<16&4294967295|a>>>16))^s^e)+i[6]+76029189&4294967295,a=e+((n=r+(a<<23&4294967295|a>>>9))^r^s)+i[9]+3654602809&4294967295,a=s+((e=n+(a<<4&4294967295|a>>>28))^n^r)+i[12]+3873151461&4294967295,a=r+((s=e+(a<<11&4294967295|a>>>21))^e^n)+i[15]+530742520&4294967295,a=n+((r=s+(a<<16&4294967295|a>>>16))^s^e)+i[2]+3299628645&4294967295,n=r+(a<<23&4294967295|a>>>9),a=e+(r^(n|~s))+i[0]+4096336452&4294967295,e=n+(a<<6&4294967295|a>>>26),a=s+(n^(e|~r))+i[7]+1126891415&4294967295,s=e+(a<<10&4294967295|a>>>22),a=r+(e^(s|~n))+i[14]+2878612391&4294967295,r=s+(a<<15&4294967295|a>>>17),a=n+(s^(r|~e))+i[5]+4237533241&4294967295,n=r+(a<<21&4294967295|a>>>11),a=e+(r^(n|~s))+i[12]+1700485571&4294967295,e=n+(a<<6&4294967295|a>>>26),a=s+(n^(e|~r))+i[3]+2399980690&4294967295,s=e+(a<<10&4294967295|a>>>22),a=r+(e^(s|~n))+i[10]+4293915773&4294967295,r=s+(a<<15&4294967295|a>>>17),a=n+(s^(r|~e))+i[1]+2240044497&4294967295,n=r+(a<<21&4294967295|a>>>11),a=e+(r^(n|~s))+i[8]+1873313359&4294967295,e=n+(a<<6&4294967295|a>>>26),a=s+(n^(e|~r))+i[15]+4264355552&4294967295,s=e+(a<<10&4294967295|a>>>22),a=r+(e^(s|~n))+i[6]+2734768916&4294967295,r=s+(a<<15&4294967295|a>>>17),a=n+(s^(r|~e))+i[13]+1309151649&4294967295,n=r+(a<<21&4294967295|a>>>11),a=e+(r^(n|~s))+i[4]+4149444226&4294967295,e=n+(a<<6&4294967295|a>>>26),a=s+(n^(e|~r))+i[11]+3174756917&4294967295,s=e+(a<<10&4294967295|a>>>22),a=r+(e^(s|~n))+i[2]+718787259&4294967295,r=s+(a<<15&4294967295|a>>>17),a=n+(s^(r|~e))+i[9]+3951481745&4294967295,t.g[0]=t.g[0]+e&4294967295,t.g[1]=t.g[1]+(r+(a<<21&4294967295|a>>>11))&4294967295,t.g[2]=t.g[2]+r&4294967295,t.g[3]=t.g[3]+s&4294967295}function i$(t,e){this.h=e;for(var n=[],i=!0,r=t.length-1;0<=r;r--){var s=0|t[r];i&&s==e||(n[r]=s,i=!1)}this.g=n}(tB=n8.prototype).Oa=function(t){this.M=t},tB.ha=function(t,e,n,i){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.I+"; newUri="+t);e=e?e.toUpperCase():"GET",this.I=t,this.j="",this.m=0,this.F=!1,this.h=!0,this.g=this.u?this.u.g():a.g(),this.C=this.u?nt(this.u):nt(a),this.g.onreadystatechange=tQ(this.La,this);try{this.G=!0,this.g.open(e,String(t),!0),this.G=!1}catch(t){ir(this,t);return}if(t=n||"",n=new Map(this.headers),i){if(Object.getPrototypeOf(i)===Object.prototype)for(var r in i)n.set(r,i[r]);else if("function"==typeof i.keys&&"function"==typeof i.get)for(let t of i.keys())n.set(t,i.get(t));else throw Error("Unknown input type for opt_headers: "+String(i))}for(let[s,a]of(i=Array.from(n.keys()).find(t=>"content-type"==t.toLowerCase()),r=tH.FormData&&t instanceof tH.FormData,!(0<=tJ(ii,e))||i||r||n.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8"),n))this.g.setRequestHeader(s,a);this.K&&(this.g.responseType=this.K),"withCredentials"in this.g&&this.g.withCredentials!==this.M&&(this.g.withCredentials=this.M);try{var s;il(this),0<this.B&&((this.L=(s=this.g,t7&&"number"==typeof s.timeout&&void 0!==s.ontimeout))?(this.g.timeout=this.B,this.g.ontimeout=tQ(this.ua,this)):this.A=ez(this.ua,this.B,this)),this.v=!0,this.g.send(t),this.v=!1}catch(t){ir(this,t)}},tB.ua=function(){void 0!==t$&&this.g&&(this.j="Timed out after "+this.B+"ms, aborting",this.m=8,eO(this,"timeout"),this.abort(8))},tB.abort=function(t){this.g&&this.h&&(this.h=!1,this.l=!0,this.g.abort(),this.l=!1,this.m=t||7,eO(this,"complete"),eO(this,"abort"),io(this))},tB.N=function(){this.g&&(this.h&&(this.h=!1,this.l=!0,this.g.abort(),this.l=!1),io(this,!0)),n8.$.N.call(this)},tB.La=function(){this.s||(this.G||this.v||this.l?ia(this):this.kb())},tB.kb=function(){ia(this)},tB.isActive=function(){return!!this.g},tB.da=function(){try{return 2<ih(this)?this.g.status:-1}catch(t){return -1}},tB.ja=function(){try{return this.g?this.g.responseText:""}catch(t){return""}},tB.Wa=function(t){if(this.g){var e=this.g.responseText;return t&&0==e.indexOf(t)&&(e=e.substring(t.length)),n7(e)}},tB.Ia=function(){return this.m},tB.Sa=function(){return"string"==typeof this.j?this.j:String(this.j)},(tB=ig.prototype).ra=8,tB.H=1,tB.Na=function(t){if(this.m){if(this.m=null,1==this.H){if(!t){this.W=Math.floor(1e5*Math.random()),t=this.W++;let r=new na(this,this.l,t),s=this.s;if(this.U&&(s?ev(s=em(s),this.U):s=this.U),null!==this.o||this.O||(r.I=s,s=null),this.P)t:{for(var e=0,n=0;n<this.j.length;n++){e:{var i=this.j[n];if("__data__"in i.map&&"string"==typeof(i=i.map.__data__)){i=i.length;break e}i=void 0}if(void 0===i)break;if(4096<(e+=i)){e=n;break t}if(4096===e||n===this.j.length-1){e=n+1;break t}}e=1e3}else e=1e3;e=iT(this,r,e),nD(n=nS(this.I),"RID",t),nD(n,"CVER",22),this.F&&nD(n,"X-HTTP-Session-Id",this.F),ib(this,n),s&&(this.O?e="headers="+encodeURIComponent(String(ic(s)))+"&"+e:this.o&&id(n,this.o,s)),nX(this.i,r),this.bb&&nD(n,"TYPE","init"),this.P?(nD(n,"$req",e),nD(n,"SID","null"),r.aa=!0,nc(r,n,null)):nc(r,n,e),this.H=2}}else 3==this.H&&(t?iE(this,t):0==this.j.length||nK(this.i)||iE(this))}},tB.Ma=function(){if(this.u=null,iC(this),this.ca&&!(this.M||null==this.g||0>=this.S)){var t=2*this.S;this.l.info("BP detection timer enabled: "+t),this.B=e5(tQ(this.jb,this),t)}},tB.jb=function(){this.B&&(this.B=null,this.l.info("BP detection timeout reached."),this.l.info("Buffering proxy detected and switch to long-polling!"),this.G=!1,this.M=!0,e4(10),iy(this),iC(this))},tB.ib=function(){null!=this.v&&(this.v=null,iy(this),iS(this),e4(19))},tB.pb=function(t){t?(this.l.info("Successfully pinged google.com"),e4(2)):(this.l.info("Failed to ping google.com"),e4(1))},tB.isActive=function(){return!!this.h&&this.h.isActive(this)},(tB=ix.prototype).Ba=function(){},tB.Aa=function(){},tB.za=function(){},tB.ya=function(){},tB.isActive=function(){return!0},tB.Va=function(){},iM.prototype.g=function(t,e){return new iP(t,e)},tX(iP,eR),iP.prototype.m=function(){this.g.h=this.j,this.A&&(this.g.J=!0);var t=this.g,e=this.l,n=this.h||void 0;e4(0),t.Y=e,t.na=n||{},t.G=t.aa,t.I=iO(t,null,t.Y),iw(t)},iP.prototype.close=function(){im(this.g)},iP.prototype.u=function(t){var e=this.g;if("string"==typeof t){var n={};n.__data__=t,t=n}else this.v&&((n={}).__data__=ex(t),t=n);e.j.push(new nz(e.fb++,t)),3==e.H&&iw(e)},iP.prototype.N=function(){this.g.h=null,delete this.j,im(this.g),delete this.g,iP.$.N.call(this)},tX(iF,ni),tX(iV,nr),tX(iU,ix),iU.prototype.Ba=function(){eO(this.g,"a")},iU.prototype.Aa=function(t){eO(this.g,new iF(t))},iU.prototype.za=function(t){eO(this.g,new iV)},iU.prototype.ya=function(){eO(this.g,"b")},tX(iB,function(){this.blockSize=-1}),iB.prototype.reset=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.i=this.h=0},iB.prototype.j=function(t,e){void 0===e&&(e=t.length);for(var n=e-this.blockSize,i=this.m,r=this.h,s=0;s<e;){if(0==r)for(;s<=n;)ij(this,t,s),s+=this.blockSize;if("string"==typeof t){for(;s<e;)if(i[r++]=t.charCodeAt(s++),r==this.blockSize){ij(this,i),r=0;break}}else for(;s<e;)if(i[r++]=t[s++],r==this.blockSize){ij(this,i),r=0;break}}this.h=r,this.i+=e},iB.prototype.l=function(){var t=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);t[0]=128;for(var e=1;e<t.length-8;++e)t[e]=0;var n=8*this.i;for(e=t.length-8;e<t.length;++e)t[e]=255&n,n/=256;for(this.j(t),t=Array(16),e=n=0;4>e;++e)for(var i=0;32>i;i+=8)t[n++]=this.g[e]>>>i&255;return t};var iH={};function iz(t){var e;return -128<=t&&128>t?(e=function(t){return new i$([0|t],0>t?-1:0)},Object.prototype.hasOwnProperty.call(iH,t)?iH[t]:iH[t]=e(t)):new i$([0|t],0>t?-1:0)}function iq(t){if(isNaN(t)||!isFinite(t))return iK;if(0>t)return iJ(iq(-t));for(var e=[],n=1,i=0;t>=n;i++)e[i]=t/n|0,n*=iG;return new i$(e,0)}var iG=4294967296,iK=iz(0),iQ=iz(1),iW=iz(16777216);function iX(t){if(0!=t.h)return!1;for(var e=0;e<t.g.length;e++)if(0!=t.g[e])return!1;return!0}function iY(t){return -1==t.h}function iJ(t){for(var e=t.g.length,n=[],i=0;i<e;i++)n[i]=~t.g[i];return new i$(n,~t.h).add(iQ)}function iZ(t,e){return t.add(iJ(e))}function i0(t,e){for(;(65535&t[e])!=t[e];)t[e+1]+=t[e]>>>16,t[e]&=65535,e++}function i1(t,e){this.g=t,this.h=e}function i2(t,e){if(iX(e))throw Error("division by zero");if(iX(t))return new i1(iK,iK);if(iY(t))return e=i2(iJ(t),e),new i1(iJ(e.g),iJ(e.h));if(iY(e))return e=i2(t,iJ(e)),new i1(iJ(e.g),e.h);if(30<t.g.length){if(iY(t)||iY(e))throw Error("slowDivide_ only works with positive integers.");for(var n=iQ,i=e;0>=i.X(t);)n=i9(n),i=i9(i);var r=i4(n,1),s=i4(i,1);for(i=i4(i,2),n=i4(n,2);!iX(i);){var a=s.add(i);0>=a.X(t)&&(r=r.add(n),s=a),i=i4(i,1),n=i4(n,1)}return e=iZ(t,r.R(e)),new i1(r,e)}for(r=iK;0<=t.X(e);){for(i=48>=(i=Math.ceil(Math.log(n=Math.max(1,Math.floor(t.ea()/e.ea())))/Math.LN2))?1:Math.pow(2,i-48),a=(s=iq(n)).R(e);iY(a)||0<a.X(t);)n-=i,a=(s=iq(n)).R(e);iX(s)&&(s=iQ),r=r.add(s),t=iZ(t,a)}return new i1(r,t)}function i9(t){for(var e=t.g.length+1,n=[],i=0;i<e;i++)n[i]=t.D(i)<<1|t.D(i-1)>>>31;return new i$(n,t.h)}function i4(t,e){var n=e>>5;e%=32;for(var i=t.g.length-n,r=[],s=0;s<i;s++)r[s]=0<e?t.D(s+n)>>>e|t.D(s+n+1)<<32-e:t.D(s+n);return new i$(r,t.h)}(tB=i$.prototype).ea=function(){if(iY(this))return-iJ(this).ea();for(var t=0,e=1,n=0;n<this.g.length;n++){var i=this.D(n);t+=(0<=i?i:iG+i)*e,e*=iG}return t},tB.toString=function(t){if(2>(t=t||10)||36<t)throw Error("radix out of range: "+t);if(iX(this))return"0";if(iY(this))return"-"+iJ(this).toString(t);for(var e=iq(Math.pow(t,6)),n=this,i="";;){var r=i2(n,e).g,s=((0<(n=iZ(n,r.R(e))).g.length?n.g[0]:n.h)>>>0).toString(t);if(iX(n=r))return s+i;for(;6>s.length;)s="0"+s;i=s+i}},tB.D=function(t){return 0>t?0:t<this.g.length?this.g[t]:this.h},tB.X=function(t){return iY(t=iZ(this,t))?-1:iX(t)?0:1},tB.abs=function(){return iY(this)?iJ(this):this},tB.add=function(t){for(var e=Math.max(this.g.length,t.g.length),n=[],i=0,r=0;r<=e;r++){var s=i+(65535&this.D(r))+(65535&t.D(r)),a=(s>>>16)+(this.D(r)>>>16)+(t.D(r)>>>16);i=a>>>16,s&=65535,a&=65535,n[r]=a<<16|s}return new i$(n,-2147483648&n[n.length-1]?-1:0)},tB.R=function(t){if(iX(this)||iX(t))return iK;if(iY(this))return iY(t)?iJ(this).R(iJ(t)):iJ(iJ(this).R(t));if(iY(t))return iJ(this.R(iJ(t)));if(0>this.X(iW)&&0>t.X(iW))return iq(this.ea()*t.ea());for(var e=this.g.length+t.g.length,n=[],i=0;i<2*e;i++)n[i]=0;for(i=0;i<this.g.length;i++)for(var r=0;r<t.g.length;r++){var s=this.D(i)>>>16,a=65535&this.D(i),o=t.D(r)>>>16,l=65535&t.D(r);n[2*i+2*r]+=a*l,i0(n,2*i+2*r),n[2*i+2*r+1]+=s*l,i0(n,2*i+2*r+1),n[2*i+2*r+1]+=a*o,i0(n,2*i+2*r+1),n[2*i+2*r+2]+=s*o,i0(n,2*i+2*r+2)}for(i=0;i<e;i++)n[i]=n[2*i+1]<<16|n[2*i];for(i=e;i<2*e;i++)n[i]=0;return new i$(n,0)},tB.gb=function(t){return i2(this,t).h},tB.and=function(t){for(var e=Math.max(this.g.length,t.g.length),n=[],i=0;i<e;i++)n[i]=this.D(i)&t.D(i);return new i$(n,this.h&t.h)},tB.or=function(t){for(var e=Math.max(this.g.length,t.g.length),n=[],i=0;i<e;i++)n[i]=this.D(i)|t.D(i);return new i$(n,this.h|t.h)},tB.xor=function(t){for(var e=Math.max(this.g.length,t.g.length),n=[],i=0;i<e;i++)n[i]=this.D(i)^t.D(i);return new i$(n,this.h^t.h)},iM.prototype.createWebChannel=iM.prototype.g,iP.prototype.send=iP.prototype.u,iP.prototype.open=iP.prototype.m,iP.prototype.close=iP.prototype.close,e3.NO_ERROR=0,e3.TIMEOUT=8,e3.HTTP_ERROR=6,e7.COMPLETE="complete",ne.EventType=nn,nn.OPEN="a",nn.CLOSE="b",nn.ERROR="c",nn.MESSAGE="d",eR.prototype.listen=eR.prototype.O,n8.prototype.listenOnce=n8.prototype.P,n8.prototype.getLastError=n8.prototype.Sa,n8.prototype.getLastErrorCode=n8.prototype.Ia,n8.prototype.getStatus=n8.prototype.da,n8.prototype.getResponseJson=n8.prototype.Wa,n8.prototype.getResponseText=n8.prototype.ja,n8.prototype.send=n8.prototype.ha,n8.prototype.setWithCredentials=n8.prototype.Oa,iB.prototype.digest=iB.prototype.l,iB.prototype.reset=iB.prototype.reset,iB.prototype.update=iB.prototype.j,i$.prototype.add=i$.prototype.add,i$.prototype.multiply=i$.prototype.R,i$.prototype.modulo=i$.prototype.gb,i$.prototype.compare=i$.prototype.X,i$.prototype.toNumber=i$.prototype.ea,i$.prototype.toString=i$.prototype.toString,i$.prototype.getBits=i$.prototype.D,i$.fromNumber=iq,i$.fromString=function t(e,n){if(0==e.length)throw Error("number format error: empty string");if(2>(n=n||10)||36<n)throw Error("radix out of range: "+n);if("-"==e.charAt(0))return iJ(t(e.substring(1),n));if(0<=e.indexOf("-"))throw Error('number format error: interior "-" character');for(var i=iq(Math.pow(n,8)),r=iK,s=0;s<e.length;s+=8){var a=Math.min(8,e.length-s),o=parseInt(e.substring(s,s+a),n);8>a?(a=iq(Math.pow(n,a)),r=r.R(a).add(iq(o))):r=(r=r.R(i)).add(iq(o))}return r};var i6=tj.createWebChannelTransport=function(){return new iM},i5=tj.getStatEventTarget=function(){return e0()},i3=tj.ErrorCode=e3,i7=tj.EventType=e7,i8=tj.Event=eJ,rt=tj.Stat={xb:0,Ab:1,Bb:2,Ub:3,Zb:4,Wb:5,Xb:6,Vb:7,Tb:8,Yb:9,PROXY:10,NOPROXY:11,Rb:12,Nb:13,Ob:14,Mb:15,Pb:16,Qb:17,tb:18,sb:19,ub:20},re=tj.FetchXmlHttpFactory=n2,rn=tj.WebChannel=ne,ri=tj.XhrIo=n8;tj.Md5=iB;var rr=tj.Integer=i$;const rs="@firebase/firestore";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rC{static A(){let t="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",e=Math.floor(256/t.length)*t.length,n="";for(;n.length<20;){let i=/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rN{constructor(t,e){if(this.seconds=t,this.nanoseconds=e,e<0||e>=1e9)throw new rm(rg.INVALID_ARGUMENT,"Timestamp nanoseconds out of range: "+e);if(t<-62135596800||t>=253402300800)throw new rm(rg.INVALID_ARGUMENT,"Timestamp seconds out of range: "+t)}static now(){return rN.fromMillis(Date.now())}static fromDate(t){return rN.fromMillis(t.getTime())}static fromMillis(t){let e=Math.floor(t/1e3);return new rN(e,Math.floor(1e6*(t-1e3*e)))}toDate(){return new Date(this.toMillis())}toMillis(){return 1e3*this.seconds+this.nanoseconds/1e6}_compareTo(t){return this.seconds===t.seconds?r_(this.nanoseconds,t.nanoseconds):r_(this.seconds,t.seconds)}isEqual(t){return t.seconds===this.seconds&&t.nanoseconds===this.nanoseconds}toString(){return"Timestamp(seconds="+this.seconds+", nanoseconds="+this.nanoseconds+")"}toJSON(){return{seconds:this.seconds,nanoseconds:this.nanoseconds}}valueOf(){return String(this.seconds- -62135596800).padStart(12,"0")+"."+String(this.nanoseconds).padStart(9,"0")}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rk{constructor(t){this.timestamp=t}static fromTimestamp(t){return new rk(t)}static min(){return new rk(new rN(0,0))}static max(){return new rk(new rN(253402300799,999999999))}compareTo(t){return this.timestamp._compareTo(t.timestamp)}isEqual(t){return this.timestamp.isEqual(t.timestamp)}toMicroseconds(){return 1e6*this.timestamp.seconds+this.timestamp.nanoseconds/1e3}toString(){return"SnapshotVersion("+this.timestamp.toString()+")"}toTimestamp(){return this.timestamp}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rR{constructor(t,e,n){void 0===e?e=0:e>t.length&&rp(),void 0===n?n=t.length-e:n>t.length-e&&rp(),this.segments=t,this.offset=e,this.len=n}get length(){return this.len}isEqual(t){return 0===rR.comparator(this,t)}child(t){let e=this.segments.slice(this.offset,this.limit());return t instanceof rR?t.forEach(t=>{e.push(t)}):e.push(t),this.construct(e)}limit(){return this.offset+this.length}popFirst(t){return t=void 0===t?1:t,this.construct(this.segments,this.offset+t,this.length-t)}popLast(){return this.construct(this.segments,this.offset,this.length-1)}firstSegment(){return this.segments[this.offset]}lastSegment(){return this.get(this.length-1)}get(t){return this.segments[this.offset+t]}isEmpty(){return 0===this.length}isPrefixOf(t){if(t.length<this.length)return!1;for(let e=0;e<this.length;e++)if(this.get(e)!==t.get(e))return!1;return!0}isImmediateParentOf(t){if(this.length+1!==t.length)return!1;for(let e=0;e<this.length;e++)if(this.get(e)!==t.get(e))return!1;return!0}forEach(t){for(let e=this.offset,n=this.limit();e<n;e++)t(this.segments[e])}toArray(){return this.segments.slice(this.offset,this.limit())}static comparator(t,e){let n=Math.min(t.length,e.length);for(let i=0;i<n;i++){let n=t.get(i),r=e.get(i);if(n<r)return -1;if(n>r)return 1}return t.length<e.length?-1:t.length>e.length?1:0}}class rO extends rR{construct(t,e,n){return new rO(t,e,n)}canonicalString(){return this.toArray().join("/")}toString(){return this.canonicalString()}static fromString(...t){let e=[];for(let n of t){if(n.indexOf("//")>=0)throw new rm(rg.INVALID_ARGUMENT,`Invalid segment (${n}). Paths must not contain // in them.`);e.push(...n.split("/").filter(t=>t.length>0))}return new rO(e)}static emptyPath(){return new rO([])}}const rL=/^[_a-zA-Z][_a-zA-Z0-9]*$/;class rx extends rR{construct(t,e,n){return new rx(t,e,n)}static isValidIdentifier(t){return rL.test(t)}canonicalString(){return this.toArray().map(t=>(t=t.replace(/\\/g,"\\\\").replace(/`/g,"\\`"),rx.isValidIdentifier(t)||(t="`"+t+"`"),t)).join(".")}toString(){return this.canonicalString()}isKeyField(){return 1===this.length&&"__name__"===this.get(0)}static keyField(){return new rx(["__name__"])}static fromServerFormat(t){let e=[],n="",i=0,r=()=>{if(0===n.length)throw new rm(rg.INVALID_ARGUMENT,`Invalid field path (${t}). Paths must not be empty, begin with '.', end with '.', or contain '..'`);e.push(n),n=""},s=!1;for(;i<t.length;){let e=t[i];if("\\"===e){if(i+1===t.length)throw new rm(rg.INVALID_ARGUMENT,"Path has trailing escape character: "+t);let e=t[i+1];if("\\"!==e&&"."!==e&&"`"!==e)throw new rm(rg.INVALID_ARGUMENT,"Path has invalid escape sequence: "+t);n+=e,i+=2}else"`"===e?s=!s:"."!==e||s?n+=e:r(),i++}if(r(),s)throw new rm(rg.INVALID_ARGUMENT,"Unterminated ` in path: "+t);return new rx(e)}static emptyPath(){return new rx([])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rM{constructor(t){this.path=t}static fromPath(t){return new rM(rO.fromString(t))}static fromName(t){return new rM(rO.fromString(t).popFirst(5))}static empty(){return new rM(rO.emptyPath())}get collectionGroup(){return this.path.popLast().lastSegment()}hasCollectionId(t){return this.path.length>=2&&this.path.get(this.path.length-2)===t}getCollectionGroup(){return this.path.get(this.path.length-2)}getCollectionPath(){return this.path.popLast()}isEqual(t){return null!==t&&0===rO.comparator(this.path,t.path)}toString(){return this.path.toString()}static comparator(t,e){return rO.comparator(t.path,e.path)}static isDocumentKey(t){return t.length%2==0}static fromSegments(t){return new rM(new rO(t.slice()))}}class rP{constructor(t,e,n){this.readTime=t,this.documentKey=e,this.largestBatchId=n}static min(){return new rP(rk.min(),rM.empty(),-1)}static max(){return new rP(rk.max(),rM.empty(),-1)}}class rF{constructor(){this.onCommittedListeners=[]}addOnCommittedListener(t){this.onCommittedListeners.push(t)}raiseOnCommittedEvent(){this.onCommittedListeners.forEach(t=>t())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rY{constructor(t){this.fields=t,t.sort(rx.comparator)}static empty(){return new rY([])}unionWith(t){let e=new rW(rx.comparator);for(let t of this.fields)e=e.add(t);for(let n of t)e=e.add(n);return new rY(e.toArray())}covers(t){for(let e of this.fields)if(e.isPrefixOf(t))return!0;return!1}isEqual(t){return rD(this.fields,t.fields,(t,e)=>t.isEqual(e))}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rZ{constructor(t){this.binaryString=t}static fromBase64String(t){return new rZ(function(t){try{return atob(t)}catch(t){throw"undefined"!=typeof DOMException&&t instanceof DOMException?new rJ("Invalid base64 string: "+t):t}}(t))}static fromUint8Array(t){return new rZ(function(t){let e="";for(let n=0;n<t.length;++n)e+=String.fromCharCode(t[n]);return e}(t))}[Symbol.iterator](){let t=0;return{next:()=>t<this.binaryString.length?{value:this.binaryString.charCodeAt(t++),done:!1}:{value:void 0,done:!0}}}toBase64(){return btoa(this.binaryString)}toUint8Array(){return function(t){let e=new Uint8Array(t.length);for(let n=0;n<t.length;n++)e[n]=t.charCodeAt(n);return e}(this.binaryString)}approximateByteSize(){return 2*this.binaryString.length}compareTo(t){return r_(this.binaryString,t.binaryString)}isEqual(t){return this.binaryString===t.binaryString}}rZ.EMPTY_BYTE_STRING=new rZ("");const r0=new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);function r1(t){if(t||rp(),"string"==typeof t){let e=0,n=r0.exec(t);if(n||rp(),n[1]){let t=n[1];e=Number(t=(t+"000000000").substr(0,9))}return{seconds:Math.floor(new Date(t).getTime()/1e3),nanos:e}}return{seconds:r2(t.seconds),nanos:r2(t.nanos)}}function r2(t){return"number"==typeof t?t:"string"==typeof t?Number(t):0}function r9(t){return"string"==typeof t?rZ.fromBase64String(t):rZ.fromUint8Array(t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function r4(t){var e,n;return"server_timestamp"===(null===(n=((null===(e=null==t?void 0:t.mapValue)||void 0===e?void 0:e.fields)||{}).__type__)||void 0===n?void 0:n.stringValue)}function r6(t){let e=r1(t.mapValue.fields.__local_write_time__.timestampValue);return new rN(e.seconds,e.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class r5{constructor(t,e,n,i,r,s,a,o,l){this.databaseId=t,this.appId=e,this.persistenceKey=n,this.host=i,this.ssl=r,this.forceLongPolling=s,this.autoDetectLongPolling=a,this.longPollingOptions=o,this.useFetchStreams=l}}class r3{constructor(t,e){this.projectId=t,this.database=e||"(default)"}static empty(){return new r3("","")}get isDefaultDatabase(){return"(default)"===this.database}isEqual(t){return t instanceof r3&&t.projectId===this.projectId&&t.database===this.database}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const r7={mapValue:{fields:{__type__:{stringValue:"__max__"}}}};function r8(t){return"nullValue"in t?0:"booleanValue"in t?1:"integerValue"in t||"doubleValue"in t?2:"timestampValue"in t?3:"stringValue"in t?5:"bytesValue"in t?6:"referenceValue"in t?7:"geoPointValue"in t?8:"arrayValue"in t?9:"mapValue"in t?r4(t)?4:sh(t)?9007199254740991:10:rp()}function st(t,e){if(t===e)return!0;let n=r8(t);if(n!==r8(e))return!1;switch(n){case 0:case 9007199254740991:return!0;case 1:return t.booleanValue===e.booleanValue;case 4:return r6(t).isEqual(r6(e));case 3:return function(t,e){if("string"==typeof t.timestampValue&&"string"==typeof e.timestampValue&&t.timestampValue.length===e.timestampValue.length)return t.timestampValue===e.timestampValue;let n=r1(t.timestampValue),i=r1(e.timestampValue);return n.seconds===i.seconds&&n.nanos===i.nanos}(t,e);case 5:return t.stringValue===e.stringValue;case 6:return r9(t.bytesValue).isEqual(r9(e.bytesValue));case 7:return t.referenceValue===e.referenceValue;case 8:return r2(t.geoPointValue.latitude)===r2(e.geoPointValue.latitude)&&r2(t.geoPointValue.longitude)===r2(e.geoPointValue.longitude);case 2:return function(t,e){if("integerValue"in t&&"integerValue"in e)return r2(t.integerValue)===r2(e.integerValue);if("doubleValue"in t&&"doubleValue"in e){let n=r2(t.doubleValue),i=r2(e.doubleValue);return n===i?r$(n)===r$(i):isNaN(n)&&isNaN(i)}return!1}(t,e);case 9:return rD(t.arrayValue.values||[],e.arrayValue.values||[],st);case 10:return function(t,e){let n=t.mapValue.fields||{},i=e.mapValue.fields||{};if(rH(n)!==rH(i))return!1;for(let t in n)if(n.hasOwnProperty(t)&&(void 0===i[t]||!st(n[t],i[t])))return!1;return!0}(t,e);default:return rp()}}function se(t,e){return void 0!==(t.values||[]).find(t=>st(t,e))}function sn(t,e){if(t===e)return 0;let n=r8(t),i=r8(e);if(n!==i)return r_(n,i);switch(n){case 0:case 9007199254740991:return 0;case 1:return r_(t.booleanValue,e.booleanValue);case 2:return function(t,e){let n=r2(t.integerValue||t.doubleValue),i=r2(e.integerValue||e.doubleValue);return n<i?-1:n>i?1:n===i?0:isNaN(n)?isNaN(i)?0:-1:1}(t,e);case 3:return si(t.timestampValue,e.timestampValue);case 4:return si(r6(t),r6(e));case 5:return r_(t.stringValue,e.stringValue);case 6:return function(t,e){let n=r9(t),i=r9(e);return n.compareTo(i)}(t.bytesValue,e.bytesValue);case 7:return function(t,e){let n=t.split("/"),i=e.split("/");for(let t=0;t<n.length&&t<i.length;t++){let e=r_(n[t],i[t]);if(0!==e)return e}return r_(n.length,i.length)}(t.referenceValue,e.referenceValue);case 8:return function(t,e){let n=r_(r2(t.latitude),r2(e.latitude));return 0!==n?n:r_(r2(t.longitude),r2(e.longitude))}(t.geoPointValue,e.geoPointValue);case 9:return function(t,e){let n=t.values||[],i=e.values||[];for(let t=0;t<n.length&&t<i.length;++t){let e=sn(n[t],i[t]);if(e)return e}return r_(n.length,i.length)}(t.arrayValue,e.arrayValue);case 10:return function(t,e){if(t===r7.mapValue&&e===r7.mapValue)return 0;if(t===r7.mapValue)return 1;if(e===r7.mapValue)return -1;let n=t.fields||{},i=Object.keys(n),r=e.fields||{},s=Object.keys(r);i.sort(),s.sort();for(let t=0;t<i.length&&t<s.length;++t){let e=r_(i[t],s[t]);if(0!==e)return e;let a=sn(n[i[t]],r[s[t]]);if(0!==a)return a}return r_(i.length,s.length)}(t.mapValue,e.mapValue);default:throw rp()}}function si(t,e){if("string"==typeof t&&"string"==typeof e&&t.length===e.length)return r_(t,e);let n=r1(t),i=r1(e),r=r_(n.seconds,i.seconds);return 0!==r?r:r_(n.nanos,i.nanos)}function sr(t){var e,n;return"nullValue"in t?"null":"booleanValue"in t?""+t.booleanValue:"integerValue"in t?""+t.integerValue:"doubleValue"in t?""+t.doubleValue:"timestampValue"in t?function(t){let e=r1(t);return`time(${e.seconds},${e.nanos})`}(t.timestampValue):"stringValue"in t?t.stringValue:"bytesValue"in t?r9(t.bytesValue).toBase64():"referenceValue"in t?(n=t.referenceValue,rM.fromName(n).toString()):"geoPointValue"in t?`geo(${(e=t.geoPointValue).latitude},${e.longitude})`:"arrayValue"in t?function(t){let e="[",n=!0;for(let i of t.values||[])n?n=!1:e+=",",e+=sr(i);return e+"]"}(t.arrayValue):"mapValue"in t?function(t){let e=Object.keys(t.fields||{}).sort(),n="{",i=!0;for(let r of e)i?i=!1:n+=",",n+=`${r}:${sr(t.fields[r])}`;return n+"}"}(t.mapValue):rp()}function ss(t){return!!t&&"integerValue"in t}function sa(t){return!!t&&"arrayValue"in t}function so(t){return!!t&&"mapValue"in t}function sl(t){if(t.geoPointValue)return{geoPointValue:Object.assign({},t.geoPointValue)};if(t.timestampValue&&"object"==typeof t.timestampValue)return{timestampValue:Object.assign({},t.timestampValue)};if(t.mapValue){let e={mapValue:{fields:{}}};return rz(t.mapValue.fields,(t,n)=>e.mapValue.fields[t]=sl(n)),e}if(t.arrayValue){let e={arrayValue:{values:[]}};for(let n=0;n<(t.arrayValue.values||[]).length;++n)e.arrayValue.values[n]=sl(t.arrayValue.values[n]);return e}return Object.assign({},t)}function sh(t){return"__max__"===(((t.mapValue||{}).fields||{}).__type__||{}).stringValue}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sc{constructor(t,e,n,i,r,s,a){this.key=t,this.documentType=e,this.version=n,this.readTime=i,this.createTime=r,this.data=s,this.documentState=a}static newInvalidDocument(t){return new sc(t,0,rk.min(),rk.min(),rk.min(),su.empty(),0)}static newFoundDocument(t,e,n,i){return new sc(t,1,e,rk.min(),n,i,0)}static newNoDocument(t,e){return new sc(t,2,e,rk.min(),rk.min(),su.empty(),0)}static newUnknownDocument(t,e){return new sc(t,3,e,rk.min(),rk.min(),su.empty(),2)}convertToFoundDocument(t,e){return this.createTime.isEqual(rk.min())&&(2===this.documentType||0===this.documentType)&&(this.createTime=t),this.version=t,this.documentType=1,this.data=e,this.documentState=0,this}convertToNoDocument(t){return this.version=t,this.documentType=2,this.data=su.empty(),this.documentState=0,this}convertToUnknownDocument(t){return this.version=t,this.documentType=3,this.data=su.empty(),this.documentState=2,this}setHasCommittedMutations(){return this.documentState=2,this}setHasLocalMutations(){return this.documentState=1,this.version=rk.min(),this}setReadTime(t){return this.readTime=t,this}get hasLocalMutations(){return 1===this.documentState}get hasCommittedMutations(){return 2===this.documentState}get hasPendingWrites(){return this.hasLocalMutations||this.hasCommittedMutations}isValidDocument(){return 0!==this.documentType}isFoundDocument(){return 1===this.documentType}isNoDocument(){return 2===this.documentType}isUnknownDocument(){return 3===this.documentType}isEqual(t){return t instanceof sc&&this.key.isEqual(t.key)&&this.version.isEqual(t.version)&&this.documentType===t.documentType&&this.documentState===t.documentState&&this.data.isEqual(t.data)}mutableCopy(){return new sc(this.key,this.documentType,this.version,this.readTime,this.createTime,this.data.clone(),this.documentState)}toString(){return`Document(${this.key}, ${this.version}, ${JSON.stringify(this.data.value)}, {createTime: ${this.createTime}}), {documentType: ${this.documentType}}), {documentState: ${this.documentState}})`}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sN{constructor(t,e=null,n=[],i=[],r=null,s=null,a=null){this.path=t,this.collectionGroup=e,this.orderBy=n,this.filters=i,this.limit=r,this.startAt=s,this.endAt=a,this.dt=null}}function sk(t,e=null,n=[],i=[],r=null,s=null,a=null){return new sN(t,e,n,i,r,s,a)}function sR(t){if(null===t.dt){let e=t.path.canonicalString();null!==t.collectionGroup&&(e+="|cg:"+t.collectionGroup),e+="|f:"+t.filters.map(t=>(function t(e){if(e instanceof sy)return e.field.canonicalString()+e.op.toString()+sr(e.value);if(sE(e)&&sw(e))return e.filters.map(e=>t(e)).join(",");{let n=e.filters.map(e=>t(e)).join(",");return`${e.op}(${n})`}})(t)).join(",")+"|ob:"+t.orderBy.map(t=>t.field.canonicalString()+t.dir).join(","),null==t.limit||(e+="|l:"+t.limit),t.startAt&&(e+="|lb:"+(t.startAt.inclusive?"b:":"a:")+t.startAt.position.map(t=>sr(t)).join(",")),t.endAt&&(e+="|ub:"+(t.endAt.inclusive?"a:":"b:")+t.endAt.position.map(t=>sr(t)).join(",")),t.dt=e}return t.dt}function sO(t,e){if(t.limit!==e.limit||t.orderBy.length!==e.orderBy.length)return!1;for(let r=0;r<t.orderBy.length;r++){var n,i;if(n=t.orderBy[r],i=e.orderBy[r],!(n.dir===i.dir&&n.field.isEqual(i.field)))return!1}if(t.filters.length!==e.filters.length)return!1;for(let n=0;n<t.filters.length;n++)if(!function t(e,n){return e instanceof sy?n instanceof sy&&e.op===n.op&&e.field.isEqual(n.field)&&st(e.value,n.value):e instanceof sv?n instanceof sv&&e.op===n.op&&e.filters.length===n.filters.length&&e.filters.reduce((e,i,r)=>e&&t(i,n.filters[r]),!0):void rp()}(t.filters[n],e.filters[n]))return!1;return t.collectionGroup===e.collectionGroup&&!!t.path.isEqual(e.path)&&!!sp(t.startAt,e.startAt)&&sp(t.endAt,e.endAt)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class s1{constructor(){this._=void 0}}function s2(t,e){return t instanceof s7?ss(e)||e&&"doubleValue"in e?e:{integerValue:0}:null}class s9 extends s1{}class s4 extends s1{constructor(t){super(),this.elements=t}}function s6(t,e){let n=at(e);for(let e of t.elements)n.some(t=>st(t,e))||n.push(e);return{arrayValue:{values:n}}}class s5 extends s1{constructor(t){super(),this.elements=t}}function s3(t,e){let n=at(e);for(let e of t.elements)n=n.filter(t=>!st(t,e));return{arrayValue:{values:n}}}class s7 extends s1{constructor(t,e){super(),this.serializer=t,this.gt=e}}function s8(t){return r2(t.integerValue||t.doubleValue)}function at(t){return sa(t)&&t.arrayValue.values?t.arrayValue.values.slice():[]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */class av{constructor(t,e){this.largestBatchId=t,this.mutation=e}getKey(){return this.mutation.key}isEqual(t){return null!==t&&this.mutation===t.mutation}toString(){return`Overlay{
    ...
    }`}}(l=o||(o={}))[l.OK=0]="OK",l[l.CANCELLED=1]="CANCELLED",l[l.UNKNOWN=2]="UNKNOWN",l[l.INVALID_ARGUMENT=3]="INVALID_ARGUMENT",l[l.DEADLINE_EXCEEDED=4]="DEADLINE_EXCEEDED",l[l.NOT_FOUND=5]="NOT_FOUND",l[l.ALREADY_EXISTS=6]="ALREADY_EXISTS",l[l.PERMISSION_DENIED=7]="PERMISSION_DENIED",l[l.UNAUTHENTICATED=16]="UNAUTHENTICATED",l[l.RESOURCE_EXHAUSTED=8]="RESOURCE_EXHAUSTED",l[l.FAILED_PRECONDITION=9]="FAILED_PRECONDITION",l[l.ABORTED=10]="ABORTED",l[l.OUT_OF_RANGE=11]="OUT_OF_RANGE",l[l.UNIMPLEMENTED=12]="UNIMPLEMENTED",l[l.INTERNAL=13]="INTERNAL",l[l.UNAVAILABLE=14]="UNAVAILABLE",l[l.DATA_LOSS=15]="DATA_LOSS",new rr([4294967295,4294967295],0);class aw{constructor(t,e){this.databaseId=t,this.useProto3Json=e}}function aE(t,e){return t.useProto3Json?`${new Date(1e3*e.seconds).toISOString().replace(/\.\d*/,"").replace("Z","")}.${("000000000"+e.nanoseconds).slice(-9)}Z`:{seconds:""+e.seconds,nanos:e.nanoseconds}}function ab(t){return t||rp(),rk.fromTimestamp(function(t){let e=r1(t);return new rN(e.seconds,e.nanos)}(t))}function aT(t,e){return new rO(["projects",t.projectId,"databases",t.database]).child("documents").child(e).canonicalString()}function aI(t,e){return aT(t.databaseId,e.path)}function aS(t,e,n){return{name:aI(t,e),fields:n.value.mapValue.fields}}function aA(t){return rx.fromServerFormat(t.fieldPath)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class aC{constructor(t){this.fe=t}}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class a_{constructor(){}_e(t,e){this.me(t,e),e.ge()}me(t,e){if("nullValue"in t)this.ye(e,5);else if("booleanValue"in t)this.ye(e,10),e.pe(t.booleanValue?1:0);else if("integerValue"in t)this.ye(e,15),e.pe(r2(t.integerValue));else if("doubleValue"in t){let n=r2(t.doubleValue);isNaN(n)?this.ye(e,13):(this.ye(e,15),r$(n)?e.pe(0):e.pe(n))}else if("timestampValue"in t){let n=t.timestampValue;this.ye(e,20),"string"==typeof n?e.Ie(n):(e.Ie(`${n.seconds||""}`),e.pe(n.nanos||0))}else if("stringValue"in t)this.Te(t.stringValue,e),this.Ee(e);else if("bytesValue"in t)this.ye(e,30),e.Ae(r9(t.bytesValue)),this.Ee(e);else if("referenceValue"in t)this.ve(t.referenceValue,e);else if("geoPointValue"in t){let n=t.geoPointValue;this.ye(e,45),e.pe(n.latitude||0),e.pe(n.longitude||0)}else"mapValue"in t?sh(t)?this.ye(e,Number.MAX_SAFE_INTEGER):(this.Re(t.mapValue,e),this.Ee(e)):"arrayValue"in t?(this.Pe(t.arrayValue,e),this.Ee(e)):rp()}Te(t,e){this.ye(e,25),this.be(t,e)}be(t,e){e.Ie(t)}Re(t,e){let n=t.fields||{};for(let t of(this.ye(e,55),Object.keys(n)))this.Te(t,e),this.me(n[t],e)}Pe(t,e){let n=t.values||[];for(let t of(this.ye(e,50),n))this.me(t,e)}ve(t,e){this.ye(e,37),rM.fromName(t).path.forEach(t=>{this.ye(e,60),this.be(t,e)})}ye(t,e){t.pe(e)}Ee(t){t.pe(2)}}a_.Ve=new a_;/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class aR{constructor(t){this.Nn=t}next(){return this.Nn+=2,this.Nn}static kn(){return new aR(0)}static Mn(){return new aR(-1)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class aO{constructor(){this.changes=new s$(t=>t.toString(),(t,e)=>t.isEqual(e)),this.changesApplied=!1}addEntry(t){this.assertNotApplied(),this.changes.set(t.key,t)}removeEntry(t,e){this.assertNotApplied(),this.changes.set(t,sc.newInvalidDocument(t).setReadTime(e))}getEntry(t,e){this.assertNotApplied();let n=this.changes.get(e);return void 0!==n?rU.resolve(n):this.getFromCache(t,e)}getEntries(t,e){return this.getAllFromCache(t,e)}apply(t){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(t)}assertNotApplied(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ax{constructor(t,e,n,i){this.remoteDocumentCache=t,this.mutationQueue=e,this.documentOverlayCache=n,this.indexManager=i}getDocument(t,e){let n=null;return this.documentOverlayCache.getOverlay(t,e).next(i=>(n=i,this.remoteDocumentCache.getEntry(t,e))).next(t=>(null!==n&&ao(n.mutation,t,rY.empty(),rN.now()),t))}getDocuments(t,e){return this.remoteDocumentCache.getEntries(t,e).next(e=>this.getLocalViewOfDocuments(t,e,sX()).next(()=>e))}getLocalViewOfDocuments(t,e,n=sX()){let i=sK();return this.populateOverlays(t,i,e).next(()=>this.computeViews(t,e,i,n).next(t=>{let e=sq();return t.forEach((t,n)=>{e=e.insert(t,n.overlayedDocument)}),e}))}getOverlayedDocuments(t,e){let n=sK();return this.populateOverlays(t,n,e).next(()=>this.computeViews(t,e,n,sX()))}populateOverlays(t,e,n){let i=[];return n.forEach(t=>{e.has(t)||i.push(t)}),this.documentOverlayCache.getOverlays(t,i).next(t=>{t.forEach((t,n)=>{e.set(t,n)})})}computeViews(t,e,n,i){let r=sH,s=sK(),a=sK();return e.forEach((t,e)=>{let a=n.get(e.key);i.has(e.key)&&(void 0===a||a.mutation instanceof au)?r=r.insert(e.key,e):void 0!==a?(s.set(e.key,a.mutation.getFieldMask()),ao(a.mutation,e,a.mutation.getFieldMask(),rN.now())):s.set(e.key,rY.empty())}),this.recalculateAndSaveOverlays(t,r).next(t=>(t.forEach((t,e)=>s.set(t,e)),e.forEach((t,e)=>{var n;return a.set(t,new aL(e,null!==(n=s.get(t))&&void 0!==n?n:null))}),a))}recalculateAndSaveOverlays(t,e){let n=sK(),i=new rG((t,e)=>t-e),r=sX();return this.mutationQueue.getAllMutationBatchesAffectingDocumentKeys(t,e).next(t=>{for(let r of t)r.keys().forEach(t=>{let s=e.get(t);if(null===s)return;let a=n.get(t)||rY.empty();a=r.applyToLocalView(s,a),n.set(t,a);let o=(i.get(r.batchId)||sX()).add(t);i=i.insert(r.batchId,o)})}).next(()=>{let s=[],a=i.getReverseIterator();for(;a.hasNext();){let i=a.getNext(),o=i.key,l=i.value,h=sK();l.forEach(t=>{if(!r.has(t)){let i=aa(e.get(t),n.get(t));null!==i&&h.set(t,i),r=r.add(t)}}),s.push(this.documentOverlayCache.saveOverlays(t,o,h))}return rU.waitFor(s)}).next(()=>n)}recalculateAndSaveOverlaysForDocumentKeys(t,e){return this.remoteDocumentCache.getEntries(t,e).next(e=>this.recalculateAndSaveOverlays(t,e))}getDocumentsMatchingQuery(t,e,n){return rM.isDocumentKey(e.path)&&null===e.collectionGroup&&0===e.filters.length?this.getDocumentsMatchingDocumentQuery(t,e.path):null!==e.collectionGroup?this.getDocumentsMatchingCollectionGroupQuery(t,e,n):this.getDocumentsMatchingCollectionQuery(t,e,n)}getNextDocuments(t,e,n,i){return this.remoteDocumentCache.getAllFromCollectionGroup(t,e,n,i).next(r=>{let s=i-r.size>0?this.documentOverlayCache.getOverlaysForCollectionGroup(t,e,n.largestBatchId,i-r.size):rU.resolve(sK()),a=-1,o=r;return s.next(e=>rU.forEach(e,(e,n)=>(a<n.largestBatchId&&(a=n.largestBatchId),r.get(e)?rU.resolve():this.remoteDocumentCache.getEntry(t,e).next(t=>{o=o.insert(e,t)}))).next(()=>this.populateOverlays(t,e,r)).next(()=>this.computeViews(t,o,e,sX())).next(t=>({batchId:a,changes:sG(t)})))})}getDocumentsMatchingDocumentQuery(t,e){return this.getDocument(t,new rM(e)).next(t=>{let e=sq();return t.isFoundDocument()&&(e=e.insert(t.key,t)),e})}getDocumentsMatchingCollectionGroupQuery(t,e,n){let i=e.collectionGroup,r=sq();return this.indexManager.getCollectionParents(t,i).next(s=>rU.forEach(s,s=>{let a=new sL(s.child(i),null,e.explicitOrderBy.slice(),e.filters.slice(),e.limit,e.limitType,e.startAt,e.endAt);return this.getDocumentsMatchingCollectionQuery(t,a,n).next(t=>{t.forEach((t,e)=>{r=r.insert(t,e)})})}).next(()=>r))}getDocumentsMatchingCollectionQuery(t,e,n){let i;return this.documentOverlayCache.getOverlaysForCollection(t,e.path,n.largestBatchId).next(r=>(i=r,this.remoteDocumentCache.getDocumentsMatchingQuery(t,e,n,i))).next(t=>{i.forEach((e,n)=>{let i=n.getKey();null===t.get(i)&&(t=t.insert(i,sc.newInvalidDocument(i)))});let n=sq();return t.forEach((t,r)=>{let s=i.get(t);void 0!==s&&ao(s.mutation,r,rY.empty(),rN.now()),sj(e,r)&&(n=n.insert(t,r))}),n})}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class aF{constructor(){this.fs=new rW(aV.ds),this.ws=new rW(aV._s)}isEmpty(){return this.fs.isEmpty()}addReference(t,e){let n=new aV(t,e);this.fs=this.fs.add(n),this.ws=this.ws.add(n)}gs(t,e){t.forEach(t=>this.addReference(t,e))}removeReference(t,e){this.ys(new aV(t,e))}ps(t,e){t.forEach(t=>this.removeReference(t,e))}Is(t){let e=new rM(new rO([])),n=new aV(e,t),i=new aV(e,t+1),r=[];return this.ws.forEachInRange([n,i],t=>{this.ys(t),r.push(t.key)}),r}Ts(){this.fs.forEach(t=>this.ys(t))}ys(t){this.fs=this.fs.delete(t),this.ws=this.ws.delete(t)}Es(t){let e=new rM(new rO([])),n=new aV(e,t),i=new aV(e,t+1),r=sX();return this.ws.forEachInRange([n,i],t=>{r=r.add(t.key)}),r}containsKey(t){let e=new aV(t,0),n=this.fs.firstAfterOrEqual(e);return null!==n&&t.isEqual(n.key)}}class aV{constructor(t,e){this.key=t,this.As=e}static ds(t,e){return rM.comparator(t.key,e.key)||r_(t.As,e.As)}static _s(t,e){return r_(t.As,e.As)||rM.comparator(t.key,e.key)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class aK{constructor(){this.qi=!1}initialize(t,e){this.Ui=t,this.indexManager=e,this.qi=!0}getDocumentsMatchingQuery(t,e,n,i){return this.Ki(t,e).next(r=>r||this.Gi(t,e,i,n)).next(n=>n||this.Qi(t,e))}Ki(t,e){if(sx(e))return rU.resolve(null);let n=sP(e);return this.indexManager.getIndexType(t,n).next(i=>0===i?null:(null!==e.limit&&1===i&&(n=sP(e=sF(e,null,"F"))),this.indexManager.getDocumentsMatchingTarget(t,n).next(i=>{let r=sX(...i);return this.Ui.getDocuments(t,r).next(i=>this.indexManager.getMinOffset(t,n).next(n=>{let s=this.ji(e,i);return this.zi(e,s,r,n.readTime)?this.Ki(t,sF(e,null,"F")):this.Wi(t,s,e,n)}))})))}Gi(t,e,n,i){return sx(e)||i.isEqual(rk.min())?this.Qi(t,e):this.Ui.getDocuments(t,n).next(r=>{let s=this.ji(e,r);return this.zi(e,s,n,i)?this.Qi(t,e):(rh()<=tU.DEBUG&&ru("QueryEngine","Re-using previous result from %s to execute query: %s",i.toString(),sB(e)),this.Wi(t,s,e,function(t,e){let n=t.toTimestamp().seconds,i=t.toTimestamp().nanoseconds+1;return new rP(rk.fromTimestamp(1e9===i?new rN(n+1,0):new rN(n,i)),rM.empty(),-1)}(i,0)))})}ji(t,e){let n=new rW((e,n)=>{let i=!1;for(let r of sM(t)){let t=function(t,e,n){let i=t.field.isKeyField()?rM.comparator(e.key,n.key):function(t,e,n){let i=e.data.field(t),r=n.data.field(t);return null!==i&&null!==r?sn(i,r):rp()}(t.field,e,n);switch(t.dir){case"asc":return i;case"desc":return -1*i;default:return rp()}}(r,e,n);if(0!==t)return t;i=i||r.field.isKeyField()}return 0});return e.forEach((e,i)=>{sj(t,i)&&(n=n.add(i))}),n}zi(t,e,n,i){if(null===t.limit)return!1;if(n.size!==e.size)return!0;let r="F"===t.limitType?e.last():e.first();return!!r&&(r.hasPendingWrites||r.version.compareTo(i)>0)}Qi(t,e){return rh()<=tU.DEBUG&&ru("QueryEngine","Using full collection scan to execute query:",sB(e)),this.Ui.getDocumentsMatchingQuery(t,e,rP.min())}Wi(t,e,n,i){return this.Ui.getDocumentsMatchingQuery(t,n,i).next(t=>(e.forEach(e=>{t=t.insert(e.key,e)}),t))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let a0=null;function a1(){return null===a0?a0=268435456+Math.round(2147483648*Math.random()):a0++,"0x"+a0.toString(16)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class a9{constructor(t){this.ro=t.ro,this.oo=t.oo}uo(t){this.co=t}ao(t){this.ho=t}onMessage(t){this.lo=t}close(){this.oo()}send(t){this.ro(t)}fo(){this.co()}wo(t){this.ho(t)}_o(t){this.lo(t)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const a4="WebChannelConnection";class a6 extends class{constructor(t){this.databaseInfo=t,this.databaseId=t.databaseId;let e=t.ssl?"https":"http";this.mo=e+"://"+t.host,this.yo="projects/"+this.databaseId.projectId+"/databases/"+this.databaseId.database+"/documents"}get po(){return!1}Io(t,e,n,i,r){let s=a1(),a=this.To(t,e);ru("RestConnection",`Sending RPC '${t}' ${s}:`,a,n);let o={};return this.Eo(o,i,r),this.Ao(t,a,o,n).then(e=>(ru("RestConnection",`Received RPC '${t}' ${s}: `,e),e),e=>{throw rf("RestConnection",`RPC '${t}' ${s} failed with error: `,e,"url: ",a,"request:",n),e})}vo(t,e,n,i,r,s){return this.Io(t,e,n,i,r)}Eo(t,e,n){t["X-Goog-Api-Client"]="gl-js/ fire/"+ro,t["Content-Type"]="text/plain",this.databaseInfo.appId&&(t["X-Firebase-GMPID"]=this.databaseInfo.appId),e&&e.headers.forEach((e,n)=>t[n]=e),n&&n.headers.forEach((e,n)=>t[n]=e)}To(t,e){let n=a2[t];return`${this.mo}/v1/${e}:${n}`}}{constructor(t){super(t),this.forceLongPolling=t.forceLongPolling,this.autoDetectLongPolling=t.autoDetectLongPolling,this.useFetchStreams=t.useFetchStreams,this.longPollingOptions=t.longPollingOptions}Ao(t,e,n,i){let r=a1();return new Promise((s,a)=>{let o=new ri;o.setWithCredentials(!0),o.listenOnce(i7.COMPLETE,()=>{try{switch(o.getLastErrorCode()){case i3.NO_ERROR:let e=o.getResponseJson();ru(a4,`XHR for RPC '${t}' ${r} received:`,JSON.stringify(e)),s(e);break;case i3.TIMEOUT:ru(a4,`RPC '${t}' ${r} timed out`),a(new rm(rg.DEADLINE_EXCEEDED,"Request time out"));break;case i3.HTTP_ERROR:let n=o.getStatus();if(ru(a4,`RPC '${t}' ${r} failed with status:`,n,"response text:",o.getResponseText()),n>0){let t=o.getResponseJson();Array.isArray(t)&&(t=t[0]);let e=null==t?void 0:t.error;if(e&&e.status&&e.message){let t=function(t){let e=t.toLowerCase().replace(/_/g,"-");return Object.values(rg).indexOf(e)>=0?e:rg.UNKNOWN}(e.status);a(new rm(t,e.message))}else a(new rm(rg.UNKNOWN,"Server responded with status "+o.getStatus()))}else a(new rm(rg.UNAVAILABLE,"Connection failed."));break;default:rp()}}finally{ru(a4,`RPC '${t}' ${r} completed.`)}});let l=JSON.stringify(i);ru(a4,`RPC '${t}' ${r} sending request:`,i),o.send(e,"POST",l,n,15)})}Ro(t,e,n){let i=a1(),r=[this.mo,"/","google.firestore.v1.Firestore","/",t,"/channel"],s=i6(),a=i5(),l={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},h=this.longPollingOptions.timeoutSeconds;void 0!==h&&(l.longPollingTimeout=Math.round(1e3*h)),this.useFetchStreams&&(l.xmlHttpFactory=new re({})),this.Eo(l.initMessageHeaders,e,n),l.encodeInitMessageHeaders=!0;let u=r.join("");ru(a4,`Creating RPC '${t}' stream ${i}: ${u}`,l);let c=s.createWebChannel(u,l),f=!1,d=!1,p=new a9({ro:e=>{d?ru(a4,`Not sending because RPC '${t}' stream ${i} is closed:`,e):(f||(ru(a4,`Opening RPC '${t}' stream ${i} transport.`),c.open(),f=!0),ru(a4,`RPC '${t}' stream ${i} sending:`,e),c.send(e))},oo:()=>c.close()}),g=(t,e,n)=>{t.listen(e,t=>{try{n(t)}catch(t){setTimeout(()=>{throw t},0)}})};return g(c,rn.EventType.OPEN,()=>{d||ru(a4,`RPC '${t}' stream ${i} transport opened.`)}),g(c,rn.EventType.CLOSE,()=>{d||(d=!0,ru(a4,`RPC '${t}' stream ${i} transport closed`),p.wo())}),g(c,rn.EventType.ERROR,e=>{d||(d=!0,rf(a4,`RPC '${t}' stream ${i} transport errored:`,e),p.wo(new rm(rg.UNAVAILABLE,"The operation could not be completed")))}),g(c,rn.EventType.MESSAGE,e=>{var n;if(!d){let r=e.data[0];r||rp();let s=r.error||(null===(n=r[0])||void 0===n?void 0:n.error);if(s){ru(a4,`RPC '${t}' stream ${i} received error:`,s);let e=s.status,n=function(t){let e=o[t];if(void 0!==e)return function(t){if(void 0===t)return rc("GRPC error has no .code"),rg.UNKNOWN;switch(t){case o.OK:return rg.OK;case o.CANCELLED:return rg.CANCELLED;case o.UNKNOWN:return rg.UNKNOWN;case o.DEADLINE_EXCEEDED:return rg.DEADLINE_EXCEEDED;case o.RESOURCE_EXHAUSTED:return rg.RESOURCE_EXHAUSTED;case o.INTERNAL:return rg.INTERNAL;case o.UNAVAILABLE:return rg.UNAVAILABLE;case o.UNAUTHENTICATED:return rg.UNAUTHENTICATED;case o.INVALID_ARGUMENT:return rg.INVALID_ARGUMENT;case o.NOT_FOUND:return rg.NOT_FOUND;case o.ALREADY_EXISTS:return rg.ALREADY_EXISTS;case o.PERMISSION_DENIED:return rg.PERMISSION_DENIED;case o.FAILED_PRECONDITION:return rg.FAILED_PRECONDITION;case o.ABORTED:return rg.ABORTED;case o.OUT_OF_RANGE:return rg.OUT_OF_RANGE;case o.UNIMPLEMENTED:return rg.UNIMPLEMENTED;case o.DATA_LOSS:return rg.DATA_LOSS;default:return rp()}}(e)}(e),r=s.message;void 0===n&&(n=rg.INTERNAL,r="Unknown error status: "+e+" with message "+s.message),d=!0,p.wo(new rm(n,r)),c.close()}else ru(a4,`RPC '${t}' stream ${i} received:`,r),p._o(r)}}),g(a,i8.STAT_EVENT,e=>{e.stat===rt.PROXY?ru(a4,`RPC '${t}' stream ${i} detected buffering proxy`):e.stat===rt.NOPROXY&&ru(a4,`RPC '${t}' stream ${i} detected no buffering proxy`)}),setTimeout(()=>{p.fo()},0),p}}function a5(){return"undefined"!=typeof document?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function a3(t){return new aw(t,!0)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class oK{constructor(t,e,n){this.converter=e,this._key=n,this.type="document",this.firestore=t}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new oW(this.firestore,this.converter,this._key.path.popLast())}withConverter(t){return new oK(this.firestore,t,this._key)}}class oQ{constructor(t,e,n){this.converter=e,this._query=n,this.type="query",this.firestore=t}withConverter(t){return new oQ(this.firestore,t,this._query)}}class oW extends oQ{constructor(t,e,n){super(t,e,new sL(n)),this._path=n,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){let t=this._path.popLast();return t.isEmpty()?null:new oK(this.firestore,null,new rM(t))}withConverter(t){return new oW(this.firestore,t,this._path)}}function oX(t,e,...n){if(t=$(t),1==arguments.length&&(e=rC.A()),oB("doc","path",e),t instanceof oG){let i=rO.fromString(e,...n);return oj(i),new oK(t,null,new rM(i))}{if(!(t instanceof oK||t instanceof oW))throw new rm(rg.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");let i=t._path.child(rO.fromString(e,...n));return oj(i),new oK(t.firestore,t instanceof oW?t.converter:null,new rM(i))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class o1{constructor(...t){for(let e=0;e<t.length;++e)if(0===t[e].length)throw new rm(rg.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new rx(t)}isEqual(t){return this._internalPath.isEqual(t._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class o9{constructor(t,e){if(!isFinite(t)||t<-90||t>90)throw new rm(rg.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+t);if(!isFinite(e)||e<-180||e>180)throw new rm(rg.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+e);this._lat=t,this._long=e}get latitude(){return this._lat}get longitude(){return this._long}isEqual(t){return this._lat===t._lat&&this._long===t._long}toJSON(){return{latitude:this._lat,longitude:this._long}}_compareTo(t){return r_(this._lat,t._lat)||r_(this._long,t._long)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
