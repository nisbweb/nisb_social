 ...
 * limitations under the License.
 */
class L{constructor(t){this.container=t}getPlatformInfoString(){return this.container.getProviders().map((t=>{if(function(t){const e=t.getComponent();return"VERSION"===(null==e?void 0:e.type)}(t)){const e=t.getImmediate();return`${e.library}/${e.version}`}return null})).filter((t=>t)).join(" ")}}const O=new R("@firebase/app"),k={"@firebase/app":"fire-core","@firebase/app-compat":"fire-core-compat","@firebase/analytics":"fire-analytics","@firebase/analytics-compat":"fire-analytics-compat","@firebase/app-check":"fire-app-check","@firebase/app-check-compat":"fire-app-check-compat","@firebase/auth":"fire-auth","@firebase/auth-compat":"fire-auth-compat","@firebase/database":"fire-rtdb","@firebase/database-compat":"fire-rtdb-compat","@firebase/functions":"fire-fn","@firebase/functions-compat":"fire-fn-compat","@firebase/installations":"fire-iid","@firebase/installations-compat":"fire-iid-compat","@firebase/messaging":"fire-fcm","@firebase/messaging-compat":"fire-fcm-compat","@firebase/performance":"fire-perf","@firebase/performance-compat":"fire-perf-compat","@firebase/remote-config":"fire-rc","@firebase/remote-config-compat":"fire-rc-compat","@firebase/storage":"fire-gcs","@firebase/storage-compat":"fire-gcs-compat","@firebase/firestore":"fire-fst","@firebase/firestore-compat":"fire-fst-compat","fire-js":"fire-js",firebase:"fire-js-all"},x=new Map,P=new Map;function F(t,e){try{t.container.addComponent(e)}catch(n){O.debug(`Component ${e.name} failed to register with FirebaseApp ${t.name}`,n)}}function M(t){const e=t.name;if(P.has(e))return O.debug(`There were multiple attempts to register component ${e}.`),!1;P.set(e,t);for(const e of x.values())F(e,t);return!0}function U(t,e){return t.container.getProvider(e)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
var H;M(new v("platform-logger",(t=>new L(t)),"PRIVATE")),B("@firebase/app","0.7.0",H),B("fire-js","");
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Lr{constructor(){this.promise=new Promise(((t,e)=>{this.resolve=t,this.reject=e}))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Or{constructor(t,e){this.user=e,this.type="OAuth",this.authHeaders={},this.authHeaders.Authorization=`Bearer ${t}`}}class kr{getToken(){return Promise.resolve(null)}invalidateToken(){}start(t,e){t.enqueueRetryable((()=>e(vr.UNAUTHENTICATED)))}shutdown(){}}class xr{constructor(t){this.t=t,this.currentUser=vr.UNAUTHENTICATED,this.i=0,this.forceRefresh=!1,this.auth=null}start(t,e){let n=this.i;const i=t=>this.i!==n?(n=this.i,e(t)):Promise.resolve();let r=new Lr;this.o=()=>{this.i++,this.currentUser=this.u(),r.resolve(),r=new Lr,t.enqueueRetryable((()=>i(this.currentUser)))};const s=e=>{t.enqueueRetryable((async()=>{Tr("FirebaseCredentialsProvider","Auth detected"),this.auth=e,this.auth.addAuthTokenListener(this.o),await r.promise,await i(this.currentUser)}))};this.t.onInit((t=>s(t))),setTimeout((()=>{if(!this.auth){const t=this.t.getImmediate({optional:!0});t?s(t):(Tr("FirebaseCredentialsProvider","Auth not yet detected"),r.resolve(),r=new Lr)}}),0),t.enqueueRetryable((async()=>{0===this.i&&(await r.promise,await i(this.currentUser))}))}getToken(){const t=this.i,e=this.forceRefresh;return this.forceRefresh=!1,this.auth?this.auth.getToken(e).then((e=>this.i!==t?(Tr("FirebaseCredentialsProvider","getToken aborted due to token change."),this.getToken()):e?(_r("string"==typeof e.accessToken),new Or(e.accessToken,this.currentUser)):null)):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.auth&&this.auth.removeAuthTokenListener(this.o)}u(){const t=this.auth&&this.auth.getUid();return _r(null===t||"string"==typeof t),new vr(t)}}class Pr{constructor(t,e,n){this.h=t,this.l=e,this.m=n,this.type="FirstParty",this.user=vr.FIRST_PARTY}get authHeaders(){const t={"X-Goog-AuthUser":this.l},e=this.h.auth.getAuthHeaderValueForFirstParty([]);return e&&(t.Authorization=e),this.m&&(t["X-Goog-Iam-Authorization-Token"]=this.m),t}}class Fr{constructor(t,e,n){this.h=t,this.l=e,this.m=n}getToken(){return Promise.resolve(new Pr(this.h,this.l,this.m))}start(t,e){t.enqueueRetryable((()=>e(vr.FIRST_PARTY)))}shutdown(){}invalidateToken(){}}
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vo{constructor(t,e){this.field=t,this.transform=e}}class wo{constructor(t,e){this.version=t,this.transformResults=e}}class bo{constructor(t,e){this.updateTime=t,this.exists=e}static none(){return new bo}static exists(t){return new bo(void 0,t)}static updateTime(t){return new bo(t)}get isNone(){return void 0===this.updateTime&&void 0===this.exists}isEqual(t){return this.exists===t.exists&&(this.updateTime?!!t.updateTime&&this.updateTime.isEqual(t.updateTime):!t.updateTime)}}function Eo(t,e){return void 0!==t.updateTime?e.isFoundDocument()&&e.version.isEqual(t.updateTime):void 0===t.exists||t.exists===e.isFoundDocument()}class To{}function Io(t,e,n){var i;t instanceof _o?function(t,e,n){if(!Eo(t.precondition,e))return;const i=t.value.clone(),r=Lo(t.fieldTransforms,n,e);i.setAll(r),e.convertToFoundDocument(No(e),i).setHasLocalMutations()}(t,e,n):t instanceof Do?function(t,e,n){if(!Eo(t.precondition,e))return;const i=Lo(t.fieldTransforms,n,e),r=e.data;r.setAll(Co(t)),r.setAll(i),e.convertToFoundDocument(No(e),r).setHasLocalMutations()}(t,e,n):(i=e,Eo(t.precondition,i)&&i.convertToNoDocument(qr.min()))}function Ao(t,e){let n=null;for(const i of t.fieldTransforms){const t=e.data.field(i.field),r=ho(i.transform,t||null);null!=r&&(null==n&&(n=bs.empty()),n.set(i.field,r))}return n||null}function So(t,e){return t.type===e.type&&!!t.key.isEqual(e.key)&&!!t.precondition.isEqual(e.precondition)&&(n=t.fieldTransforms,i=e.fieldTransforms,!!(void 0===n&&void 0===i||n&&i&&Br(n,i,((t,e)=>{return i=e,(n=t).field.isEqual(i.field)&&(r=n.transform,s=i.transform,r instanceof lo&&s instanceof lo||r instanceof fo&&s instanceof fo?Br(r.elements,s.elements,ls):r instanceof go&&s instanceof go?ls(r.C,s.C):r instanceof co&&s instanceof co);var n,i,r,s}))))&&(0===t.type?t.value.isEqual(e.value):1!==t.type||t.data.isEqual(e.data)&&t.fieldMask.isEqual(e.fieldMask));var n,i}function No(t){return t.isFoundDocument()?t.version:qr.min()}class _o extends To{constructor(t,e,n,i=[]){super(),this.key=t,this.value=e,this.precondition=n,this.fieldTransforms=i,this.type=0}}class Do extends To{constructor(t,e,n,i,r=[]){super(),this.key=t,this.data=e,this.fieldMask=n,this.precondition=i,this.fieldTransforms=r,this.type=1}}function Co(t){const e=new Map;return t.fieldMask.fields.forEach((n=>{if(!n.isEmpty()){const i=t.data.field(n);e.set(n,i)}})),e}function Ro(t,e,n){const i=new Map;_r(t.length===n.length);for(let a=0;a<n.length;a++){const h=t[a],c=h.transform,l=e.data.field(h.field);i.set(h.field,(r=c,s=l,o=n[a],r instanceof lo?uo(r,s):r instanceof fo?po(r,s):o))}var r,s,o;return i}function Lo(t,e,n){const i=new Map;for(const a of t){const t=a.transform,h=n.data.field(a.field);i.set(a.field,(s=h,o=e,(r=t)instanceof co?function(t,e){const n={fields:{__type__:{stringValue:"server_timestamp"},__local_write_time__:{timestampValue:{seconds:t.seconds,nanos:t.nanoseconds}}}};return e&&(n.fields.__previous_value__=e),{mapValue:n}}(o,s):r instanceof lo?uo(r,s):r instanceof fo?po(r,s):function(t,e){const n=ho(t,e),i=mo(n)+mo(t.C);return ms(n)&&ms(t.C)?so(i):ro(t.N,i)}(r,s)))}var r,s,o;return i}class Oo extends To{constructor(t,e){super(),this.key=t,this.precondition=e,this.type=2,this.fieldTransforms=[]}}class ko extends To{constructor(t,e){super(),this.key=t,this.precondition=e,this.type=3,this.fieldTransforms=[]}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
var xo,Po;function Fo(t){switch(t){case Cr.OK:return Nr();case Cr.CANCELLED:case Cr.UNKNOWN:case Cr.DEADLINE_EXCEEDED:case Cr.RESOURCE_EXHAUSTED:case Cr.INTERNAL:case Cr.UNAVAILABLE:case Cr.UNAUTHENTICATED:return!1;case Cr.INVALID_ARGUMENT:case Cr.NOT_FOUND:case Cr.ALREADY_EXISTS:case Cr.PERMISSION_DENIED:case Cr.FAILED_PRECONDITION:case Cr.ABORTED:case Cr.OUT_OF_RANGE:case Cr.UNIMPLEMENTED:case Cr.DATA_LOSS:return!0;default:return Nr()}}function Mo(t){if(void 0===t)return Ir("GRPC error has no .code"),Cr.UNKNOWN;switch(t){case xo.OK:return Cr.OK;case xo.CANCELLED:return Cr.CANCELLED;case xo.UNKNOWN:return Cr.UNKNOWN;case xo.DEADLINE_EXCEEDED:return Cr.DEADLINE_EXCEEDED;case xo.RESOURCE_EXHAUSTED:return Cr.RESOURCE_EXHAUSTED;case xo.INTERNAL:return Cr.INTERNAL;case xo.UNAVAILABLE:return Cr.UNAVAILABLE;case xo.UNAUTHENTICATED:return Cr.UNAUTHENTICATED;case xo.INVALID_ARGUMENT:return Cr.INVALID_ARGUMENT;case xo.NOT_FOUND:return Cr.NOT_FOUND;case xo.ALREADY_EXISTS:return Cr.ALREADY_EXISTS;case xo.PERMISSION_DENIED:return Cr.PERMISSION_DENIED;case xo.FAILED_PRECONDITION:return Cr.FAILED_PRECONDITION;case xo.ABORTED:return Cr.ABORTED;case xo.OUT_OF_RANGE:return Cr.OUT_OF_RANGE;case xo.UNIMPLEMENTED:return Cr.UNIMPLEMENTED;case xo.DATA_LOSS:return Cr.DATA_LOSS;default:return Nr()}}(Po=xo||(xo={}))[Po.OK=0]="OK",Po[Po.CANCELLED=1]="CANCELLED",Po[Po.UNKNOWN=2]="UNKNOWN",Po[Po.INVALID_ARGUMENT=3]="INVALID_ARGUMENT",Po[Po.DEADLINE_EXCEEDED=4]="DEADLINE_EXCEEDED",Po[Po.NOT_FOUND=5]="NOT_FOUND",Po[Po.ALREADY_EXISTS=6]="ALREADY_EXISTS",Po[Po.PERMISSION_DENIED=7]="PERMISSION_DENIED",Po[Po.UNAUTHENTICATED=16]="UNAUTHENTICATED",Po[Po.RESOURCE_EXHAUSTED=8]="RESOURCE_EXHAUSTED",Po[Po.FAILED_PRECONDITION=9]="FAILED_PRECONDITION",Po[Po.ABORTED=10]="ABORTED",Po[Po.OUT_OF_RANGE=11]="OUT_OF_RANGE",Po[Po.UNIMPLEMENTED=12]="UNIMPLEMENTED",Po[Po.INTERNAL=13]="INTERNAL",Po[Po.UNAVAILABLE=14]="UNAVAILABLE",Po[Po.DATA_LOSS=15]="DATA_LOSS";
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Bo{constructor(t){this.comparator=t,this.data=new Uo(this.comparator)}has(t){return null!==this.data.get(t)}first(){return this.data.minKey()}last(){return this.data.maxKey()}get size(){return this.data.size}indexOf(t){return this.data.indexOf(t)}forEach(t){this.data.inorderTraversal(((e,n)=>(t(e),!1)))}forEachInRange(t,e){const n=this.data.getIteratorFrom(t[0]);for(;n.hasNext();){const i=n.getNext();if(this.comparator(i.key,t[1])>=0)return;e(i.key)}}forEachWhile(t,e){let n;for(n=void 0!==e?this.data.getIteratorFrom(e):this.data.getIterator();n.hasNext();)if(!t(n.getNext().key))return}firstAfterOrEqual(t){const e=this.data.getIteratorFrom(t);return e.hasNext()?e.getNext().key:null}getIterator(){return new Ho(this.data.getIterator())}getIteratorFrom(t){return new Ho(this.data.getIteratorFrom(t))}add(t){return this.copy(this.data.remove(t).insert(t,!0))}delete(t){return this.has(t)?this.copy(this.data.remove(t)):this}isEmpty(){return this.data.isEmpty()}unionWith(t){let e=this;return e.size<t.size&&(e=t,t=this),t.forEach((t=>{e=e.add(t)})),e}isEqual(t){if(!(t instanceof Bo))return!1;if(this.size!==t.size)return!1;const e=this.data.getIterator(),n=t.data.getIterator();for(;e.hasNext();){const t=e.getNext().key,i=n.getNext().key;if(0!==this.comparator(t,i))return!1}return!0}toArray(){const t=[];return this.forEach((e=>{t.push(e)})),t}toString(){const t=[];return this.forEach((e=>t.push(e))),"SortedSet("+t.toString()+")"}copy(t){const e=new Bo(this.comparator);return e.data=t,e}}class Ho{constructor(t){this.iter=t}getNext(){return this.iter.getNext().key}hasNext(){return this.iter.hasNext()}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qo=new Uo(hs.comparator);function $o(){return qo}const Ko=new Uo(hs.comparator);function Go(){return Ko}const zo=new Uo(hs.comparator);function Xo(){return zo}const Wo=new Bo(hs.comparator);function Qo(...t){let e=Wo;for(const n of t)e=e.add(n);return e}const Yo=new Bo(jr);function Jo(){return Yo}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Zo{constructor(t,e){this.databaseId=t,this.D=e}}function ta(t,e){return t.D?`${new Date(1e3*e.seconds).toISOString().replace(/\.\d*/,"").replace("Z","")}.${("000000000"+e.nanoseconds).slice(-9)}Z`:{seconds:""+e.seconds,nanos:e.nanoseconds}}function ea(t,e){return t.D?e.toBase64():e.toUint8Array()}function na(t,e){return ta(t,e.toTimestamp())}function ia(t){return _r(!!t),qr.fromTimestamp(function(t){const e=ts(t);return new Hr(e.seconds,e.nanos)}(t))}function ra(t,e){return(n=t,new Xr(["projects",n.projectId,"databases",n.database])).child("documents").child(e).canonicalString();var n}function sa(t){const e=Xr.fromString(t);return _r(wa(e)),e}function oa(t,e){return ra(t.databaseId,e.path)}function aa(t){const e=sa(t);return 4===e.length?Xr.emptyPath():ca(e)}function ha(t){return new Xr(["projects",t.databaseId.projectId,"databases",t.databaseId.database]).canonicalString()}function ca(t){return _r(t.length>4&&"documents"===t.get(4)),t.popFirst(5)}function la(t,e,n){return{name:oa(t,e),fields:n.value.mapValue.fields}}function ua(t,e){let n;if(e instanceof _o)n={update:la(t,e.key,e.value)};else if(e instanceof Oo)n={delete:oa(t,e.key)};else if(e instanceof Do)n={update:la(t,e.key,e.data),updateMask:va(e.fieldMask)};else{if(!(e instanceof ko))return Nr();n={verify:oa(t,e.key)}}return e.fieldTransforms.length>0&&(n.updateTransforms=e.fieldTransforms.map((t=>function(t,e){const n=e.transform;if(n instanceof co)return{fieldPath:e.field.canonicalString(),setToServerValue:"REQUEST_TIME"};if(n instanceof lo)return{fieldPath:e.field.canonicalString(),appendMissingElements:{values:n.elements}};if(n instanceof fo)return{fieldPath:e.field.canonicalString(),removeAllFromArray:{values:n.elements}};if(n instanceof go)return{fieldPath:e.field.canonicalString(),increment:n.C};throw Nr()}(0,t)))),e.precondition.isNone||(n.currentDocument=(i=t,void 0!==(r=e.precondition).updateTime?{updateTime:na(i,r.updateTime)}:void 0!==r.exists?{exists:r.exists}:Nr())),n;var i,r}function fa(t){let e=aa(t.parent);const n=t.structuredQuery,i=n.from?n.from.length:0;let r=null;if(i>0){_r(1===i);const t=n.from[0];t.allDescendants?r=t.collectionId:e=e.child(t.collectionId)}let s=[];n.where&&(s=da(n.where));let o=[];n.orderBy&&(o=n.orderBy.map((t=>{return new Us(ga((e=t).field),function(t){switch(t){case"ASCENDING":return"asc";case"DESCENDING":return"desc";default:return}}(e.direction));var e})));let a=null;n.limit&&(a=function(t){let e;return e="object"==typeof t?t.value:t,ss(e)?null:e}(n.limit));let h=null;n.startAt&&(h=pa(n.startAt));let c=null;return n.endAt&&(c=pa(n.endAt)),Hs(e,r,o,s,a,"F",h,c)}function da(t){return t?void 0!==t.unaryFilter?[ya(t)]:void 0!==t.fieldFilter?[ma(t)]:void 0!==t.compositeFilter?t.compositeFilter.filters.map((t=>da(t))).reduce(((t,e)=>t.concat(e))):Nr():[]}function pa(t){const e=!!t.before,n=t.values||[];return new Fs(n,e)}function ga(t){return Qr.fromServerFormat(t.fieldPath)}function ma(t){return _s.create(ga(t.fieldFilter.field),function(t){switch(t){case"EQUAL":return"==";case"NOT_EQUAL":return"!=";case"GREATER_THAN":return">";case"GREATER_THAN_OR_EQUAL":return">=";case"LESS_THAN":return"<";case"LESS_THAN_OR_EQUAL":return"<=";case"ARRAY_CONTAINS":return"array-contains";case"IN":return"in";case"NOT_IN":return"not-in";case"ARRAY_CONTAINS_ANY":return"array-contains-any";case"OPERATOR_UNSPECIFIED":default:return Nr()}}(t.fieldFilter.op),t.fieldFilter.value)}function ya(t){switch(t.unaryFilter.op){case"IS_NAN":const e=ga(t.unaryFilter.field);return _s.create(e,"==",{doubleValue:NaN});case"IS_NULL":const n=ga(t.unaryFilter.field);return _s.create(n,"==",{nullValue:"NULL_VALUE"});case"IS_NOT_NAN":const i=ga(t.unaryFilter.field);return _s.create(i,"!=",{doubleValue:NaN});case"IS_NOT_NULL":const r=ga(t.unaryFilter.field);return _s.create(r,"!=",{nullValue:"NULL_VALUE"});case"OPERATOR_UNSPECIFIED":default:return Nr()}}function va(t){const e=[];return t.fields.forEach((t=>e.push(t.canonicalString()))),{fieldPaths:e}}function wa(t){return t.length>=4&&"projects"===t.get(0)&&"databases"===t.get(2)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ba(t){let e="";for(let n=0;n<t.length;n++)e.length>0&&(e=Ta(e)),e=Ea(t.get(n),e);return Ta(e)}function Ea(t,e){let n=e;const i=t.length;for(let e=0;e<i;e++){const i=t.charAt(e);switch(i){case"\0":n+="";break;case"":n+="";break;default:n+=i}}return n}function Ta(t){return t+""}class Ia{constructor(t,e,n){this.ownerId=t,this.allowTabSynchronization=e,this.leaseTimestampMs=n}}Ia.store="owner",Ia.key="owner";class Aa{constructor(t,e,n){this.userId=t,this.lastAcknowledgedBatchId=e,this.lastStreamToken=n}}Aa.store="mutationQueues",Aa.keyPath="userId";class Sa{constructor(t,e,n,i,r){this.userId=t,this.batchId=e,this.localWriteTimeMs=n,this.baseMutations=i,this.mutations=r}}Sa.store="mutations",Sa.keyPath="batchId",Sa.userMutationsIndex="userMutationsIndex",Sa.userMutationsKeyPath=["userId","batchId"];class Na{constructor(){}static prefixForUser(t){return[t]}static prefixForPath(t,e){return[t,ba(e)]}static key(t,e,n){return[t,ba(e),n]}}Na.store="documentMutations",Na.PLACEHOLDER=new Na;class _a{constructor(t,e,n,i,r,s){this.unknownDocument=t,this.noDocument=e,this.document=n,this.hasCommittedMutations=i,this.readTime=r,this.parentPath=s}}_a.store="remoteDocuments",_a.readTimeIndex="readTimeIndex",_a.readTimeIndexPath="readTime",_a.collectionReadTimeIndex="collectionReadTimeIndex",_a.collectionReadTimeIndexPath=["parentPath","readTime"];class Da{constructor(t){this.byteSize=t}}Da.store="remoteDocumentGlobal",Da.key="remoteDocumentGlobalKey";class Ca{constructor(t,e,n,i,r,s,o){this.targetId=t,this.canonicalId=e,this.readTime=n,this.resumeToken=i,this.lastListenSequenceNumber=r,this.lastLimboFreeSnapshotVersion=s,this.query=o}}Ca.store="targets",Ca.keyPath="targetId",Ca.queryTargetsIndexName="queryTargetsIndex",Ca.queryTargetsKeyPath=["canonicalId","targetId"];class Ra{constructor(t,e,n){this.targetId=t,this.path=e,this.sequenceNumber=n}}Ra.store="targetDocuments",Ra.keyPath=["targetId","path"],Ra.documentTargetsIndex="documentTargetsIndex",Ra.documentTargetsKeyPath=["path","targetId"];class La{constructor(t,e,n,i){this.highestTargetId=t,this.highestListenSequenceNumber=e,this.lastRemoteSnapshotVersion=n,this.targetCount=i}}La.key="targetGlobalKey",La.store="targetGlobal";class Oa{constructor(t,e){this.collectionId=t,this.parent=e}}Oa.store="collectionParents",Oa.keyPath=["collectionId","parent"];class ka{constructor(t,e,n,i){this.clientId=t,this.updateTimeMs=e,this.networkEnabled=n,this.inForeground=i}}ka.store="clientMetadata",ka.keyPath="clientId";class xa{constructor(t,e,n){this.bundleId=t,this.createTime=e,this.version=n}}xa.store="bundles",xa.keyPath="bundleId";class Pa{constructor(t,e,n){this.name=t,this.readTime=e,this.bundledQuery=n}}Pa.store="namedQueries",Pa.keyPath="name";Aa.store,Sa.store,Na.store,_a.store,Ca.store,Ia.store,La.store,Ra.store,ka.store,Da.store,Oa.store,xa.store,Pa.store;const Fa="The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab.";class Ma{constructor(){this.onCommittedListeners=[]}addOnCommittedListener(t){this.onCommittedListeners.push(t)}raiseOnCommittedEvent(){this.onCommittedListeners.forEach((t=>t()))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ua{constructor(t){this.nextCallback=null,this.catchCallback=null,this.result=void 0,this.error=void 0,this.isDone=!1,this.callbackAttached=!1,t((t=>{this.isDone=!0,this.result=t,this.nextCallback&&this.nextCallback(t)}),(t=>{this.isDone=!0,this.error=t,this.catchCallback&&this.catchCallback(t)}))}catch(t){return this.next(void 0,t)}next(t,e){return this.callbackAttached&&Nr(),this.callbackAttached=!0,this.isDone?this.error?this.wrapFailure(e,this.error):this.wrapSuccess(t,this.result):new Ua(((n,i)=>{this.nextCallback=e=>{this.wrapSuccess(t,e).next(n,i)},this.catchCallback=t=>{this.wrapFailure(e,t).next(n,i)}}))}toPromise(){return new Promise(((t,e)=>{this.next(t,e)}))}wrapUserFunction(t){try{const e=t();return e instanceof Ua?e:Ua.resolve(e)}catch(t){return Ua.reject(t)}}wrapSuccess(t,e){return t?this.wrapUserFunction((()=>t(e))):Ua.resolve(e)}wrapFailure(t,e){return t?this.wrapUserFunction((()=>t(e))):Ua.reject(e)}static resolve(t){return new Ua(((e,n)=>{e(t)}))}static reject(t){return new Ua(((e,n)=>{n(t)}))}static waitFor(t){return new Ua(((e,n)=>{let i=0,r=0,s=!1;t.forEach((t=>{++i,t.next((()=>{++r,s&&r===i&&e()}),(t=>n(t)))})),s=!0,r===i&&e()}))}static or(t){let e=Ua.resolve(!1);for(const n of t)e=e.next((t=>t?Ua.resolve(t):n()));return e}static forEach(t,e){const n=[];return t.forEach(((t,i)=>{n.push(e.call(this,t,i))})),this.waitFor(n)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class ja{constructor(t,e,n,i){this.batchId=t,this.localWriteTime=e,this.baseMutations=n,this.mutations=i}applyToRemoteDocument(t,e){const n=e.mutationResults;for(let e=0;e<this.mutations.length;e++){const a=this.mutations[e];a.key.isEqual(t.key)&&(i=a,r=t,s=n[e],o=void 0,i instanceof _o?function(t,e,n){const i=t.value.clone(),r=Ro(t.fieldTransforms,e,n.transformResults);i.setAll(r),e.convertToFoundDocument(n.version,i).setHasCommittedMutations()}(i,r,s):i instanceof Do?function(t,e,n){if(!Eo(t.precondition,e))return void e.convertToUnknownDocument(n.version);const i=Ro(t.fieldTransforms,e,n.transformResults),r=e.data;r.setAll(Co(t)),r.setAll(i),e.convertToFoundDocument(n.version,r).setHasCommittedMutations()}(i,r,s):(o=s,r.convertToNoDocument(o.version).setHasCommittedMutations()))}var i,r,s,o}applyToLocalView(t){for(const e of this.baseMutations)e.key.isEqual(t.key)&&Io(e,t,this.localWriteTime);for(const e of this.mutations)e.key.isEqual(t.key)&&Io(e,t,this.localWriteTime)}applyToLocalDocumentSet(t){this.mutations.forEach((e=>{const n=t.get(e.key),i=n;this.applyToLocalView(i),n.isValidDocument()||i.convertToNoDocument(qr.min())}))}keys(){return this.mutations.reduce(((t,e)=>t.add(e.key)),Qo())}isEqual(t){return this.batchId===t.batchId&&Br(this.mutations,t.mutations,((t,e)=>So(t,e)))&&Br(this.baseMutations,t.baseMutations,((t,e)=>So(t,e)))}}class Ba{constructor(t,e,n,i){this.batch=t,this.commitVersion=e,this.mutationResults=n,this.docVersions=i}static from(t,e,n){_r(t.mutations.length===n.length);let i=Xo();const r=t.mutations;for(let t=0;t<r.length;t++)i=i.insert(r[t].key,n[t].version);return new Ba(t,e,n,i)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ha{constructor(t){this.Wt=t}}function qa(t){const e=fa({parent:t.parent,structuredQuery:t.structuredQuery});return"LAST"===t.limitType?Ys(e,e.limit,"L"):e}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class $a{constructor(){this.Gt=new Ka}addToCollectionParentIndex(t,e){return this.Gt.add(e),Ua.resolve()}getCollectionParents(t,e){return Ua.resolve(this.Gt.getEntries(e))}}class Ka{constructor(){this.index={}}add(t){const e=t.lastSegment(),n=t.popLast(),i=this.index[e]||new Bo(Xr.comparator),r=!i.has(n);return this.index[e]=i.add(n),r}has(t){const e=t.lastSegment(),n=t.popLast(),i=this.index[e];return i&&i.has(n)}getEntries(t){return(this.index[t]||new Bo(Xr.comparator)).toArray()}}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
class za{constructor(t){this.ne=t}next(){return this.ne+=2,this.ne}static se(){return new za(0)}static ie(){return new za(-1)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
async function Xa(t){if(t.code!==Cr.FAILED_PRECONDITION||t.message!==Fa)throw t;Tr("LocalStore","Unexpectedly lost primary lease")}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class Wa{constructor(t,e){this.mapKeyFn=t,this.equalsFn=e,this.inner={}}get(t){const e=this.mapKeyFn(t),n=this.inner[e];if(void 0!==n)for(const[e,i]of n)if(this.equalsFn(e,t))return i}has(t){return void 0!==this.get(t)}set(t,e){const n=this.mapKeyFn(t),i=this.inner[n];if(void 0!==i){for(let n=0;n<i.length;n++)if(this.equalsFn(i[n][0],t))return void(i[n]=[t,e]);i.push([t,e])}else this.inner[n]=[[t,e]]}delete(t){const e=this.mapKeyFn(t),n=this.inner[e];if(void 0===n)return!1;for(let i=0;i<n.length;i++)if(this.equalsFn(n[i][0],t))return 1===n.length?delete this.inner[e]:n.splice(i,1),!0;return!1}forEach(t){Kr(this.inner,((e,n)=>{for(const[e,i]of n)t(e,i)}))}isEmpty(){return Gr(this.inner)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qa{constructor(){this.changes=new Wa((t=>t.toString()),((t,e)=>t.isEqual(e))),this.changesApplied=!1}getReadTime(t){const e=this.changes.get(t);return e?e.readTime:qr.min()}addEntry(t,e){this.assertNotApplied(),this.changes.set(t.key,{document:t,readTime:e})}removeEntry(t,e=null){this.assertNotApplied(),this.changes.set(t,{document:Ts.newInvalidDocument(t),readTime:e})}getEntry(t,e){this.assertNotApplied();const n=this.changes.get(e);return void 0!==n?Ua.resolve(n.document):this.getFromCache(t,e)}getEntries(t,e){return this.getAllFromCache(t,e)}apply(t){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(t)}assertNotApplied(){}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Ya{constructor(t,e,n){this.He=t,this.In=e,this.Ht=n}An(t,e){return this.In.getAllMutationBatchesAffectingDocumentKey(t,e).next((n=>this.Rn(t,e,n)))}Rn(t,e,n){return this.He.getEntry(t,e).next((t=>{for(const e of n)e.applyToLocalView(t);return t}))}Pn(t,e){t.forEach(((t,n)=>{for(const t of e)t.applyToLocalView(n)}))}bn(t,e){return this.He.getEntries(t,e).next((e=>this.vn(t,e).next((()=>e))))}vn(t,e){return this.In.getAllMutationBatchesAffectingDocumentKeys(t,e).next((t=>this.Pn(e,t)))}getDocumentsMatchingQuery(t,e,n){return i=e,hs.isDocumentKey(i.path)&&null===i.collectionGroup&&0===i.filters.length?this.Vn(t,e.path):Xs(e)?this.Sn(t,e,n):this.Dn(t,e,n);var i}Vn(t,e){return this.An(t,new hs(e)).next((t=>{let e=Go();return t.isFoundDocument()&&(e=e.insert(t.key,t)),e}))}Sn(t,e,n){const i=e.collectionGroup;let r=Go();return this.Ht.getCollectionParents(t,i).next((s=>Ua.forEach(s,(s=>{const o=(a=e,h=s.child(i),new Bs(h,null,a.explicitOrderBy.slice(),a.filters.slice(),a.limit,a.limitType,a.startAt,a.endAt));var a,h;return this.Dn(t,o,n).next((t=>{t.forEach(((t,e)=>{r=r.insert(t,e)}))}))})).next((()=>r))))}Dn(t,e,n){let i,r;return this.He.getDocumentsMatchingQuery(t,e,n).next((n=>(i=n,this.In.getAllMutationBatchesAffectingQuery(t,e)))).next((e=>(r=e,this.Cn(t,r,i).next((t=>{i=t;for(const t of r)for(const e of t.mutations){const n=e.key;let r=i.get(n);null==r&&(r=Ts.newInvalidDocument(n),i=i.insert(n,r)),Io(e,r,t.localWriteTime),r.isFoundDocument()||(i=i.remove(n))}}))))).next((()=>(i.forEach(((t,n)=>{eo(e,n)||(i=i.remove(t))})),i)))}Cn(t,e,n){let i=Qo();for(const t of e)for(const e of t.mutations)e instanceof Do&&null===n.get(e.key)&&(i=i.add(e.key));let r=n;return this.He.getEntries(t,i).next((t=>(t.forEach(((t,e)=>{e.isFoundDocument()&&(r=r.insert(t,e))})),r)))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ja{constructor(t,e,n,i){this.targetId=t,this.fromCache=e,this.Nn=n,this.xn=i}static kn(t,e){let n=Qo(),i=Qo();for(const t of e.docChanges)switch(t.type){case 0:n=n.add(t.doc.key);break;case 1:i=i.add(t.doc.key)}return new Ja(t,e.fromCache,n,i)}}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class th{constructor(t,e,n,i){this.persistence=t,this.Bn=e,this.N=i,this.Un=new Uo(jr),this.qn=new Wa((t=>Ss(t)),Ns),this.Kn=qr.min(),this.In=t.getMutationQueue(n),this.jn=t.getRemoteDocumentCache(),this.ze=t.getTargetCache(),this.Qn=new Ya(this.jn,this.In,this.persistence.getIndexManager()),this.Je=t.getBundleCache(),this.Bn.$n(this.Qn)}collectGarbage(t){return this.persistence.runTransaction("Collect garbage","readwrite-primary",(e=>t.collect(e,this.Un)))}}function eh(t,e,n,i){return new th(t,e,n,i)}async function nh(t,e){const n=Dr(t);let i=n.In,r=n.Qn;const s=await n.persistence.runTransaction("Handle user change","readonly",(t=>{let s;return n.In.getAllMutationBatches(t).next((o=>(s=o,i=n.persistence.getMutationQueue(e),r=new Ya(n.jn,i,n.persistence.getIndexManager()),i.getAllMutationBatches(t)))).next((e=>{const n=[],i=[];let o=Qo();for(const t of s){n.push(t.batchId);for(const e of t.mutations)o=o.add(e.key)}for(const t of e){i.push(t.batchId);for(const e of t.mutations)o=o.add(e.key)}return r.bn(t,o).next((t=>({Wn:t,removedBatchIds:n,addedBatchIds:i})))}))}));return n.In=i,n.Qn=r,n.Bn.$n(n.Qn),s}function ih(t){const e=Dr(t);return e.persistence.runTransaction("Get last remote snapshot version","readonly",(t=>e.ze.getLastRemoteSnapshotVersion(t)))}function rh(t,e){const n=Dr(t);return n.persistence.runTransaction("Get next mutation batch","readonly",(t=>(void 0===e&&(e=-1),n.In.getNextMutationBatchAfterBatchId(t,e))))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class sh{constructor(t){this.N=t,this.Yn=new Map,this.Xn=new Map}getBundleMetadata(t,e){return Ua.resolve(this.Yn.get(e))}saveBundleMetadata(t,e){var n;return this.Yn.set(e.id,{id:(n=e).id,version:n.version,createTime:ia(n.createTime)}),Ua.resolve()}getNamedQuery(t,e){return Ua.resolve(this.Xn.get(e))}saveNamedQuery(t,e){return this.Xn.set(e.name,{name:(n=e).name,query:qa(n.bundledQuery),readTime:ia(n.readTime)}),Ua.resolve();var n}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class oh{constructor(){this.Zn=new Bo(ah.ts),this.es=new Bo(ah.ns)}isEmpty(){return this.Zn.isEmpty()}addReference(t,e){const n=new ah(t,e);this.Zn=this.Zn.add(n),this.es=this.es.add(n)}ss(t,e){t.forEach((t=>this.addReference(t,e)))}removeReference(t,e){this.rs(new ah(t,e))}os(t,e){t.forEach((t=>this.removeReference(t,e)))}cs(t){const e=new hs(new Xr([])),n=new ah(e,t),i=new ah(e,t+1),r=[];return this.es.forEachInRange([n,i],(t=>{this.rs(t),r.push(t.key)})),r}us(){this.Zn.forEach((t=>this.rs(t)))}rs(t){this.Zn=this.Zn.delete(t),this.es=this.es.delete(t)}hs(t){const e=new hs(new Xr([])),n=new ah(e,t),i=new ah(e,t+1);let r=Qo();return this.es.forEachInRange([n,i],(t=>{r=r.add(t.key)})),r}containsKey(t){const e=new ah(t,0),n=this.Zn.firstAfterOrEqual(e);return null!==n&&t.isEqual(n.key)}}class ah{constructor(t,e){this.key=t,this.ls=e}static ts(t,e){return hs.comparator(t.key,e.key)||jr(t.ls,e.ls)}static ns(t,e){return jr(t.ls,e.ls)||hs.comparator(t.key,e.key)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class hh{constructor(t,e){this.Ht=t,this.referenceDelegate=e,this.In=[],this.fs=1,this.ds=new Bo(ah.ts)}checkEmpty(t){return Ua.resolve(0===this.In.length)}addMutationBatch(t,e,n,i){const r=this.fs;this.fs++,this.In.length>0&&this.In[this.In.length-1];const s=new ja(r,e,n,i);this.In.push(s);for(const e of i)this.ds=this.ds.add(new ah(e.key,r)),this.Ht.addToCollectionParentIndex(t,e.key.path.popLast());return Ua.resolve(s)}lookupMutationBatch(t,e){return Ua.resolve(this.ws(e))}getNextMutationBatchAfterBatchId(t,e){const n=e+1,i=this._s(n),r=i<0?0:i;return Ua.resolve(this.In.length>r?this.In[r]:null)}getHighestUnacknowledgedBatchId(){return Ua.resolve(0===this.In.length?-1:this.fs-1)}getAllMutationBatches(t){return Ua.resolve(this.In.slice())}getAllMutationBatchesAffectingDocumentKey(t,e){const n=new ah(e,0),i=new ah(e,Number.POSITIVE_INFINITY),r=[];return this.ds.forEachInRange([n,i],(t=>{const e=this.ws(t.ls);r.push(e)})),Ua.resolve(r)}getAllMutationBatchesAffectingDocumentKeys(t,e){let n=new Bo(jr);return e.forEach((t=>{const e=new ah(t,0),i=new ah(t,Number.POSITIVE_INFINITY);this.ds.forEachInRange([e,i],(t=>{n=n.add(t.ls)}))})),Ua.resolve(this.gs(n))}getAllMutationBatchesAffectingQuery(t,e){const n=e.path,i=n.length+1;let r=n;hs.isDocumentKey(r)||(r=r.child(""));const s=new ah(new hs(r),0);let o=new Bo(jr);return this.ds.forEachWhile((t=>{const e=t.key.path;return!!n.isPrefixOf(e)&&(e.length===i&&(o=o.add(t.ls)),!0)}),s),Ua.resolve(this.gs(o))}gs(t){const e=[];return t.forEach((t=>{const n=this.ws(t);null!==n&&e.push(n)})),e}removeMutationBatch(t,e){_r(0===this.ys(e.batchId,"removed")),this.In.shift();let n=this.ds;return Ua.forEach(e.mutations,(i=>{const r=new ah(i.key,e.batchId);return n=n.delete(r),this.referenceDelegate.markPotentiallyOrphaned(t,i.key)})).next((()=>{this.ds=n}))}te(t){}containsKey(t,e){const n=new ah(e,0),i=this.ds.firstAfterOrEqual(n);return Ua.resolve(e.isEqual(i&&i.key))}performConsistencyCheck(t){return this.In.length,Ua.resolve()}ys(t,e){return this._s(t)}_s(t){return 0===this.In.length?0:t-this.In[0].batchId}ws(t){const e=this._s(t);return e<0||e>=this.In.length?null:this.In[e]}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ch{constructor(t,e){this.Ht=t,this.ps=e,this.docs=new Uo(hs.comparator),this.size=0}addEntry(t,e,n){const i=e.key,r=this.docs.get(i),s=r?r.size:0,o=this.ps(e);return this.docs=this.docs.insert(i,{document:e.clone(),size:o,readTime:n}),this.size+=o-s,this.Ht.addToCollectionParentIndex(t,i.path.popLast())}removeEntry(t){const e=this.docs.get(t);e&&(this.docs=this.docs.remove(t),this.size-=e.size)}getEntry(t,e){const n=this.docs.get(e);return Ua.resolve(n?n.document.clone():Ts.newInvalidDocument(e))}getEntries(t,e){let n=$o();return e.forEach((t=>{const e=this.docs.get(t);n=n.insert(t,e?e.document.clone():Ts.newInvalidDocument(t))})),Ua.resolve(n)}getDocumentsMatchingQuery(t,e,n){let i=$o();const r=new hs(e.path.child("")),s=this.docs.getIteratorFrom(r);for(;s.hasNext();){const{key:t,value:{document:r,readTime:o}}=s.getNext();if(!e.path.isPrefixOf(t.path))break;o.compareTo(n)<=0||eo(e,r)&&(i=i.insert(r.key,r.clone()))}return Ua.resolve(i)}Es(t,e){return Ua.forEach(this.docs,(t=>e(t)))}newChangeBuffer(t){return new lh(this)}getSize(t){return Ua.resolve(this.size)}}class lh extends Qa{constructor(t){super(),this.Se=t}applyChanges(t){const e=[];return this.changes.forEach(((n,i)=>{i.document.isValidDocument()?e.push(this.Se.addEntry(t,i.document,this.getReadTime(n))):this.Se.removeEntry(n)})),Ua.waitFor(e)}getFromCache(t,e){return this.Se.getEntry(t,e)}getAllFromCache(t,e){return this.Se.getEntries(t,e)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class uh{constructor(t){this.persistence=t,this.Ts=new Wa((t=>Ss(t)),Ns),this.lastRemoteSnapshotVersion=qr.min(),this.highestTargetId=0,this.Is=0,this.As=new oh,this.targetCount=0,this.Rs=za.se()}forEachTarget(t,e){return this.Ts.forEach(((t,n)=>e(n))),Ua.resolve()}getLastRemoteSnapshotVersion(t){return Ua.resolve(this.lastRemoteSnapshotVersion)}getHighestSequenceNumber(t){return Ua.resolve(this.Is)}allocateTargetId(t){return this.highestTargetId=this.Rs.next(),Ua.resolve(this.highestTargetId)}setTargetsMetadata(t,e,n){return n&&(this.lastRemoteSnapshotVersion=n),e>this.Is&&(this.Is=e),Ua.resolve()}ae(t){this.Ts.set(t.target,t);const e=t.targetId;e>this.highestTargetId&&(this.Rs=new za(e),this.highestTargetId=e),t.sequenceNumber>this.Is&&(this.Is=t.sequenceNumber)}addTargetData(t,e){return this.ae(e),this.targetCount+=1,Ua.resolve()}updateTargetData(t,e){return this.ae(e),Ua.resolve()}removeTargetData(t,e){return this.Ts.delete(e.target),this.As.cs(e.targetId),this.targetCount-=1,Ua.resolve()}removeTargets(t,e,n){let i=0;const r=[];return this.Ts.forEach(((s,o)=>{o.sequenceNumber<=e&&null===n.get(o.targetId)&&(this.Ts.delete(s),r.push(this.removeMatchingKeysForTargetId(t,o.targetId)),i++)})),Ua.waitFor(r).next((()=>i))}getTargetCount(t){return Ua.resolve(this.targetCount)}getTargetData(t,e){const n=this.Ts.get(e)||null;return Ua.resolve(n)}addMatchingKeys(t,e,n){return this.As.ss(e,n),Ua.resolve()}removeMatchingKeys(t,e,n){this.As.os(e,n);const i=this.persistence.referenceDelegate,r=[];return i&&e.forEach((e=>{r.push(i.markPotentiallyOrphaned(t,e))})),Ua.waitFor(r)}removeMatchingKeysForTargetId(t,e){return this.As.cs(e),Ua.resolve()}getMatchingKeysForTargetId(t,e){const n=this.As.hs(e);return Ua.resolve(n)}containsKey(t,e){return Ua.resolve(this.As.containsKey(e))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class fh{constructor(t,e){var n;this.Ps={},this.Le=new Mr(0),this.Be=!1,this.Be=!0,this.referenceDelegate=t(this),this.ze=new uh(this),this.Ht=new $a,this.He=(n=this.Ht,new ch(n,(t=>this.referenceDelegate.bs(t)))),this.N=new Ha(e),this.Je=new sh(this.N)}start(){return Promise.resolve()}shutdown(){return this.Be=!1,Promise.resolve()}get started(){return this.Be}setDatabaseDeletedListener(){}setNetworkEnabled(){}getIndexManager(){return this.Ht}getMutationQueue(t){let e=this.Ps[t.toKey()];return e||(e=new hh(this.Ht,this.referenceDelegate),this.Ps[t.toKey()]=e),e}getTargetCache(){return this.ze}getRemoteDocumentCache(){return this.He}getBundleCache(){return this.Je}runTransaction(t,e,n){Tr("MemoryPersistence","Starting transaction:",t);const i=new dh(this.Le.next());return this.referenceDelegate.vs(),n(i).next((t=>this.referenceDelegate.Vs(i).next((()=>t)))).toPromise().then((t=>(i.raiseOnCommittedEvent(),t)))}Ss(t,e){return Ua.or(Object.values(this.Ps).map((n=>()=>n.containsKey(t,e))))}}class dh extends Ma{constructor(t){super(),this.currentSequenceNumber=t}}class ph{constructor(t){this.persistence=t,this.Ds=new oh,this.Cs=null}static Ns(t){return new ph(t)}get xs(){if(this.Cs)return this.Cs;throw Nr()}addReference(t,e,n){return this.Ds.addReference(n,e),this.xs.delete(n.toString()),Ua.resolve()}removeReference(t,e,n){return this.Ds.removeReference(n,e),this.xs.add(n.toString()),Ua.resolve()}markPotentiallyOrphaned(t,e){return this.xs.add(e.toString()),Ua.resolve()}removeTarget(t,e){this.Ds.cs(e.targetId).forEach((t=>this.xs.add(t.toString())));const n=this.persistence.getTargetCache();return n.getMatchingKeysForTargetId(t,e.targetId).next((t=>{t.forEach((t=>this.xs.add(t.toString())))})).next((()=>n.removeTargetData(t,e)))}vs(){this.Cs=new Set}Vs(t){const e=this.persistence.getRemoteDocumentCache().newChangeBuffer();return Ua.forEach(this.xs,(n=>{const i=hs.fromPath(n);return this.ks(t,i).next((t=>{t||e.removeEntry(i)}))})).next((()=>(this.Cs=null,e.apply(t))))}updateLimboDocument(t,e){return this.ks(t,e).next((t=>{t?this.xs.delete(e.toString()):this.xs.add(e.toString())}))}bs(t){return 0}ks(t,e){return Ua.or([()=>Ua.resolve(this.Ds.containsKey(e)),()=>this.persistence.getTargetCache().containsKey(t,e),()=>this.persistence.Ss(t,e)])}}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gh{constructor(){this.activeTargetIds=Jo()}Fs(t){this.activeTargetIds=this.activeTargetIds.add(t)}Ms(t){this.activeTargetIds=this.activeTargetIds.delete(t)}Os(){const t={activeTargetIds:this.activeTargetIds.toArray(),updateTimeMs:Date.now()};return JSON.stringify(t)}}class mh{constructor(){this.yi=new gh,this.pi={},this.onlineStateHandler=null,this.sequenceNumberHandler=null}addPendingMutation(t){}updateMutationState(t,e,n){}addLocalQueryTarget(t){return this.yi.Fs(t),this.pi[t]||"not-current"}updateQueryState(t,e,n){this.pi[t]=e}removeLocalQueryTarget(t){this.yi.Ms(t)}isLocalQueryTarget(t){return this.yi.activeTargetIds.has(t)}clearQueryState(t){delete this.pi[t]}getAllActiveQueryTargets(){return this.yi.activeTargetIds}isActiveQueryTarget(t){return this.yi.activeTargetIds.has(t)}start(){return this.yi=new gh,Promise.resolve()}handleUserChange(t,e,n){}setOnlineState(t){}shutdown(){}writeSequenceNumber(t){}notifyBundleLoaded(){}}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const wh={BatchGetDocuments:"batchGet",Commit:"commit",RunQuery:"runQuery"};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bh{constructor(t){this.vi=t.vi,this.Vi=t.Vi}Si(t){this.Di=t}Ci(t){this.Ni=t}onMessage(t){this.xi=t}close(){this.Vi()}send(t){this.vi(t)}ki(){this.Di()}$i(t){this.Ni(t)}Oi(t){this.xi(t)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ch{constructor(t,e,n,i,r){this.localStore=t,this.datastore=e,this.asyncQueue=n,this.remoteSyncer={},this.Ur=[],this.qr=new Map,this.Kr=new Set,this.jr=[],this.Qr=r,this.Qr.Ei((t=>{n.enqueueAndForget((async()=>{Oh(this)&&(Tr("RemoteStore","Restarting streams for network reachability change."),await async function(t){const e=Dr(t);e.Kr.add(4),await Lh(e),e.Wr.set("Unknown"),e.Kr.delete(4),await Rh(e)}(this))}))})),this.Wr=new Dh(n,i)}}async function Rh(t){if(Oh(t))for(const e of t.jr)await e(!0)}async function Lh(t){for(const e of t.jr)await e(!1)}function Oh(t){return 0===Dr(t).Kr.size}async function kh(t,e,n){if(!Va(e))throw e;t.Kr.add(1),await Lh(t),t.Wr.set("Offline"),n||(n=()=>ih(t.localStore)),t.asyncQueue.enqueueRetryable((async()=>{Tr("RemoteStore","Retrying IndexedDB access"),await n(),t.Kr.delete(1),await Rh(t)}))}function xh(t,e){return e().catch((n=>kh(t,n,e)))}async function Ph(t){const e=Dr(t),n=Kh(e);let i=e.Ur.length>0?e.Ur[e.Ur.length-1].batchId:-1;for(;Fh(e);)try{const t=await rh(e.localStore,i);if(null===t){0===e.Ur.length&&n.lr();break}i=t.batchId,Mh(e,t)}catch(t){await kh(e,t)}Uh(e)&&Vh(e)}function Fh(t){return Oh(t)&&t.Ur.length<10}function Mh(t,e){t.Ur.push(e);const n=Kh(t);n.cr()&&n.Pr&&n.br(e.mutations)}function Uh(t){return Oh(t)&&!Kh(t).ar()&&t.Ur.length>0}function Vh(t){Kh(t).start()}async function jh(t){Kh(t).Sr()}async function Bh(t){const e=Kh(t);for(const n of t.Ur)e.br(n.mutations)}async function Hh(t,e,n){const i=t.Ur.shift(),r=Ba.from(i,e,n);await xh(t,(()=>t.remoteSyncer.applySuccessfulWrite(r))),await Ph(t)}async function qh(t,e){e&&Kh(t).Pr&&await async function(t,e){if(Fo(n=e.code)&&n!==Cr.ABORTED){const n=t.Ur.shift();Kh(t).hr(),await xh(t,(()=>t.remoteSyncer.rejectFailedWrite(n.batchId,e))),await Ph(t)}var n}(t,e),Uh(t)&&Vh(t)}async function $h(t,e){const n=Dr(t);e?(n.Kr.delete(2),await Rh(n)):e||(n.Kr.add(2),await Lh(n),n.Wr.set("Unknown"))}function Kh(t){return t.Hr||(t.Hr=function(t,e,n){const i=Dr(t);return i.Cr(),new Nh(e,i.nr,i.credentials,i.N,n)}(t.datastore,t.asyncQueue,{Si:jh.bind(null,t),Ci:qh.bind(null,t),Vr:Bh.bind(null,t),vr:Hh.bind(null,t)}),t.jr.push((async e=>{e?(t.Hr.hr(),await Ph(t)):(await t.Hr.stop(),t.Ur.length>0&&(Tr("RemoteStore",`Stopping write stream with ${t.Ur.length} pending writes`),t.Ur=[]))}))),t.Hr
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */}class Gh{constructor(t,e,n,i,r){this.asyncQueue=t,this.timerId=e,this.targetTimeMs=n,this.op=i,this.removalCallback=r,this.deferred=new Lr,this.then=this.deferred.promise.then.bind(this.deferred.promise),this.deferred.promise.catch((t=>{}))}static createAndSchedule(t,e,n,i,r){const s=Date.now()+n,o=new Gh(t,e,s,i,r);return o.start(n),o}start(t){this.timerHandle=setTimeout((()=>this.handleDelayElapsed()),t)}skipDelay(){return this.handleDelayElapsed()}cancel(t){null!==this.timerHandle&&(this.clearTimeout(),this.deferred.reject(new Rr(Cr.CANCELLED,"Operation cancelled"+(t?": "+t:""))))}handleDelayElapsed(){this.asyncQueue.enqueueAndForget((()=>null!==this.timerHandle?(this.clearTimeout(),this.op().then((t=>this.deferred.resolve(t)))):Promise.resolve()))}clearTimeout(){null!==this.timerHandle&&(this.removalCallback(this),clearTimeout(this.timerHandle),this.timerHandle=null)}}function zh(t,e){if(Ir("AsyncQueue",`${e}: ${t}`),Va(t))return new Rr(Cr.UNAVAILABLE,`${e}: ${t}`);throw t}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xh{constructor(){this.queries=new Wa((t=>Zs(t)),Js),this.onlineState="Unknown",this.Zr=new Set}}function Wh(t){t.Zr.forEach((t=>{t.next()}))}class Qh{constructor(t,e,n,i,r,s){this.localStore=t,this.remoteStore=e,this.eventManager=n,this.sharedClientState=i,this.currentUser=r,this.maxConcurrentLimboResolutions=s,this.No={},this.xo=new Wa((t=>Zs(t)),Js),this.ko=new Map,this.$o=new Set,this.Oo=new Uo(hs.comparator),this.Fo=new Map,this.Mo=new oh,this.Lo={},this.Bo=new Map,this.Uo=za.ie(),this.onlineState="Unknown",this.qo=void 0}get isPrimaryClient(){return!0===this.qo}}function Yh(t,e,n){const i=Dr(t);if(i.isPrimaryClient&&0===n||!i.isPrimaryClient&&1===n){const t=[];i.xo.forEach(((n,i)=>{const r=i.view.eo(e);r.snapshot&&t.push(r.snapshot)})),function(t,e){const n=Dr(t);n.onlineState=e;let i=!1;n.queries.forEach(((t,n)=>{for(const t of n.listeners)t.eo(e)&&(i=!0)})),i&&Wh(n)}(i.eventManager,e),t.length&&i.No.Tr(t),i.onlineState=e,i.isPrimaryClient&&i.sharedClientState.setOnlineState(e)}}async function Jh(t,e){const n=Dr(t),i=e.batch.batchId;try{const t=await function(t,e){const n=Dr(t);return n.persistence.runTransaction("Acknowledge batch","readwrite-primary",(t=>{const i=e.batch.keys(),r=n.jn.newChangeBuffer({trackRemovals:!0});return function(t,e,n,i){const r=n.batch,s=r.keys();let o=Ua.resolve();return s.forEach((t=>{o=o.next((()=>i.getEntry(e,t))).next((e=>{const s=n.docVersions.get(t);_r(null!==s),e.version.compareTo(s)<0&&(r.applyToRemoteDocument(e,n),e.isValidDocument()&&i.addEntry(e,n.commitVersion))}))})),o.next((()=>t.In.removeMutationBatch(e,r)))}(n,t,e,r).next((()=>r.apply(t))).next((()=>n.In.performConsistencyCheck(t))).next((()=>n.Qn.bn(t,i)))}))}(n.localStore,e);ec(n,i,null),tc(n,i),n.sharedClientState.updateMutationState(i,"acknowledged"),await nc(n,t)}catch(t){await Xa(t)}}async function Zh(t,e,n){const i=Dr(t);try{const t=await function(t,e){const n=Dr(t);return n.persistence.runTransaction("Reject batch","readwrite-primary",(t=>{let i;return n.In.lookupMutationBatch(t,e).next((e=>(_r(null!==e),i=e.keys(),n.In.removeMutationBatch(t,e)))).next((()=>n.In.performConsistencyCheck(t))).next((()=>n.Qn.bn(t,i)))}))}(i.localStore,e);ec(i,e,n),tc(i,e),i.sharedClientState.updateMutationState(e,"rejected",n),await nc(i,t)}catch(t){await Xa(t)}}function tc(t,e){(t.Bo.get(e)||[]).forEach((t=>{t.resolve()})),t.Bo.delete(e)}function ec(t,e,n){const i=Dr(t);let r=i.Lo[i.currentUser.toKey()];if(r){const t=r.get(e);t&&(n?t.reject(n):t.resolve(),r=r.remove(e)),i.Lo[i.currentUser.toKey()]=r}}async function nc(t,e,n){const i=Dr(t),r=[],s=[],o=[];i.xo.isEmpty()||(i.xo.forEach(((t,a)=>{o.push(i.Ko(a,e,n).then((t=>{if(t){i.isPrimaryClient&&i.sharedClientState.updateQueryState(a.targetId,t.fromCache?"not-current":"current"),r.push(t);const e=Ja.kn(a.targetId,t);s.push(e)}})))})),await Promise.all(o),i.No.Tr(r),await async function(t,e){const n=Dr(t);try{await n.persistence.runTransaction("notifyLocalViewChanges","readwrite",(t=>Ua.forEach(e,(e=>Ua.forEach(e.Nn,(i=>n.persistence.referenceDelegate.addReference(t,e.targetId,i))).next((()=>Ua.forEach(e.xn,(i=>n.persistence.referenceDelegate.removeReference(t,e.targetId,i)))))))))}catch(t){if(!Va(t))throw t;Tr("LocalStore","Failed to update sequence numbers: "+t)}for(const t of e){const e=t.targetId;if(!t.fromCache){const t=n.Un.get(e),i=t.snapshotVersion,r=t.withLastLimboFreeSnapshotVersion(i);n.Un=n.Un.insert(e,r)}}}(i.localStore,s))}async function ic(t,e){const n=Dr(t);if(!n.currentUser.isEqual(e)){Tr("SyncEngine","User change. New user:",e.toKey());const t=await nh(n.localStore,e);n.currentUser=e,(i=n).Bo.forEach((t=>{t.forEach((t=>{t.reject(new Rr(Cr.CANCELLED,"'waitForPendingWrites' promise is rejected due to a user change."))}))})),i.Bo.clear(),n.sharedClientState.handleUserChange(e,t.removedBatchIds,t.addedBatchIds),await nc(n,t.Wn)}var i}function rc(t){const e=Dr(t);return e.remoteStore.remoteSyncer.applySuccessfulWrite=Jh.bind(null,e),e.remoteStore.remoteSyncer.rejectFailedWrite=Zh.bind(null,e),e}class sc{constructor(){this.synchronizeTabs=!1}async initialize(t){this.N=Ih(t.databaseInfo.databaseId),this.sharedClientState=this.Wo(t),this.persistence=this.Go(t),await this.persistence.start(),this.gcScheduler=this.zo(t),this.localStore=this.Ho(t)}zo(t){return null}Ho(t){return eh(this.persistence,new Za,t.initialUser,this.N)}Go(t){return new fh(ph.Ns,this.N)}Wo(t){return new mh}async terminate(){this.gcScheduler&&this.gcScheduler.stop(),await this.sharedClientState.shutdown(),await this.persistence.shutdown()}}class oc{async initialize(t,e){this.localStore||(this.localStore=t.localStore,this.sharedClientState=t.sharedClientState,this.datastore=this.createDatastore(e),this.remoteStore=this.createRemoteStore(e),this.eventManager=this.createEventManager(e),this.syncEngine=this.createSyncEngine(e,!t.synchronizeTabs),this.sharedClientState.onlineStateHandler=t=>Yh(this.syncEngine,t,1),this.remoteStore.remoteSyncer.handleCredentialChange=ic.bind(null,this.syncEngine),await $h(this.remoteStore,this.syncEngine.isPrimaryClient))}createEventManager(t){return new Xh}createDatastore(t){const e=Ih(t.databaseInfo.databaseId),n=(i=t.databaseInfo,new Eh(i));var i,r;return r=t.credentials,new _h(r,n,e)}createRemoteStore(t){var e,n,i,r,s;return e=this.localStore,n=this.datastore,i=t.asyncQueue,r=t=>Yh(this.syncEngine,t,0),s=vh.Pt()?new vh:new yh,new Ch(e,n,i,r,s)}createSyncEngine(t,e){return function(t,e,n,i,r,s,o){const a=new Qh(t,e,n,i,r,s);return o&&(a.qo=!0),a}(this.localStore,this.remoteStore,this.eventManager,this.sharedClientState,t.initialUser,t.maxConcurrentLimboResolutions,e)}terminate(){return async function(t){const e=Dr(t);Tr("RemoteStore","RemoteStore shutting down."),e.Kr.add(5),await Lh(e),e.Qr.shutdown(),e.Wr.set("Unknown")}(this.remoteStore)}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class ac{constructor(t,e,n){this.credentials=t,this.asyncQueue=e,this.databaseInfo=n,this.user=vr.UNAUTHENTICATED,this.clientId=Vr.I(),this.credentialListener=()=>Promise.resolve(),this.credentials.start(e,(async t=>{Tr("FirestoreClient","Received user=",t.uid),await this.credentialListener(t),this.user=t}))}async getConfiguration(){return{asyncQueue:this.asyncQueue,databaseInfo:this.databaseInfo,clientId:this.clientId,credentials:this.credentials,initialUser:this.user,maxConcurrentLimboResolutions:100}}setCredentialChangeListener(t){this.credentialListener=t}verifyNotTerminated(){if(this.asyncQueue.isShuttingDown)throw new Rr(Cr.FAILED_PRECONDITION,"The client has already been terminated.")}terminate(){this.asyncQueue.enterRestrictedMode();const t=new Lr;return this.asyncQueue.enqueueAndForgetEvenWhileRestricted((async()=>{try{this.onlineComponents&&await this.onlineComponents.terminate(),this.offlineComponents&&await this.offlineComponents.terminate(),this.credentials.shutdown(),t.resolve()}catch(e){const n=zh(e,"Failed to shutdown persistence");t.reject(n)}})),t.promise}}async function hc(t,e){t.asyncQueue.verifyOperationInProgress(),Tr("FirestoreClient","Initializing OfflineComponentProvider");const n=await t.getConfiguration();await e.initialize(n);let i=n.initialUser;t.setCredentialChangeListener((async t=>{i.isEqual(t)||(await nh(e.localStore,t),i=t)})),e.persistence.setDatabaseDeletedListener((()=>t.terminate())),t.offlineComponents=e}async function cc(t,e){t.asyncQueue.verifyOperationInProgress();const n=await lc(t);Tr("FirestoreClient","Initializing OnlineComponentProvider");const i=await t.getConfiguration();await e.initialize(n,i),t.setCredentialChangeListener((t=>async function(t,e){const n=Dr(t);n.asyncQueue.verifyOperationInProgress(),Tr("RemoteStore","RemoteStore received new credentials");const i=Oh(n);n.Kr.add(3),await Lh(n),i&&n.Wr.set("Unknown"),await n.remoteSyncer.handleCredentialChange(e),n.Kr.delete(3),await Rh(n)}(e.remoteStore,t))),t.onlineComponents=e}async function lc(t){return t.offlineComponents||(Tr("FirestoreClient","Using default OfflineComponentProvider"),await hc(t,new sc)),t.offlineComponents}async function uc(t){return t.onlineComponents||(Tr("FirestoreClient","Using default OnlineComponentProvider"),await cc(t,new oc)),t.onlineComponents}function fc(t){return uc(t).then((t=>t.syncEngine))}class dc{constructor(t,e,n,i,r,s,o,a){this.databaseId=t,this.appId=e,this.persistenceKey=n,this.host=i,this.ssl=r,this.forceLongPolling=s,this.autoDetectLongPolling=o,this.useFetchStreams=a}}class pc{constructor(t,e){this.projectId=t,this.database=e||"(default)"}get isDefaultDatabase(){return"(default)"===this.database}isEqual(t){return t instanceof pc&&t.projectId===this.projectId&&t.database===this.database}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Tc{constructor(t,e){this._credentials=e,this.type="firestore-lite",this._persistenceKey="(lite)",this._settings=new Ec({}),this._settingsFrozen=!1,t instanceof pc?this._databaseId=t:(this._app=t,this._databaseId=function(t){if(!Object.prototype.hasOwnProperty.apply(t.options,["projectId"]))throw new Rr(Cr.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new pc(t.options.projectId)}(t))}get app(){if(!this._app)throw new Rr(Cr.FAILED_PRECONDITION,"Firestore was not initialized using the Firebase SDK. 'app' is not available");return this._app}get _initialized(){return this._settingsFrozen}get _terminated(){return void 0!==this._terminateTask}_setSettings(t){if(this._settingsFrozen)throw new Rr(Cr.FAILED_PRECONDITION,"Firestore has already been started and its settings can no longer be changed. You can only modify settings before calling any other methods on a Firestore object.");this._settings=new Ec(t),void 0!==t.credentials&&(this._credentials=function(t){if(!t)return new kr;switch(t.type){case"gapi":const e=t.client;return _r(!("object"!=typeof e||null===e||!e.auth||!e.auth.getAuthHeaderValueForFirstParty)),new Fr(e,t.sessionIndex||"0",t.iamToken||null);case"provider":return t.client;default:throw new Rr(Cr.INVALID_ARGUMENT,"makeCredentialsProvider failed due to invalid credential type")}}(t.credentials))}_getSettings(){return this._settings}_freezeSettings(){return this._settingsFrozen=!0,this._settings}_delete(){return this._terminateTask||(this._terminateTask=this._terminate()),this._terminateTask}toJSON(){return{app:this._app,databaseId:this._databaseId,settings:this._settings}}_terminate(){return function(t){const e=gc.get(t);e&&(Tr("ComponentProvider","Removing Datastore"),gc.delete(t),e.terminate())}(this),Promise.resolve()}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class Ic{constructor(t,e,n){this.converter=e,this._key=n,this.type="document",this.firestore=t}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new Sc(this.firestore,this.converter,this._key.path.popLast())}withConverter(t){return new Ic(this.firestore,t,this._key)}}class Ac{constructor(t,e,n){this.converter=e,this._query=n,this.type="query",this.firestore=t}withConverter(t){return new Ac(this.firestore,t,this._query)}}class Sc extends Ac{constructor(t,e,n){super(t,e,qs(n)),this._path=n,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const t=this._path.popLast();return t.isEmpty()?null:new Ic(this.firestore,null,new hs(t))}withConverter(t){return new Sc(this.firestore,t,this._path)}}function Nc(t,e,...n){if(t=y(t),1===arguments.length&&(e=Vr.I()),mc("doc","path",e),t instanceof Tc){const i=Xr.fromString(e,...n);return yc(i),new Ic(t,null,new hs(i))}{if(!(t instanceof Ic||t instanceof Sc))throw new Rr(Cr.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const i=t._path.child(Xr.fromString(e,...n));return yc(i),new Ic(t.firestore,t instanceof Sc?t.converter:null,new hs(i))}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class _c{constructor(){this.fa=Promise.resolve(),this.da=[],this.wa=!1,this._a=[],this.ma=null,this.ga=!1,this.ya=!1,this.pa=[],this.rr=new Ah(this,"async_queue_retry"),this.Ea=()=>{const t=Th();t&&Tr("AsyncQueue","Visibility state changed to "+t.visibilityState),this.rr.tr()};const t=Th();t&&"function"==typeof t.addEventListener&&t.addEventListener("visibilitychange",this.Ea)}get isShuttingDown(){return this.wa}enqueueAndForget(t){this.enqueue(t)}enqueueAndForgetEvenWhileRestricted(t){this.Ta(),this.Ia(t)}enterRestrictedMode(t){if(!this.wa){this.wa=!0,this.ya=t||!1;const e=Th();e&&"function"==typeof e.removeEventListener&&e.removeEventListener("visibilitychange",this.Ea)}}enqueue(t){if(this.Ta(),this.wa)return new Promise((()=>{}));const e=new Lr;return this.Ia((()=>this.wa&&this.ya?Promise.resolve():(t().then(e.resolve,e.reject),e.promise))).then((()=>e.promise))}enqueueRetryable(t){this.enqueueAndForget((()=>(this.da.push(t),this.Aa())))}async Aa(){if(0!==this.da.length){try{await this.da[0](),this.da.shift(),this.rr.reset()}catch(t){if(!Va(t))throw t;Tr("AsyncQueue","Operation failed with retryable error: "+t)}this.da.length>0&&this.rr.Xi((()=>this.Aa()))}}Ia(t){const e=this.fa.then((()=>(this.ga=!0,t().catch((t=>{throw this.ma=t,this.ga=!1,Ir("INTERNAL UNHANDLED ERROR: ",function(t){let e=t.message||"";return t.stack&&(e=t.stack.includes(t.message)?t.stack:t.message+"\n"+t.stack),e}(t)),t})).then((t=>(this.ga=!1,t))))));return this.fa=e,e}enqueueAfterDelay(t,e,n){this.Ta(),this.pa.indexOf(t)>-1&&(e=0);const i=Gh.createAndSchedule(this,t,e,n,(t=>this.Ra(t)));return this._a.push(i),i}Ta(){this.ma&&Nr()}verifyOperationInProgress(){}async Pa(){let t;do{t=this.fa,await t}while(t!==this.fa)}ba(t){for(const e of this._a)if(e.timerId===t)return!0;return!1}va(t){return this.Pa().then((()=>{this._a.sort(((t,e)=>t.targetTimeMs-e.targetTimeMs));for(const e of this._a)if(e.skipDelay(),"all"!==t&&e.timerId===t)break;return this.Pa()}))}Va(t){this.pa.push(t)}Ra(t){const e=this._a.indexOf(t);this._a.splice(e,1)}}class Dc extends Tc{constructor(t,e){super(t,e),this.type="firestore",this._queue=new _c,this._persistenceKey="name"in t?t.name:"[DEFAULT]"}_terminate(){return this._firestoreClient||Rc(this),this._firestoreClient.terminate()}}function Cc(t){return t._firestoreClient||Rc(t),t._firestoreClient.verifyNotTerminated(),t._firestoreClient}function Rc(t){var e;const n=t._freezeSettings(),i=(r=t._databaseId,s=(null===(e=t._app)||void 0===e?void 0:e.options.appId)||"",o=t._persistenceKey,new dc(r,s,o,(a=n).host,a.ssl,a.experimentalForceLongPolling,a.experimentalAutoDetectLongPolling,a.useFetchStreams));var r,s,o,a;t._firestoreClient=new ac(t._credentials,t._queue,i)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class Lc{constructor(...t){for(let e=0;e<t.length;++e)if(0===t[e].length)throw new Rr(Cr.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new Qr(t)}isEqual(t){return this._internalPath.isEqual(t._internalPath)}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class Oc{constructor(t){this._byteString=t}static fromBase64String(t){try{return new Oc(Jr.fromBase64String(t))}catch(t){throw new Rr(Cr.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+t)}}static fromUint8Array(t){return new Oc(Jr.fromUint8Array(t))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(t){return this._byteString.isEqual(t._byteString)}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xc{constructor(t,e){if(!isFinite(t)||t<-90||t>90)throw new Rr(Cr.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+t);if(!isFinite(e)||e<-180||e>180)throw new Rr(Cr.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+e);this._lat=t,this._long=e}get latitude(){return this._lat}get longitude(){return this._long}isEqual(t){return this._lat===t._lat&&this._long===t._long}toJSON(){return{latitude:this._lat,longitude:this._long}}_compareTo(t){return jr(this._lat,t._lat)||jr(this._long,t._long)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Pc=/^__.*__$/;class Fc{constructor(t,e,n){this.data=t,this.fieldMask=e,this.fieldTransforms=n}toMutation(t,e){return null!==this.fieldMask?new Do(t,this.data,this.fieldMask,e,this.fieldTransforms):new _o(t,this.data,e,this.fieldTransforms)}}class Mc{constructor(t,e,n){this.data=t,this.fieldMask=e,this.fieldTransforms=n}toMutation(t,e){return new Do(t,this.data,this.fieldMask,e,this.fieldTransforms)}}function Uc(t){switch(t){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw Nr()}}class Vc{constructor(t,e,n,i,r,s){this.settings=t,this.databaseId=e,this.N=n,this.ignoreUndefinedProperties=i,void 0===r&&this.Sa(),this.fieldTransforms=r||[],this.fieldMask=s||[]}get path(){return this.settings.path}get Da(){return this.settings.Da}Ca(t){return new Vc(Object.assign(Object.assign({},this.settings),t),this.databaseId,this.N,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}Na(t){var e;const n=null===(e=this.path)||void 0===e?void 0:e.child(t),i=this.Ca({path:n,xa:!1});return i.ka(t),i}$a(t){var e;const n=null===(e=this.path)||void 0===e?void 0:e.child(t),i=this.Ca({path:n,xa:!1});return i.Sa(),i}Oa(t){return this.Ca({path:void 0,xa:!0})}Fa(t){return tl(t,this.settings.methodName,this.settings.Ma||!1,this.path,this.settings.La)}contains(t){return void 0!==this.fieldMask.find((e=>t.isPrefixOf(e)))||void 0!==this.fieldTransforms.find((e=>t.isPrefixOf(e.field)))}Sa(){if(this.path)for(let t=0;t<this.path.length;t++)this.ka(this.path.get(t))}ka(t){if(0===t.length)throw this.Fa("Document fields must not be empty");if(Uc(this.Da)&&Pc.test(t))throw this.Fa('Document fields cannot begin and end with "__"')}}class jc{constructor(t,e,n){this.databaseId=t,this.ignoreUndefinedProperties=e,this.N=n||Ih(t)}Ba(t,e,n,i=!1){return new Vc({Da:t,methodName:e,La:n,path:Qr.emptyPath(),xa:!1,Ma:i},this.databaseId,this.N,this.ignoreUndefinedProperties)}}function Bc(t){const e=t._freezeSettings(),n=Ih(t._databaseId);return new jc(t._databaseId,!!e.ignoreUndefinedProperties,n)}function Hc(t,e,n,i,r,s={}){const o=t.Ba(s.merge||s.mergeFields?2:0,e,n,r);Qc("Data must be an object, but it was:",o,i);const a=Xc(i,o);let h,c;if(s.merge)h=new Yr(o.fieldMask),c=o.fieldTransforms;else if(s.mergeFields){const t=[];for(const i of s.mergeFields){const r=Yc(e,i,n);if(!o.contains(r))throw new Rr(Cr.INVALID_ARGUMENT,`Field '${r}' is specified in your field mask but missing from your input data.`);el(t,r)||t.push(r)}h=new Yr(t),c=o.fieldTransforms.filter((t=>h.covers(t.field)))}else h=null,c=o.fieldTransforms;return new Fc(new bs(a),h,c)}class qc extends kc{_toFieldTransform(t){if(2!==t.Da)throw 1===t.Da?t.Fa(`${this._methodName}() can only appear at the top level of your update data`):t.Fa(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);return t.fieldMask.push(t.path),null}isEqual(t){return t instanceof qc}}class $c extends kc{constructor(t,e){super(t),this.qa=e}_toFieldTransform(t){const e=new go(t.N,oo(t.N,this.qa));return new vo(t.path,e)}isEqual(t){return this===t}}function Kc(t,e,n,i){const r=t.Ba(1,e,n);Qc("Data must be an object, but it was:",r,i);const s=[],o=bs.empty();Kr(i,((t,i)=>{const a=Zc(e,t,n);i=y(i);const h=r.$a(a);if(i instanceof qc)s.push(a);else{const t=zc(i,h);null!=t&&(s.push(a),o.set(a,t))}}));const a=new Yr(s);return new Mc(o,a,r.fieldTransforms)}function Gc(t,e,n,i,r,s){const o=t.Ba(1,e,n),a=[Yc(e,i,n)],h=[r];if(s.length%2!=0)throw new Rr(Cr.INVALID_ARGUMENT,`Function ${e}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let t=0;t<s.length;t+=2)a.push(Yc(e,s[t])),h.push(s[t+1]);const c=[],l=bs.empty();for(let t=a.length-1;t>=0;--t)if(!el(c,a[t])){const e=a[t];let n=h[t];n=y(n);const i=o.$a(e);if(n instanceof qc)c.push(e);else{const t=zc(n,i);null!=t&&(c.push(e),l.set(e,t))}}const u=new Yr(c);return new Mc(l,u,o.fieldTransforms)}function zc(t,e){if(Wc(t=y(t)))return Qc("Unsupported field value:",e,t),Xc(t,e);if(t instanceof kc)return function(t,e){if(!Uc(e.Da))throw e.Fa(`${t._methodName}() can only be used with update() and set()`);if(!e.path)throw e.Fa(`${t._methodName}() is not currently supported inside arrays`);const n=t._toFieldTransform(e);n&&e.fieldTransforms.push(n)}(t,e),null;if(void 0===t&&e.ignoreUndefinedProperties)return null;if(e.path&&e.fieldMask.push(e.path),t instanceof Array){if(e.settings.xa&&4!==e.Da)throw e.Fa("Nested arrays are not supported");return function(t,e){const n=[];let i=0;for(const r of t){let t=zc(r,e.Oa(i));null==t&&(t={nullValue:"NULL_VALUE"}),n.push(t),i++}return{arrayValue:{values:n}}}(t,e)}return function(t,e){if(null===(t=y(t)))return{nullValue:"NULL_VALUE"};if("number"==typeof t)return oo(e.N,t);if("boolean"==typeof t)return{booleanValue:t};if("string"==typeof t)return{stringValue:t};if(t instanceof Date){const n=Hr.fromDate(t);return{timestampValue:ta(e.N,n)}}if(t instanceof Hr){const n=new Hr(t.seconds,1e3*Math.floor(t.nanoseconds/1e3));return{timestampValue:ta(e.N,n)}}if(t instanceof xc)return{geoPointValue:{latitude:t.latitude,longitude:t.longitude}};if(t instanceof Oc)return{bytesValue:ea(e.N,t._byteString)};if(t instanceof Ic){const n=e.databaseId,i=t.firestore._databaseId;if(!i.isEqual(n))throw e.Fa(`Document reference is for database ${i.projectId}/${i.database} but should be for database ${n.projectId}/${n.database}`);return{referenceValue:ra(t.firestore._databaseId||e.databaseId,t._key.path)}}throw e.Fa(`Unsupported field value: ${wc(t)}`)}(t,e)}function Xc(t,e){const n={};return Gr(t)?e.path&&e.path.length>0&&e.fieldMask.push(e.path):Kr(t,((t,i)=>{const r=zc(i,e.Na(t));null!=r&&(n[t]=r)})),{mapValue:{fields:n}}}function Wc(t){return!("object"!=typeof t||null===t||t instanceof Array||t instanceof Date||t instanceof Hr||t instanceof xc||t instanceof Oc||t instanceof Ic||t instanceof kc)}function Qc(t,e,n){if(!Wc(n)||("object"!=typeof(i=n)||null===i||Object.getPrototypeOf(i)!==Object.prototype&&null!==Object.getPrototypeOf(i))){const i=wc(n);throw"an object"===i?e.Fa(t+" a custom object"):e.Fa(t+" "+i)}var i}function Yc(t,e,n){if((e=y(e))instanceof Lc)return e._internalPath;if("string"==typeof e)return Zc(t,e);throw tl("Field path arguments must be of type string or FieldPath.",t,!1,void 0,n)}const Jc=new RegExp("[~\\*/\\[\\]]");function Zc(t,e,n){if(e.search(Jc)>=0)throw tl(`Invalid field path (${e}). Paths must not contain '~', '*', '/', '[', or ']'`,t,!1,void 0,n);try{return new Lc(...e.split("."))._internalPath}catch(i){throw tl(`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,t,!1,void 0,n)}}function tl(t,e,n,i,r){const s=i&&!i.isEmpty(),o=void 0!==r;let a=`Function ${e}() called with invalid data`;n&&(a+=" (via `toFirestore()`)"),a+=". ";let h="";return(s||o)&&(h+=" (found",s&&(h+=` in field ${i}`),o&&(h+=` in document ${r}`),h+=")"),new Rr(Cr.INVALID_ARGUMENT,a+t+h)}function el(t,e){return t.some((t=>t.isEqual(e)))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function nl(t,e,n){let i;return i=t?n&&(n.merge||n.mergeFields)?t.toFirestore(e,n):t.toFirestore(e):e,i}function il(t,e){return function(t,e){const n=new Lr;return t.asyncQueue.enqueueAndForget((async()=>async function(t,e,n){const i=rc(t);try{const t=await function(t,e){const n=Dr(t),i=Hr.now(),r=e.reduce(((t,e)=>t.add(e.key)),Qo());let s;return n.persistence.runTransaction("Locally write mutations","readwrite",(t=>n.Qn.bn(t,r).next((r=>{s=r;const o=[];for(const t of e){const e=Ao(t,s.get(t.key));null!=e&&o.push(new Do(t.key,e,Es(e.value.mapValue),bo.exists(!0)))}return n.In.addMutationBatch(t,i,o,e)})))).then((t=>(t.applyToLocalDocumentSet(s),{batchId:t.batchId,changes:s})))}(i.localStore,e);i.sharedClientState.addPendingMutation(t.batchId),function(t,e,n){let i=t.Lo[t.currentUser.toKey()];i||(i=new Uo(jr)),i=i.insert(e,n),t.Lo[t.currentUser.toKey()]=i}(i,t.batchId,n),await nc(i,t.changes),await Ph(i.remoteStore)}catch(t){const e=zh(t,"Failed to persist write");n.reject(e)}}(await fc(t),e,n))),n.promise}(Cc(t),e)}wr="9.0.0",M(new v("firestore",((t,{options:e})=>{const n=t.getProvider("app").getImmediate(),i=new Dc(n,new xr(t.getProvider("auth-internal")));return e=Object.assign({useFetchStreams:!0},e),i._setSettings(e),i}),"PUBLIC")),B("@firebase/firestore","3.0.1",undefined);!function(t,e={}){if("object"!=typeof e){e={name:e}}const n=Object.assign({name:"[DEFAULT]",automaticDataCollectionEnabled:!1},e),i=n.name;if("string"!=typeof i||!i)throw V.create("bad-app-name",{appName:String(i)});const r=x.get(i);if(r){if(p(t,r.options)&&p(n,r.config))return r;throw V.create("duplicate-app",{appName:i})}const s=new E(i);for(const t of P.values())s.addComponent(t);const o=new j(t,n,s);x.set(i,o)}({apiKey:"AIzaSyDhfTomFg03nXW2cD1RIysGXydVHHUNC0c",authDomain:"nisb-website.firebaseapp.com",projectId:"nisb-website",storageBucket:"nisb-website.appspot.com",messagingSenderId:"30096523025",appId:"1:30096523025:web:8485960da3344cf73cd6b0",measurementId:"G-5RMDTP6Q8R"});const rl=function(t=function(t="[DEFAULT]"){const e=x.get(t);if(!e)throw V.create("no-app",{appName:t});return e}()){return U(t,"firestore").getImmediate()}();var sl=null;fetch("https://ipapi.co/json/").then((t=>t.json())).then((t=>sl=t)).catch((t=>console.error(t)));const ol=t=>{var e;
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */!function(t,e){const n=bc(t.firestore,Dc),i=Nc(t),r=nl(t.converter,e);il(n,[Hc(Bc(t.firestore),"addDoc",i._key,r,null!==t.converter,{}).toMutation(i._key,bo.exists(!1))]).then((()=>i))}(function(t,e,...n){if(t=y(t),mc("collection","path",e),t instanceof Tc){const i=Xr.fromString(e,...n);return vc(i),new Sc(t,null,i)}{if(!(t instanceof Ic||t instanceof Sc))throw new Rr(Cr.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const i=Xr.fromString(t.path,...n).child(Xr.fromString(e));return vc(i),new Sc(t.firestore,null,i)}}(rl,"analytics"),{name:t.target.getAttribute("data-name"),link:t.target.getAttribute("data-url"),time:new Date,loc:sl}),function(t,e,n,...i){t=bc(t,Ic);const r=bc(t.firestore,Dc),s=Bc(r);let o;o="string"==typeof(e=y(e))||e instanceof Lc?Gc(s,"updateDoc",t._key,e,n,i):Kc(s,"updateDoc",t._key,e),il(r,[o.toMutation(t._key,bo.exists(!0))])}(Nc(rl,"social-links",t.target.getAttribute("data-id")),{count:(e=1,new $c("increment",e))}),window.open(t.target.getAttribute("data-url"),"_blank")};for(var al=document.getElementsByClassName("link"),hl=0;hl<al.length;hl++)al[hl].addEventListener("click",ol,!1);
//# sourceMappingURL=index.512bed18.js.map
